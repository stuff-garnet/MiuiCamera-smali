...
.method public constructor <init>(Lokio/BufferedSource;Z)V
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(Lokio/Source;IIILkotlin/jvm/internal/w;)V
...
.method private final readRstStream(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-static {p2, p0}, Lkotlin/jvm/internal/l0;->C(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;
...
.method private final readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-static {v0, p2}, Lxl/u;->W1(II)Lxl/l;

    move-result-object p2

    const/4 v1, 0x6

    invoke-static {p2, v1}, Lxl/u;->B1(Lxl/j;I)Lxl/j;

    move-result-object p2

    invoke-virtual {p2}, Lxl/j;->c()I

    move-result v1

    invoke-virtual {p2}, Lxl/j;->d()I

    move-result v2

    invoke-virtual {p2}, Lxl/j;->e()I
