...
.method private newDrawing()V
    ...
    invoke-static {}, Lqs/c$a;->a()Lqs/c;

    move-result-object v0

    sget-object v1, Lss/o;->W8:Lss/o$a;

    invoke-interface {v0, v1}, Lqs/c;->l5(Lss/o$a;)V

    invoke-interface {v0}, Lqs/c;->tp()Lqs/a;

    move-result-object v2

    invoke-interface {v2, v1}, Lqs/a;->l5(Lss/o$a;)V

    const-string v1, "1"

    invoke-interface {v2, v1}, Lqs/a;->setData(Ljava/lang/String;)V
    ...
    invoke-interface {v0, v1}, Lss/j;->setId(Ljava/lang/String;)V

    const-string v1, "21600,21600"

    invoke-interface {v0, v1}, Lss/j;->n6(Ljava/lang/String;)V

    const/high16 v1, 0x434a0000    # 202.0f

    invoke-interface {v0, v1}, Lss/j;->g8(F)V

    const-string v1, "m,l,21600r21600,l21600,xe"

    invoke-interface {v0, v1}, Lss/j;->E8(Ljava/lang/String;)V

    invoke-interface {v0}, Lss/j;->u6()Lss/k;

    move-result-object v1

    sget-object v2, Lss/p;->e9:Lss/p$a;

    invoke-interface {v1, v2}, Lss/k;->zl(Lss/p$a;)V

    invoke-interface {v0}, Lss/j;->addNewPath()Lss/g;

    move-result-object v1

    sget-object v2, Lss/q;->j9:Lss/q$a;

    invoke-interface {v1, v2}, Lss/g;->Jj(Lss/q$a;)V

    sget-object v2, Lqs/d;->h8:Lqs/d$a;

    invoke-interface {v1, v2}, Lss/g;->hh(Lqs/d$a;)V
...
.method public findCommentShape(II)Lss/i;
    .locals 5
    ...
    instance-of v1, v0, Lss/i;

    if-eqz v1, :cond_0

    check-cast v0, Lss/i;

    invoke-interface {v0}, Lss/i;->z0()I
    ...
    invoke-interface {v0, v1}, Lss/i;->y6(I)Los/a;

    move-result-object v2

    invoke-interface {v2}, Los/a;->SD()Los/b$a;

    move-result-object v3

    sget-object v4, Los/b;->S6:Los/b$a;

    if-ne v3, v4, :cond_0

    invoke-interface {v2, v1}, Los/a;->getRowArray(I)Ljava/math/BigInteger;
    ...
    invoke-interface {v2, v1}, Los/a;->Ho(I)Ljava/math/BigInteger;
...
.method public newCommentShape()Lss/i;
    .locals 5

    invoke-static {}, Lss/i$a;->a()Lss/i;
    ...
    invoke-interface {v0, v1}, Lss/i;->setId(Ljava/lang/String;)V
    ...
    invoke-interface {v0, v1}, Lss/i;->setType(Ljava/lang/String;)V

    const-string v1, "position:absolute; visibility:hidden"

    invoke-interface {v0, v1}, Lss/i;->l(Ljava/lang/String;)V

    const-string v1, "#ffffe1"

    invoke-interface {v0, v1}, Lss/i;->R2(Ljava/lang/String;)V

    sget-object v2, Lqs/e;->r8:Lqs/e$a;

    invoke-interface {v0, v2}, Lss/i;->t(Lqs/e$a;)V

    invoke-interface {v0}, Lss/i;->addNewFill()Lss/b;

    move-result-object v2

    invoke-interface {v2, v1}, Lss/b;->setColor(Ljava/lang/String;)V

    invoke-interface {v0}, Lss/i;->addNewShadow()Lss/h;

    move-result-object v1

    sget-object v2, Lss/q;->j9:Lss/q$a;

    invoke-interface {v1, v2}, Lss/h;->z(Lss/q$a;)V

    const-string v3, "black"

    invoke-interface {v1, v3}, Lss/h;->setColor(Ljava/lang/String;)V

    invoke-interface {v1, v2}, Lss/h;->Rh(Lss/q$a;)V

    invoke-interface {v0}, Lss/i;->addNewPath()Lss/g;

    move-result-object v1

    sget-object v2, Lqs/d;->g8:Lqs/d$a;

    invoke-interface {v1, v2}, Lss/g;->hh(Lqs/d$a;)V

    invoke-interface {v0}, Lss/i;->S()Lss/m;

    move-result-object v1

    const-string v2, "mso-direction-alt:auto"

    invoke-interface {v1, v2}, Lss/m;->l(Ljava/lang/String;)V

    invoke-interface {v0}, Lss/i;->addNewClientData()Los/a;

    move-result-object v1

    sget-object v2, Los/b;->S6:Los/b$a;

    invoke-interface {v1, v2}, Los/a;->Ww(Los/b$a;)V

    invoke-interface {v1}, Los/a;->Na()Los/c;

    invoke-interface {v1}, Los/a;->pA()Los/c;

    invoke-interface {v1}, Los/a;->addNewAnchor()Lorg/apache/xmlbeans/XmlString;
    ...
    invoke-interface {v1}, Los/a;->By()Los/c;
    ...
    invoke-interface {v1}, Los/a;->addNewRow()Lorg/apache/xmlbeans/XmlInteger;
    ...
    invoke-interface {v1}, Los/a;->G8()Lorg/apache/xmlbeans/XmlInteger;
...
.method public read(Ljava/io/InputStream;)V
    ...
    invoke-static {v2}, Lqs/c$a;->k(Ljava/lang/String;)Lqs/c;
    ...
    invoke-static {v2}, Lss/j$a;->k(Ljava/lang/String;)Lss/j;
    ...
    invoke-interface {v2}, Lss/j;->getId()Ljava/lang/String;
    ...
    invoke-static {v2}, Lss/i$a;->k(Ljava/lang/String;)Lss/i;

    move-result-object v2

    invoke-interface {v2}, Lss/i;->getId()Ljava/lang/String;
...
.method public removeCommentShape(II)Z
    ...
    invoke-virtual {p0, p1, p2}, Lorg/apache/poi/xssf/usermodel/XSSFVMLDrawing;->findCommentShape(II)Lss/i;
