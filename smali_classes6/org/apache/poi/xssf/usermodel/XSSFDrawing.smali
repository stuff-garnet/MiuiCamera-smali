...
.method public createCellComment(Lorg/apache/poi/ss/usermodel/ClientAnchor;)Lorg/apache/poi/xssf/usermodel/XSSFComment;
    ...
    .line 6
    invoke-virtual {p0}, Lorg/apache/poi/xssf/usermodel/XSSFVMLDrawing;->newCommentShape()Lss/i;
    ...
    .line 9
    invoke-interface {p0, v2}, Lss/i;->y6(I)Los/a;

    move-result-object v3

    invoke-interface {v3, v2, v0}, Los/a;->rw(ILjava/lang/String;)V
    ...
    invoke-direct {v0, v1, v2, p0}, Lorg/apache/poi/xssf/usermodel/XSSFComment;-><init>(Lorg/apache/poi/xssf/model/CommentsTable;Lorg/openxmlformats/schemas/spreadsheetml/x2006/main/CTComment;Lss/i;)V
