...
.method private getWatermarkParagraph(Ljava/lang/String;I)Lorg/apache/poi/xwpf/usermodel/XWPFParagraph;
    ...
    invoke-static {}, Lss/d$a;->a()Lss/d;

    move-result-object v2

    invoke-interface {v2}, Lss/d;->ol()Lss/j;

    move-result-object v3

    const-string v4, "_x0000_t136"

    invoke-interface {v3, v4}, Lss/j;->setId(Ljava/lang/String;)V

    const-string v4, "1600,21600"

    invoke-interface {v3, v4}, Lss/j;->n6(Ljava/lang/String;)V

    const/high16 v4, 0x43080000    # 136.0f

    invoke-interface {v3, v4}, Lss/j;->g8(F)V

    const-string v4, "10800"

    invoke-interface {v3, v4}, Lss/j;->u8(Ljava/lang/String;)V

    const-string v4, "m@7,0l@8,0m@5,21600l@6,21600e"

    invoke-interface {v3, v4}, Lss/j;->E8(Ljava/lang/String;)V

    invoke-interface {v3}, Lss/j;->h1()Lss/c;

    move-result-object v4

    invoke-interface {v4}, Lss/c;->addNewF()Lss/a;

    move-result-object v5

    const-string v6, "sum #0 0 10800"

    invoke-interface {v5, v6}, Lss/a;->fa(Ljava/lang/String;)V
    ...
    invoke-interface {v4, v5}, Lss/a;->fa(Ljava/lang/String;)V

    invoke-interface {v3}, Lss/j;->addNewPath()Lss/g;

    move-result-object v4

    sget-object v5, Lss/q;->j9:Lss/q$a;

    invoke-interface {v4, v5}, Lss/g;->Nn(Lss/q$a;)V

    sget-object v6, Lqs/d;->j8:Lqs/d$a;

    invoke-interface {v4, v6}, Lss/g;->hh(Lqs/d$a;)V

    const-string v6, "@9,0;@10,10800;@11,21600;@12,10800"

    invoke-interface {v4, v6}, Lss/g;->Lk(Ljava/lang/String;)V

    const-string v6, "270,180,90,0"

    invoke-interface {v4, v6}, Lss/g;->wi(Ljava/lang/String;)V

    invoke-interface {v3}, Lss/j;->Y1()Lss/l;

    move-result-object v4

    invoke-interface {v4, v5}, Lss/l;->z(Lss/q$a;)V

    invoke-interface {v4, v5}, Lss/l;->tb(Lss/q$a;)V

    invoke-interface {v3}, Lss/j;->E4()Lss/f;

    move-result-object v4

    invoke-interface {v4}, Lss/f;->addNewH()Lss/e;

    move-result-object v4

    const-string v5, "#0,bottomRight"

    invoke-interface {v4, v5}, Lss/e;->setPosition(Ljava/lang/String;)V

    const-string v5, "6629,14971"

    invoke-interface {v4, v5}, Lss/e;->kg(Ljava/lang/String;)V

    invoke-interface {v3}, Lss/j;->addNewLock()Lqs/b;

    move-result-object v3

    sget-object v4, Lss/o;->W8:Lss/o$a;

    invoke-interface {v3, v4}, Lqs/b;->l5(Lss/o$a;)V

    invoke-interface {v2}, Lss/d;->aB()Lss/i;
    ...
    invoke-interface {v3, v4}, Lss/i;->setId(Ljava/lang/String;)V
    ...
    invoke-interface {v3, p2}, Lss/i;->Z(Ljava/lang/String;)V

    const-string p2, "#_x0000_t136"

    invoke-interface {v3, p2}, Lss/i;->setType(Ljava/lang/String;)V
    ...
    invoke-interface {v3, p2}, Lss/i;->l(Ljava/lang/String;)V
    ...
    invoke-interface {v3, p2}, Lss/i;->L4(Ljava/lang/String;)V

    const-string p2, "black"

    invoke-interface {v3, p2}, Lss/i;->R2(Ljava/lang/String;)V

    sget-object p2, Lss/q;->m9:Lss/q$a;

    invoke-interface {v3, p2}, Lss/i;->f9(Lss/q$a;)V

    invoke-interface {v3}, Lss/i;->Y1()Lss/l;

    move-result-object p2

    const-string v3, "font-family:&quot;Cambria&quot;;font-size:1pt"

    invoke-interface {p2, v3}, Lss/l;->l(Ljava/lang/String;)V

    invoke-interface {p2, p1}, Lss/l;->pF(Ljava/lang/String;)V
