...
.method public static J(Lcom/android/camera2/f;I)Z
    ...
    invoke-static {p0}, Lcom/android/camera2/g;->W9(Lcom/android/camera2/f;)Ljava/util/List;
...
.method public final B()V
    ...
    invoke-static {v4}, Lcom/android/camera2/g;->X9(Lcom/android/camera2/f;)Ljava/util/List;
...
.method public final D(Ljava/util/List;Ljava/util/List;Lu0/a0$b;Ljava/util/List;ILcom/android/camera2/f;)V
    ...
    invoke-static {p6, p2, v0}, Lcom/android/camera2/g;->v5(Lcom/android/camera2/f;II)Z
    ...
    invoke-static {p6}, Lcom/android/camera2/g;->T8(Lcom/android/camera2/f;)Z
...
.method public final E(Ljava/util/List;Ljava/util/List;Lu0/a0$b;Ljava/util/List;ILcom/android/camera2/f;)V
    ...
    new-instance p6, Lcom/android/camera/d3;

    const/16 v0, 0x500

    const/16 v1, 0x2d0

    invoke-direct {p6, v0, v1}, Lcom/android/camera/d3;-><init>(II)V
...
.method public final F(Ljava/util/List;Ljava/util/List;Lu0/a0$b;Ljava/util/List;ILcom/android/camera2/f;)V
    ...
    invoke-static {p6, p5, p2}, Lcom/android/camera2/g;->v5(Lcom/android/camera2/f;II)Z
...
.method public final H(Lu0/a0$b;Ljava/util/List;ILcom/android/camera2/f;II)V
    ...
    invoke-static/range {p6 .. p6}, Lcom/android/camera/c3;->k3(I)Z
    ...
    :cond_0
    invoke-static/range {p6 .. p6}, Lcom/android/camera/c3;->P6(I)Z
    ...
    :cond_1
    invoke-static/range {p6 .. p6}, Lcom/android/camera/c3;->W2(I)Z
    ...
    :cond_3
    invoke-static {v3, v4}, Lcom/android/camera/c3;->f7(Lcom/android/camera2/f;I)Z
    ...
    :cond_4
    invoke-static/range {p6 .. p6}, Lcom/android/camera/c3;->a6(I)Z
    ...
    invoke-static {v3, v6}, Lcom/android/camera/c3;->B2(Lcom/android/camera2/f;I)Z
    ...
    :cond_6
    invoke-static/range {p6 .. p6}, Lcom/android/camera/c3;->p0(I)Ljava/lang/String;
    ...
    :cond_7
    invoke-static/range {p6 .. p6}, Lcom/android/camera/c3;->R4(I)Z
    ...
    invoke-static/range {p4 .. p4}, Lcom/android/camera2/g;->N9(Lcom/android/camera2/f;)Ljava/util/List;
    ...
    invoke-static {v4, v14}, Lcom/android/camera/c3;->Z3(ILcom/android/camera/fragment/beauty/c0;)Z
    ...
    invoke-virtual {v5}, Lub/c;->y8()Z

    move-result v5

    if-eqz v5, :cond_12

    invoke-static/range {p4 .. p4}, Lcom/android/camera2/g;->x8(Lcom/android/camera2/f;)Z
    ...
    :cond_12
    :goto_4
    invoke-static/range {p6 .. p6}, Lcom/android/camera/c3;->B5(I)Z

    move-result v5

    if-eqz v5, :cond_14

    invoke-static/range {p4 .. p4}, Lcom/android/camera2/g;->R6(Lcom/android/camera2/f;)Z
    ...
    invoke-static {v2}, Lcom/android/camera/c3;->e0(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_17
    invoke-static/range {p4 .. p4}, Lcom/android/camera/c3;->h6(Lcom/android/camera2/f;)Z
...
.method public final P(II)Z
    ...
    invoke-static {v0, p1}, Lcom/android/camera/c3;->f7(Lcom/android/camera2/f;I)Z
...
.method public Q(IILcom/android/camera2/f;I)V
    ...
    invoke-virtual {v0, v9, v1}, Lp6/g;->O(II)Lcom/android/camera2/f;
    ...
    :cond_3
    invoke-static/range {p3 .. p3}, Lcom/android/camera/c3;->h6(Lcom/android/camera2/f;)Z

    move-result v1

    if-eqz v1, :cond_4

    invoke-static/range {p3 .. p3}, Lcom/android/camera2/g;->T9(Lcom/android/camera2/f;)Ljava/util/List;
    ...
    :cond_6
    invoke-static/range {p1 .. p1}, Lcom/android/camera/c3;->B5(I)Z
    ...
    invoke-static/range {p3 .. p3}, Lcom/android/camera2/g;->L9(Lcom/android/camera2/f;)Ljava/util/List;
    ...
    invoke-static/range {p1 .. p1}, Lcom/android/camera/c3;->F6(I)Z
    ...
    invoke-static/range {p3 .. p3}, Lcom/android/camera2/g;->y9(Lcom/android/camera2/f;)Z
...
.method public getKey(I)Ljava/lang/String;
    ...
    invoke-static {p1}, Lcom/android/camera/c3;->G(I)I
    ...
    invoke-static {p0}, Lcom/android/camera/c3;->h6(Lcom/android/camera2/f;)Z
...
.method public final h(ILjava/util/List;Lu0/a0$b;)V
    ...
    :cond_0
    invoke-static {v7}, Lcom/android/camera2/g;->n6(Lcom/android/camera2/f;)Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-static {v7}, Lcom/android/camera2/g;->L9(Lcom/android/camera2/f;)Ljava/util/List;
