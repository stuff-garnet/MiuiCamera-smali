...
.method private synthetic j()V
    ...
    const-string/jumbo v1, "startBindBGService: already start!"
    ...
    :cond_0
    const-string/jumbo v0, "startBindBGService"
...
.method public final e()V
    ...
    invoke-static {v0}, Lus/c$b;->K0(Landroid/os/IBinder;)Lus/c;

    move-result-object v0

    iput-object v0, p0, Lp2/d;->c:Lus/c;

    iget-object v0, p0, Lp2/d;->c:Lus/c;
...
.method public final g()V
    ...
    const-string/jumbo v0, "setEventCallback: E"
    ...
    iget-object v3, p0, Lp2/d;->c:Lus/c;

    new-instance v4, Lp2/d$a;

    invoke-direct {v4, p0, v0}, Lp2/d$a;-><init>(Lp2/d;I)V

    invoke-interface {v3, v0, v4}, Lus/c;->L(ILus/d;)I
    ...
    const-string/jumbo v3, "setEventCallback: result > "
    ...
    const-string/jumbo p0, "setEventCallback: X"
    ...
    const-string/jumbo v0, "setEventCallback: "
...
.method public n(Ljava/lang/String;)V
    ...
    const-string/jumbo v0, "setCapabilities: "

    new-instance v1, Ljava/lang/StringBuilder;

    invoke-direct {v1}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v2, "setCapabilities: strLen: "
    ...
    iget-object p0, p0, Lp2/d;->c:Lus/c;

    invoke-interface {p0, p1}, Lus/c;->g(Ljava/lang/String;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :cond_0
    const-string/jumbo v0, "setCapabilities: post delay set"
    ...
    :cond_1
    const-string/jumbo p1, "setCapabilities: post delay start service task"
...
.method public o()V
    ...
    const-string/jumbo v3, "startServiceIfNeed: 1"
    ...
    const-string/jumbo v1, "startServiceIfNeed: already start!"
...
.method public final p()V
    ...
    const-string/jumbo v2, "startServiceIfNeed: remove pending task"
