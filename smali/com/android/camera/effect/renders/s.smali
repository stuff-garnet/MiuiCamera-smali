...
.field public g:Lcom/android/camera/effect/o;
...
.method public final b()Landroid/graphics/Matrix;
    ...
    iget v1, p0, Lcom/android/camera/effect/renders/t;->mOrientation:I

    iget p0, p0, Lcom/android/camera/effect/renders/t;->mJpegOrientation:I
...
.method public final c(Z)[F
    ...
    invoke-virtual {p0}, Lcom/android/camera/effect/renders/s;->b()Landroid/graphics/Matrix;

    move-result-object v6

    new-array p1, v5, [F

    iget-object p0, p0, Lcom/android/camera/effect/renders/s;->g:Lcom/android/camera/effect/o;

    iget-object v5, p0, Lcom/android/camera/effect/o;->b:Landroid/graphics/PointF;
    ...
    iget-object v3, p0, Lcom/android/camera/effect/o;->c:Landroid/graphics/PointF;
    ...
    invoke-virtual {p0}, Lcom/android/camera/effect/n;->getEffectAttribute()Lcom/android/camera/effect/o;
...
.method public d(Z)[F
    ...
    iget-boolean p1, p0, Lcom/android/camera/effect/renders/t;->mMirror:Z
    ...
    iget p1, p0, Lcom/android/camera/effect/renders/t;->mOrientation:I
    ...
    iget-object v5, p0, Lcom/android/camera/effect/renders/w;->mPreviewEffectRect:[F
    ...
    iget-object v4, p0, Lcom/android/camera/effect/renders/w;->mPreviewEffectRect:[F
    ...
    iget-object p0, p0, Lcom/android/camera/effect/renders/w;->mSnapshotEffectRect:[F
    ...
    invoke-virtual {p1}, Lcom/android/camera/effect/n;->getEffectRectF()Landroid/graphics/RectF;

    move-result-object p1

    iget v0, p0, Lcom/android/camera/effect/renders/t;->mPreviewWidth:I

    iget v1, p0, Lcom/android/camera/effect/renders/s;->h:I

    if-le v0, v1, :cond_3

    iget v0, p0, Lcom/android/camera/effect/renders/t;->mPreviewHeight:I

    iget v1, p0, Lcom/android/camera/effect/renders/s;->i:I

    if-le v0, v1, :cond_3

    invoke-virtual {p0, p1}, Lcom/android/camera/effect/renders/s;->i(Landroid/graphics/RectF;)V
    ...
    :goto_1
    iget-object p0, p0, Lcom/android/camera/effect/renders/w;->mPreviewEffectRect:[F
...
.method public final g()V
    ...
    iput v1, p0, Lcom/android/camera/effect/renders/s;->h:I
    ...
    iput v0, p0, Lcom/android/camera/effect/renders/s;->i:I
...
.method public h(Z)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/effect/renders/s;->d(Z)[F
    ...
    iget v0, p0, Lcom/android/camera/effect/renders/s;->e:I

    invoke-virtual {p0, p1}, Lcom/android/camera/effect/renders/s;->f(Z)I

    move-result v1

    invoke-static {v0, v1}, Landroid/opengl/GLES20;->glUniform1i(II)V

    iget v0, p0, Lcom/android/camera/effect/renders/s;->f:I

    const/4 v1, 0x5

    invoke-virtual {p0, p1}, Lcom/android/camera/effect/renders/s;->c(Z)[F
...
.method public initShader()V
    ...
    iput v0, p0, Lcom/android/camera/effect/renders/s;->e:I
    ...
    iput v0, p0, Lcom/android/camera/effect/renders/s;->f:I
...
.method public initShaderValue(Z)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/effect/renders/s;->h(Z)V
...
.method public setEffectRangeAttribute(Lcom/android/camera/effect/o;)V
    ...
    iput-object p1, p0, Lcom/android/camera/effect/renders/s;->g:Lcom/android/camera/effect/o;

    iget-object p1, p1, Lcom/android/camera/effect/o;->a:Landroid/graphics/RectF;
