...
# interfaces
.implements Lcom/android/camera/g5$m;


# annotations
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/android/camera/Camera;->cp()V
.end annotation
...
.method private synthetic d(I)V
    ...
    invoke-interface {p0, p1}, Lcom/android/camera/g5$m;->b(I)V
...
.method public a(I)V
    ...
    iget-object v0, v0, Lcom/android/camera/ActivityBase;->G9:Lcom/android/camera/display/manager/CamLayoutManager;

    if-eqz v0, :cond_0

    invoke-interface {v0, p1}, Lcom/android/camera/g5$m;->a(I)V

    :cond_0
    invoke-static {p1}, Lcom/android/camera/o6;->J1(I)I
    ...
    invoke-virtual {p1}, Lcom/android/camera/ActivityBase;->i()I
    ...
    iget-object v0, v0, Lcom/android/camera/ActivityBase;->e:Ld6/d5;

    if-eqz v0, :cond_2

    invoke-interface {v0, p1, v1, p1}, Ld6/d5;->B0(III)V
    ...
    invoke-interface {p1, p0}, Lcom/android/camera/ui/h1;->q(I)V
...
.method public b(I)V
    ...
    invoke-direct {v1, p0, p1}, Lcom/android/camera/h2;-><init>(Lcom/android/camera/Camera$k;I)V
