...
.method public run()V
    ...
    invoke-interface {v1, v2}, Ld6/d5;->R4(Z)V
    ...
    iget-object v4, v0, Lcom/android/camera/ActivityBase;->K0:Lcom/android/camera/CameraAppImpl;
    ...
    new-instance v5, Lcom/android/camera/k2;

    invoke-direct {v5}, Lcom/android/camera/k2;-><init>()V
    ...
    invoke-static {p0}, Lcom/android/camera/Camera;->Nm(Ljava/lang/ref/WeakReference;)Lp6/m$b;
    ...
    invoke-static {v0}, Lcom/android/camera/Camera;->zm(Lcom/android/camera/Camera;)Lcom/android/camera/module/loader/base/StartControl;
    ...
    invoke-direct {v1, p0}, Lcom/android/camera/j2;-><init>(Lcom/android/camera/Camera$q;)V
