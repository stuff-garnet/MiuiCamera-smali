...
.method private synthetic Bl(ZLcom/android/camera/data/data/j;)V
    .locals 1
...
.method public static synthetic Cl(Landroid/text/SpannableStringBuilder;Ljava/util/concurrent/atomic/AtomicInteger;Landroid/text/Spanned;Ljava/util/concurrent/atomic/AtomicInteger;Landroid/text/style/URLSpan;)V
    .locals 0
...
.method private synthetic Dl(ZLcom/android/camera/data/data/j;)V
    .locals 1
...
.method private synthetic El(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    .locals 0
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/fragment/beauty/TsBeautyParamsFragment;->zl(Ljava/lang/String;)V
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/beauty/TsBeautyParamsFragment;->Ok()Ljava/lang/String;
    ...
    invoke-interface {p2, p4, p1, p3, p5}, Lj7/p1;->b1(Ljava/lang/String;Ljava/lang/String;IZ)V

    invoke-virtual {p0}, Lcom/android/camera/fragment/beauty/TsBeautyParamsFragment;->Ok()Ljava/lang/String;

    move-result-object p0

    invoke-static {p0, p1}, Lz7/a;->o0(Ljava/lang/String;Ljava/lang/String;)V

    :cond_1
    return-void
.end method

.method public static synthetic Fl(Lcom/android/camera/data/data/j;)V
    .locals 4
...
.method public static synthetic sl(Lcom/android/camera/fragment/beauty/TsBeautyParamsFragment;Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    .locals 0

    invoke-direct/range {p0 .. p5}, Lcom/android/camera/fragment/beauty/TsBeautyParamsFragment;->El(Landroid/widget/AdapterView;Landroid/view/View;IJ)V

    return-void
.end method

.method public static synthetic tl(Lcom/android/camera/data/data/j;)V
    .locals 0

    invoke-static {p0}, Lcom/android/camera/fragment/beauty/TsBeautyParamsFragment;->Fl(Lcom/android/camera/data/data/j;)V

    return-void
.end method

.method public static synthetic ul(Lcom/android/camera/fragment/beauty/TsBeautyParamsFragment;ZLcom/android/camera/data/data/j;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/camera/fragment/beauty/TsBeautyParamsFragment;->Bl(ZLcom/android/camera/data/data/j;)V

    return-void
.end method

.method public static synthetic vl(Lcom/android/camera/fragment/beauty/TsBeautyParamsFragment;ZLcom/android/camera/data/data/j;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/camera/fragment/beauty/TsBeautyParamsFragment;->Dl(ZLcom/android/camera/data/data/j;)V

    return-void
.end method

.method public static synthetic wl(Landroid/text/SpannableStringBuilder;Ljava/util/concurrent/atomic/AtomicInteger;Landroid/text/Spanned;Ljava/util/concurrent/atomic/AtomicInteger;Landroid/text/style/URLSpan;)V
    .locals 0

    invoke-static {p0, p1, p2, p3, p4}, Lcom/android/camera/fragment/beauty/TsBeautyParamsFragment;->Cl(Landroid/text/SpannableStringBuilder;Ljava/util/concurrent/atomic/AtomicInteger;Landroid/text/Spanned;Ljava/util/concurrent/atomic/AtomicInteger;Landroid/text/style/URLSpan;)V

    return-void
.end method

.method public static bridge synthetic xl(Lcom/android/camera/fragment/beauty/TsBeautyParamsFragment;)Ll9/a;
    .locals 0
...
.method public static bridge synthetic yl(Lcom/android/camera/fragment/beauty/TsBeautyParamsFragment;)V
    .locals 0

    invoke-virtual {p0}, Lcom/android/camera/fragment/beauty/TsBeautyParamsFragment;->Gl()V
...
.method public final Al()Z
    ...
    invoke-static {p0}, Lcom/android/camera/z2;->L(Landroid/content/Intent;)Z
...
.method public final Gl()V
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/beauty/BaseBeautyMakeupFragment;->Mk()Ljava/util/List;
...
.method public Hk()V
    ...
    invoke-static {v0, v1}, Lcom/android/camera/c3;->p4(ILcom/android/camera/fragment/beauty/c0;)Z
...
.method public zl(Ljava/lang/String;)V
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/beauty/TsBeautyParamsFragment;->Al()Z
