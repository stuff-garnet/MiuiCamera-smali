...
.method public static synthetic dl(Lcom/android/camera/fragment/FragmentSuperMoon;Lc0/u;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/camera/fragment/FragmentSuperMoon;->nl(Lc0/u;)V

    return-void
.end method

.method public static synthetic el(Lcom/android/camera/fragment/FragmentSuperMoon;Landroid/widget/FrameLayout$LayoutParams;IILandroid/util/Size;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3, p4}, Lcom/android/camera/fragment/FragmentSuperMoon;->ml(Landroid/widget/FrameLayout$LayoutParams;IILandroid/util/Size;)V

    return-void
.end method

.method public static synthetic fl(Lj7/z2;)V
    .locals 0

    invoke-static {p0}, Lcom/android/camera/fragment/FragmentSuperMoon;->ll(Lj7/z2;)V
...
.method private synthetic ml(Landroid/widget/FrameLayout$LayoutParams;IILandroid/util/Size;)V
    .locals 1
    ...
    invoke-virtual {p0, p1, p2}, Lcom/android/camera/fragment/FragmentSuperMoon;->Vk(Landroid/view/View;I)V

    return-void
.end method

.method private synthetic nl(Lc0/u;)V
    .locals 0

    invoke-virtual {p0, p1}, Lcom/android/camera/fragment/FragmentWatermarkBase;->wh(Lc0/u;)V
...
.method public E1(Lc0/u;Z)V
    ...
    invoke-direct {v0, p0, p1}, Lcom/android/camera/fragment/b4;-><init>(Lcom/android/camera/fragment/FragmentSuperMoon;Lc0/u;)V
...
.method public Pk(ILjava/lang/String;)Le0/e;
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/FragmentSuperMoon;->jl()Le0/e;
    ...
    invoke-virtual {p0, p1, v0}, Lcom/android/camera/fragment/FragmentSuperMoon;->Vk(Landroid/view/View;I)V
    ...
    :sswitch_0
    const-string/jumbo p1, "super_moon_text_6"
    ...
    :sswitch_1
    const-string/jumbo p1, "super_moon_text_4"
    ...
    :sswitch_2
    const-string/jumbo p1, "super_moon_text_1"
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/FragmentSuperMoon;->kl()Le0/e;
    ...
    :pswitch_0
    invoke-virtual {p0}, Lcom/android/camera/fragment/FragmentSuperMoon;->il()Le0/e;
    ...
    :pswitch_1
    invoke-virtual {p0}, Lcom/android/camera/fragment/FragmentSuperMoon;->hl()Le0/e;
    ...
    :pswitch_2
    invoke-virtual {p0}, Lcom/android/camera/fragment/FragmentSuperMoon;->gl()Le0/e;
...
.method public Zk(Lx0/c;Lc0/u;)V
    ...
    invoke-virtual {p0, p2, v0}, Lcom/android/camera/fragment/FragmentSuperMoon;->ol(Lc0/u;Lc0/u;)V

    invoke-super {p0, p1, p2}, Lcom/android/camera/fragment/FragmentWatermarkBase;->Zk(Lx0/c;Lc0/u;)V
...
.method public cl()V
    ...
    invoke-virtual {p0, v3, v0, v1, v8}, Lcom/android/camera/fragment/FragmentWatermarkBase;->bl(Landroid/graphics/Rect;Lx0/c;Lc0/u;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v8, v6}, Lcom/android/camera/fragment/FragmentSuperMoon;->Vk(Landroid/view/View;I)V
    ...
    invoke-virtual {p0, v3, v0, v2, v5}, Lcom/android/camera/fragment/FragmentWatermarkBase;->bl(Landroid/graphics/Rect;Lx0/c;Lc0/u;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0, v6}, Lcom/android/camera/fragment/FragmentSuperMoon;->Vk(Landroid/view/View;I)V
    ...
    invoke-virtual {p0, v1}, Lcom/android/camera/fragment/FragmentSuperMoon;->pl(Lc0/u;)V

    invoke-virtual {p0, v4}, Lcom/android/camera/fragment/FragmentWatermarkBase;->Y2(I)V

    goto :goto_2

    :cond_4
    invoke-virtual {p0, v6}, Lcom/android/camera/fragment/FragmentWatermarkBase;->Y2(I)V
...
.method public notifyLayoutChange()V
    ...
    invoke-virtual {p0, v1, v0}, Lcom/android/camera/fragment/FragmentSuperMoon;->Vk(Landroid/view/View;I)V

    :cond_0
    return-void
.end method

.method public final ol(Lc0/u;Lc0/u;)V
    .locals 1
    ...
    new-instance p1, Lcom/android/camera/fragment/d4;

    invoke-direct {p1}, Lcom/android/camera/fragment/d4;-><init>()V
...
.method public final pl(Lc0/u;)V
    .locals 9
    ...
    invoke-static {p1, v1}, Lff/c;->e(Landroid/content/Context;I)Landroid/util/Size;
    ...
    invoke-direct/range {v3 .. v8}, Lcom/android/camera/fragment/c4;-><init>(Lcom/android/camera/fragment/FragmentSuperMoon;Landroid/widget/FrameLayout$LayoutParams;IILandroid/util/Size;)V
