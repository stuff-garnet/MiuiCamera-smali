...
.implements Lcom/android/camera/k4;
...
.field protected mCubicEaseOut:Ltq/m;
...
.field protected mFilterGLThread:Lgk/n;
...
.method public static synthetic Ck(Lcom/android/camera/fragment/FragmentFilter;)V
    .locals 0
...
.method public static synthetic Dk(Lcom/android/camera/fragment/FragmentFilter;)V
    .locals 0
...
.method public static synthetic Ek(I)Z
    .locals 0
...
.method private synthetic lambda$drawRealtimeFilterOnGLThread$2()V
    ...
    invoke-interface {v3}, Lcom/android/camera/ui/h1;->m1()Ljava/lang/Object;
    ...
    invoke-interface {v2}, Lcom/android/camera/ui/h1;->n1()[F
    ...
    :try_start_0
    invoke-virtual {v5}, Lcom/android/camera/fragment/EffectItemAdapter$EffectItemHolder;->getEglSurface()Lgk/g;
    ...
    invoke-virtual {v6}, Lgk/f;->e()I

    move-result v8

    invoke-virtual {v6}, Lgk/f;->d()I
    ...
    invoke-static {v10, v11}, Lif/c;->e(II)Landroid/graphics/Rect;
...
.method private releaseGL()V
    ...
    iget-object v1, p0, Lcom/android/camera/fragment/FragmentFilter;->mFilterGLThread:Lgk/n;

    const/4 v3, 0x0

    if-eqz v1, :cond_0

    invoke-virtual {v1}, Lgk/n;->e()Landroid/os/Handler;
    ...
    new-instance v4, Lcom/android/camera/fragment/d3;

    invoke-direct {v4, p0}, Lcom/android/camera/fragment/d3;-><init>(Lcom/android/camera/fragment/FragmentFilter;)V

    invoke-virtual {v1, v4}, Landroid/os/Handler;->post(Ljava/lang/Runnable;)Z

    :cond_1
    iput-object v3, p0, Lcom/android/camera/fragment/FragmentFilter;->mFilterGLThread:Lgk/n;
...
.method public drawRealtimeFilterOnGLThread()V
    ...
    iget-object v0, p0, Lcom/android/camera/fragment/FragmentFilter;->mFilterGLThread:Lgk/n;
    ...
    new-instance v0, Lcom/android/camera/fragment/c3;

    invoke-direct {v0, p0}, Lcom/android/camera/fragment/c3;-><init>(Lcom/android/camera/fragment/FragmentFilter;)V
    ...
    invoke-virtual {v0, p0}, Lgk/n;->j(Ljava/lang/Runnable;)Z
...
.method public getFilterInfo()Ljava/util/ArrayList;
    ...
    invoke-direct {v0}, Lcom/android/camera/fragment/b3;-><init>()V
...
.method public initGL()V
    ...
    invoke-interface {v1}, Lcom/android/camera/ui/h1;->b1()Lgk/n;

    move-result-object v1

    iput-object v1, p0, Lcom/android/camera/fragment/FragmentFilter;->mFilterGLThread:Lgk/n;
...
.method public initView(Landroid/view/View;)V
    ...
    iget-object v2, p0, Lcom/android/camera/fragment/FragmentFilter;->mFilterGLThread:Lgk/n;
    ...
    invoke-virtual {v2}, Lgk/n;->d()Lgk/d;

    move-result-object v2

    invoke-direct {v3, v0, p1, v4, v2}, Lcom/android/camera/fragment/EffectItemAdapter;-><init>(Landroid/content/Context;Lcom/android/camera/data/data/b;ZLgk/d;)V
    ...
    iput-object p1, p0, Lcom/android/camera/fragment/FragmentFilter;->mCubicEaseOut:Ltq/m;
...
.method public onClick(Landroid/view/View;)V
    ...
    invoke-interface {p1}, Lm7/g;->Xe()V
...
.method public onItemSelected(IZ)V
    ...
    invoke-static {v4, p2}, Lz7/a;->A1(IZ)V
    ...
    invoke-static {p2}, Lcom/android/camera2/g;->P3(Lcom/android/camera2/f;)Z
    ...
    invoke-interface {v1, v3, v0, v0, v3}, Lj7/a0;->z6(ZLjava/lang/String;Ljava/lang/String;Z)V

    :cond_3
    invoke-interface {v1, v4}, Lj7/a0;->V9(I)V
    :try_end_0
...
.method public onPause()V
    ...
    invoke-interface {v0, p0}, Lcom/android/camera/ui/h1;->I0(Lcom/android/camera/a3$b;)V
...
.method public onResume()V
    ...
    invoke-interface {v0, p0}, Lcom/android/camera/ui/h1;->H1(Lcom/android/camera/a3$b;)V
