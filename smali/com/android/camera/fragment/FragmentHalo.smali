...
.method public static synthetic Ik(Ld6/j0;)V
    ...
    invoke-static {p0}, Lcom/android/camera/fragment/FragmentHalo;->Lk(Ld6/j0;)V
...
# virtual methods
.method public final Jk()[Landroid/graphics/Point;
    .locals 4
    ...
    invoke-interface {p0, v2, v0}, Lj7/n2;->M9(ZLandroid/graphics/Point;)Z

    const/4 v3, 0x1

    invoke-interface {p0, v3, v1}, Lj7/n2;->M9(ZLandroid/graphics/Point;)Z
...
.method public final Mk(I)V
    ...
    invoke-static {v1}, Lcom/android/camera/o6;->J4(I)V
...
.method public final Nk(ZLandroid/graphics/Rect;)V
    .locals 2
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/FragmentHalo;->Jk()[Landroid/graphics/Point;
...
.method public final Ok()V
    ...
    invoke-virtual {p0, v2}, Lcom/android/camera/fragment/FragmentHalo;->Mk(I)V

    goto :goto_0

    :cond_0
    invoke-virtual {p0}, Lcom/android/camera/fragment/FragmentHalo;->dk()V
...
.method public fg(Z)V
    ...
    invoke-static {p1, v0}, Lcom/android/camera/c3;->I8(ILjava/lang/String;)V

    invoke-virtual {p0}, Lcom/android/camera/fragment/BaseFragment;->getBaseModule()Ljava/util/Optional;

    move-result-object p0

    new-instance p1, Lcom/android/camera/fragment/f3;

    invoke-direct {p1}, Lcom/android/camera/fragment/f3;-><init>()V
...
.method public i2()V
    ...
    invoke-interface {v0, v3, v1}, Lj7/n2;->g5(ZLandroid/graphics/Point;)Z

    const/4 v3, 0x1

    invoke-interface {v0, v3, v2}, Lj7/n2;->g5(ZLandroid/graphics/Point;)Z
...
.method public initView(Landroid/view/View;)V
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/FragmentHalo;->i2()V

    invoke-virtual {p0}, Lcom/android/camera/fragment/FragmentHalo;->Ok()V

    goto :goto_0

    :cond_0
    invoke-virtual {p0}, Lcom/android/camera/fragment/FragmentHalo;->Kk()V
...
.method public notifyAfterFrameAvailable(I)V
    ...
    invoke-interface {p0}, Lj7/o1;->Vh()V
...
.method public notifyThemeChanged(ILjava/util/List;I)V
    ...
    invoke-virtual {p0, p2, p3}, Lcom/android/camera/fragment/FragmentHalo;->Nk(ZLandroid/graphics/Rect;)V

    invoke-virtual {p0, p1}, Lcom/android/camera/fragment/FragmentHalo;->Mk(I)V
...
.method public provideAnimateElement(ILjava/util/List;I)V
    ...
    :cond_0
    invoke-virtual {p0, p3}, Lcom/android/camera/fragment/FragmentHalo;->Mk(I)V
...
.method public updateView(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v0, p1}, Lcom/android/camera/fragment/FragmentHalo;->Nk(ZLandroid/graphics/Rect;)V

    :cond_0
    return-void
.end method

.method public zd(ZZ)V
    .locals 1
