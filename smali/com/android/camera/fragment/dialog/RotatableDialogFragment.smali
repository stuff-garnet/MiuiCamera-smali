...
.method public static synthetic Ck(Landroid/content/DialogInterface;ILandroid/view/KeyEvent;)Z
    .locals 0

    invoke-static {p0, p1, p2}, Lcom/android/camera/fragment/dialog/RotatableDialogFragment;->Gk(Landroid/content/DialogInterface;ILandroid/view/KeyEvent;)Z
...
.method public static synthetic Dk(Lcom/android/camera/fragment/dialog/RotatableDialogFragment;Landroid/app/Dialog;ILandroid/content/DialogInterface;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/android/camera/fragment/dialog/RotatableDialogFragment;->Ik(Landroid/app/Dialog;ILandroid/content/DialogInterface;)V

    return-void
.end method

.method public static synthetic Ek(Lcom/android/camera/fragment/dialog/RotatableDialogFragment;Landroid/content/DialogInterface;I)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/camera/fragment/dialog/RotatableDialogFragment;->Hk(Landroid/content/DialogInterface;I)V

    return-void
.end method

.method public static synthetic Gk(Landroid/content/DialogInterface;ILandroid/view/KeyEvent;)Z
    .locals 0
...
.method private synthetic Ik(Landroid/app/Dialog;ILandroid/content/DialogInterface;)V
    .locals 2
    ...
    invoke-virtual {p0, p2}, Lcom/android/camera/fragment/dialog/RotatableDialogFragment;->Lk(I)V
...
# virtual methods
.method public final Fk(Landroid/os/Bundle;Lcom/android/camera2/r3;)Lmiuix/appcompat/app/AlertDialog$a;
    .locals 6
    ...
    invoke-virtual {v4, v0}, Lmiuix/appcompat/app/AlertDialog$a;->X(I)Lmiuix/appcompat/app/AlertDialog$a;

    :cond_0
    if-eq v2, v1, :cond_1

    invoke-virtual {v4, v2}, Lmiuix/appcompat/app/AlertDialog$a;->y(I)Lmiuix/appcompat/app/AlertDialog$a;
    ...
    invoke-virtual {v4, p0}, Lmiuix/appcompat/app/AlertDialog$a;->b0(Landroid/view/View;)Lmiuix/appcompat/app/AlertDialog$a;

    :cond_2
    if-eq v3, v1, :cond_3

    invoke-virtual {v4, v3, p2}, Lmiuix/appcompat/app/AlertDialog$a;->P(ILandroid/content/DialogInterface$OnClickListener;)Lmiuix/appcompat/app/AlertDialog$a;

    :cond_3
    if-eq p1, v1, :cond_4

    invoke-virtual {v4, p1, p2}, Lmiuix/appcompat/app/AlertDialog$a;->D(ILandroid/content/DialogInterface$OnClickListener;)Lmiuix/appcompat/app/AlertDialog$a;

    :cond_4
    const/4 p0, 0x1

    invoke-virtual {v4, p0}, Lmiuix/appcompat/app/AlertDialog$a;->j(Z)Lmiuix/appcompat/app/AlertDialog$a;

    invoke-virtual {v4, p2}, Lmiuix/appcompat/app/AlertDialog$a;->I(Landroid/content/DialogInterface$OnCancelListener;)Lmiuix/appcompat/app/AlertDialog$a;

    new-instance p0, Lcom/android/camera/fragment/dialog/l;

    invoke-direct {p0}, Lcom/android/camera/fragment/dialog/l;-><init>()V

    invoke-virtual {v4, p0}, Lmiuix/appcompat/app/AlertDialog$a;->M(Landroid/content/DialogInterface$OnKeyListener;)Lmiuix/appcompat/app/AlertDialog$a;

    return-object v4
.end method

.method public Jk(Landroidx/fragment/app/FragmentManager;)V
    .locals 0
    ...
    invoke-static {p1, p0}, Lff/d;->d(Landroidx/fragment/app/FragmentManager;Ljava/lang/String;)Z

    return-void
.end method

.method public Kk(IIIII)V
    .locals 2
...
.method public Lk(I)V
    ...
    :cond_0
    invoke-static {v0}, Lqn/t;->o(Landroid/view/View;)Landroid/graphics/Point;
...
.method public onCreateDialog(Landroid/os/Bundle;)Landroid/app/Dialog;
    ...
    invoke-virtual {p0, v0, v1}, Lcom/android/camera/fragment/dialog/RotatableDialogFragment;->Fk(Landroid/os/Bundle;Lcom/android/camera2/r3;)Lmiuix/appcompat/app/AlertDialog$a;
