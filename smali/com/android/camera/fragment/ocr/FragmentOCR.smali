...
.method public static synthetic Ik(Lj7/o;)V
    .locals 0

    invoke-static {p0}, Lcom/android/camera/fragment/ocr/FragmentOCR;->Rk(Lj7/o;)V

    return-void
.end method

.method public static synthetic Jk(Lj7/o;)V
    .locals 0

    invoke-static {p0}, Lcom/android/camera/fragment/ocr/FragmentOCR;->Pk(Lj7/o;)V

    return-void
.end method

.method public static synthetic Kk(Lcom/android/camera/fragment/ocr/FragmentOCR;)V
    .locals 0

    invoke-virtual {p0}, Lcom/android/camera/fragment/ocr/FragmentOCR;->Ok()V
...
.method public static synthetic Lk(Lj7/c1;)V
    ...
    invoke-static {p0}, Lcom/android/camera/fragment/ocr/FragmentOCR;->Sk(Lj7/c1;)V

    return-void
.end method

.method public static synthetic Mk(Lcom/android/camera/fragment/ocr/FragmentOCR;Ljava/lang/Boolean;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/camera/fragment/ocr/FragmentOCR;->Qk(Ljava/lang/Boolean;)V
...
.method public static synthetic Pk(Lj7/o;)V
    ...
    invoke-interface {p0, v0}, Lj7/o;->S7(Z)V
...
.method private synthetic Qk(Ljava/lang/Boolean;)V
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/ocr/FragmentOCR;->kj()V

    :cond_0
    return-void
.end method

.method public static synthetic Rk(Lj7/o;)V
    .locals 1
...
.method public Kc(Lcom/xiaomi/ocr/sdk_ocr/OCRData$Location;)V
    .locals 10
    ...
    invoke-static {v2}, Lz7/a;->J2(Ljava/lang/String;)V
...
.method public final Nk()V
    ...
    iget-object p0, p0, Lcom/android/camera/fragment/ocr/FragmentOCR;->c:Lpp/g;
...
.method public Oc(Landroid/view/View;I)V
    .locals 4
    ...
    iget-object v0, p0, Lcom/android/camera/fragment/ocr/FragmentOCR;->c:Lpp/g;
    ...
    const-string/jumbo v0, "showFirstUseBubble: start show"
    ...
    invoke-direct {v0, v2}, Lpp/g;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/android/camera/fragment/ocr/FragmentOCR;->c:Lpp/g;

    const/16 v2, 0xbb8

    invoke-virtual {v0, v2}, Lpp/g;->I(I)V

    iget-object v0, p0, Lcom/android/camera/fragment/ocr/FragmentOCR;->c:Lpp/g;

    const v2, 0x7f130782

    invoke-virtual {v0, v2}, Lpp/g;->F(I)V
    ...
    invoke-virtual {v0, p1, p2, v1, v2}, Lpp/g;->K(Landroid/view/View;IIZ)V

    goto :goto_0

    :cond_1
    iget-object p2, p0, Lcom/android/camera/fragment/ocr/FragmentOCR;->c:Lpp/g;

    const/16 v0, 0x10

    invoke-virtual {p2, v0}, Lpp/a;->m(I)V

    iget-object p2, p0, Lcom/android/camera/fragment/ocr/FragmentOCR;->c:Lpp/g;

    invoke-virtual {p2, p1, v2}, Lpp/g;->L(Landroid/view/View;Z)V
...
.method public final Ok()V
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/ocr/FragmentOCR;->Nk()V
...
.method public notifyDataChanged(II)V
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/ocr/FragmentOCR;->Tk()V
