...
.method public static synthetic a(Lj7/j1;Lag/b;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/android/camera/fragment/top/FragmentTopAlert$i;->d(Lj7/j1;Lag/b;)V
...
.method public static synthetic d(Lj7/j1;Lag/b;)V
    .locals 1

    invoke-interface {p1}, Lag/b;->f()Z

    move-result v0

    if-nez v0, :cond_0

    invoke-interface {p1}, Lag/b;->E()Z

    move-result p1

    if-nez p1, :cond_0

    invoke-interface {p0}, Lj7/j1;->Y8()V
...
.method public static synthetic e(Lj7/j1;)V
    ...
    invoke-static {}, Lag/b;->impl()Ljava/util/Optional;
...
.method public run()V
    ...
    invoke-static {p0}, Lcom/android/camera/fragment/top/FragmentTopAlert;->Ll(Lcom/android/camera/fragment/top/FragmentTopAlert;)Landroid/widget/LinearLayout;
