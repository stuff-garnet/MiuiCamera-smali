...
.method public static synthetic Ik(Lcom/android/camera/fragment/FragmentWatermarkBase;Le0/e;Lc0/u;Landroid/graphics/Rect;Lx0/c;Ljava/util/concurrent/atomic/AtomicBoolean;)V
    .locals 0

    invoke-direct/range {p0 .. p5}, Lcom/android/camera/fragment/FragmentWatermarkBase;->Sk(Le0/e;Lc0/u;Landroid/graphics/Rect;Lx0/c;Ljava/util/concurrent/atomic/AtomicBoolean;)V

    return-void
.end method

.method public static synthetic Jk(Lcom/android/camera/fragment/FragmentWatermarkBase;Landroid/view/View;Landroid/view/View;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/camera/fragment/FragmentWatermarkBase;->Rk(Landroid/view/View;Landroid/view/View;)V

    return-void
.end method

.method public static synthetic Kk(Lcom/android/camera/fragment/FragmentWatermarkBase;Landroid/view/View;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/camera/fragment/FragmentWatermarkBase;->Qk(Landroid/view/View;)V

    return-void
.end method

.method public static synthetic Lk(Lcom/android/camera/fragment/FragmentWatermarkBase;Le0/e;Lc0/u;Ljava/util/concurrent/atomic/AtomicBoolean;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/android/camera/fragment/FragmentWatermarkBase;->Tk(Le0/e;Lc0/u;Ljava/util/concurrent/atomic/AtomicBoolean;)V
...
.method private synthetic Rk(Landroid/view/View;Landroid/view/View;)V
    .locals 2
    ...
    :cond_0
    new-instance p2, Lcom/android/camera/fragment/s4;

    invoke-direct {p2, p0, p1}, Lcom/android/camera/fragment/s4;-><init>(Lcom/android/camera/fragment/FragmentWatermarkBase;Landroid/view/View;)V
...
.method private synthetic Sk(Le0/e;Lc0/u;Landroid/graphics/Rect;Lx0/c;Ljava/util/concurrent/atomic/AtomicBoolean;)V
    .locals 3
    ...
    invoke-virtual {p0, v0, p3, p4, p2}, Lcom/android/camera/fragment/FragmentWatermarkBase;->al([ILandroid/graphics/Rect;Lx0/c;Lc0/u;)V

    invoke-virtual {p0, p1, p2}, Lcom/android/camera/fragment/FragmentWatermarkBase;->Xk(Le0/e;Lc0/u;)Z
...
.method private synthetic Tk(Le0/e;Lc0/u;Ljava/util/concurrent/atomic/AtomicBoolean;)V
    .locals 1
...
# virtual methods
.method public Mk(Landroid/view/View;)V
    .locals 1
    ...
    invoke-direct {v0, p0, p1}, Lcom/android/camera/fragment/t4;-><init>(Lcom/android/camera/fragment/FragmentWatermarkBase;Landroid/view/View;)V
...
.method public Ok()Landroid/graphics/Rect;
    .locals 2
...
.method public abstract Pk(ILjava/lang/String;)Le0/e;
.end method

.method public abstract Uk(Lc0/u;Le0/e;Landroid/widget/FrameLayout$LayoutParams;)V
.end method

.method public Vk(Landroid/view/View;I)V
    .locals 1
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/fragment/FragmentWatermarkBase;->Wk(Landroid/view/View;)V
...
.method public Wk(Landroid/view/View;)V
    .locals 3
...
.method public Xk(Le0/e;Lc0/u;)Z
    ...
    invoke-virtual {p0, v0, v1}, Lcom/android/camera/fragment/FragmentWatermarkBase;->Vk(Landroid/view/View;I)V

    invoke-interface {p1}, Le0/e;->h()Landroid/view/View;

    move-result-object p1

    invoke-virtual {p0, p1}, Lcom/android/camera/fragment/FragmentWatermarkBase;->Yk(Landroid/view/View;)V
...
.method public Y2(I)V
    ...
    invoke-virtual {p0, v0, p1}, Lcom/android/camera/fragment/FragmentWatermarkBase;->Vk(Landroid/view/View;I)V

    return-void
.end method

.method public abstract Yk(Landroid/view/View;)V
.end method

.method public Zk(Lx0/c;Lc0/u;)V
    .locals 0
...
.method public abstract al([ILandroid/graphics/Rect;Lx0/c;Lc0/u;)V
.end method

.method public bl(Landroid/graphics/Rect;Lx0/c;Lc0/u;Ljava/lang/String;)V
    .locals 16
    ...
    invoke-virtual {v7, v0, v1}, Lcom/android/camera/fragment/FragmentWatermarkBase;->Pk(ILjava/lang/String;)Le0/e;
    ...
    invoke-virtual {v7, v8, v12, v0}, Lcom/android/camera/fragment/FragmentWatermarkBase;->Uk(Lc0/u;Le0/e;Landroid/widget/FrameLayout$LayoutParams;)V
    ...
    new-instance v15, Lcom/android/camera/fragment/q4;
    ...
    invoke-direct/range {v0 .. v6}, Lcom/android/camera/fragment/q4;-><init>(Lcom/android/camera/fragment/FragmentWatermarkBase;Le0/e;Lc0/u;Landroid/graphics/Rect;Lx0/c;Ljava/util/concurrent/atomic/AtomicBoolean;)V
    ...
    invoke-direct {v1, v7, v12, v8, v13}, Lcom/android/camera/fragment/r4;-><init>(Lcom/android/camera/fragment/FragmentWatermarkBase;Le0/e;Lc0/u;Ljava/util/concurrent/atomic/AtomicBoolean;)V
    ...
    invoke-virtual {v7, v0}, Lcom/android/camera/fragment/FragmentWatermarkBase;->Mk(Landroid/view/View;)V
...
.method public cl()V
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/android/camera/fragment/FragmentWatermarkBase;->Ok()Landroid/graphics/Rect;
    ...
    invoke-virtual {p0, v1, v0, v2, v3}, Lcom/android/camera/fragment/FragmentWatermarkBase;->bl(Landroid/graphics/Rect;Lx0/c;Lc0/u;Ljava/lang/String;)V
...
.method public updateView(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/FragmentWatermarkBase;->Nk()F
...
.method public wh(Lc0/u;)V
    ...
    invoke-virtual {p0, v0, p1}, Lcom/android/camera/fragment/FragmentWatermarkBase;->Zk(Lx0/c;Lc0/u;)V
