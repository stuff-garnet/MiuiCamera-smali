...
.method public a()V
    ...
    iput v0, p0, Lcom/android/camera/e3;->f:I
...
.method public d(Lcom/android/gallery3d/ui/h;Lcom/android/gallery3d/ui/l;)Z
    ...
    iget-wide v5, v0, Lcom/android/camera/e3;->a:J
    ...
    :goto_0
    iget v7, v0, Lcom/android/camera/e3;->f:I
    ...
    :goto_2
    iget v11, v0, Lcom/android/camera/e3;->f:I
    ...
    iget v4, v0, Lcom/android/camera/e3;->d:F

    float-to-int v4, v4

    iget v5, v0, Lcom/android/camera/e3;->e:F

    float-to-int v5, v5

    iget v6, v0, Lcom/android/camera/e3;->b:I

    iget v0, v0, Lcom/android/camera/e3;->c:I

    invoke-static {v4, v5, v6, v0}, Lif/c;->f(IIII)Landroid/graphics/Rect;
    ...
    iget v11, v0, Lcom/android/camera/e3;->b:I

    iget v12, v0, Lcom/android/camera/e3;->c:I

    invoke-static {v4, v5, v11, v12}, Lif/c;->f(IIII)Landroid/graphics/Rect;
    ...
    iget v3, v0, Lcom/android/camera/e3;->d:F

    float-to-int v12, v3

    iget v3, v0, Lcom/android/camera/e3;->e:F

    float-to-int v13, v3

    iget v14, v0, Lcom/android/camera/e3;->b:I

    iget v15, v0, Lcom/android/camera/e3;->c:I
    ...
    iget v8, v0, Lcom/android/camera/e3;->b:I

    iget v11, v0, Lcom/android/camera/e3;->c:I

    invoke-static {v4, v5, v8, v11}, Lif/c;->f(IIII)Landroid/graphics/Rect;
...
.method public e(Lcom/android/gallery3d/ui/h;Lcom/android/gallery3d/ui/l;)V
    ...
    iget v1, p0, Lcom/android/camera/e3;->d:F

    float-to-int v1, v1

    iget v2, p0, Lcom/android/camera/e3;->e:F

    float-to-int v2, v2

    iget v3, p0, Lcom/android/camera/e3;->b:I

    iget p0, p0, Lcom/android/camera/e3;->c:I

    invoke-static {v1, v2, v3, p0}, Lif/c;->f(IIII)Landroid/graphics/Rect;
...
.method public f(IIII)V
    ...
    iput-wide v0, p0, Lcom/android/camera/e3;->a:J

    iput p3, p0, Lcom/android/camera/e3;->b:I

    iput p4, p0, Lcom/android/camera/e3;->c:I

    int-to-float p1, p1

    iput p1, p0, Lcom/android/camera/e3;->d:F

    int-to-float p1, p2

    iput p1, p0, Lcom/android/camera/e3;->e:F
