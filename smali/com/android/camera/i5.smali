...
.field public static final g:Lef/b;
...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v0}, Lcom/android/camera/i5$a;-><init>()V

    sput-object v0, Lcom/android/camera/i5;->g:Lef/b;
...
.method public static e()Lcom/android/camera/i5;
    .locals 1

    sget-object v0, Lcom/android/camera/i5;->g:Lef/b;

    invoke-virtual {v0}, Lef/b;->b()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lcom/android/camera/i5;
...
.method public final a(Ljava/io/IOException;)V
    ...
    invoke-virtual {p0}, Lcom/android/camera/i5;->b()Landroid/os/MemoryFile;
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/i5;->j(Landroid/os/MemoryFile;)V

    iput v0, p0, Lcom/android/camera/i5;->b:I

    iput v0, p0, Lcom/android/camera/i5;->c:I

    iput v0, p0, Lcom/android/camera/i5;->d:I

    iput-object p1, p0, Lcom/android/camera/i5;->e:Landroid/net/Uri;
...
.method public final declared-synchronized b()Landroid/os/MemoryFile;
    ...
    :try_start_0
    iget-object v0, p0, Lcom/android/camera/i5;->a:Landroid/os/MemoryFile;
    :try_end_0
...
.method public declared-synchronized c()I
    ...
    :try_start_0
    iget v0, p0, Lcom/android/camera/i5;->d:I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized f()Landroid/os/ParcelFileDescriptor;
    ...
    invoke-static {v0}, Lnf/e;->a(Landroid/os/MemoryFile;)Ljava/io/FileDescriptor;
...
.method public declared-synchronized g()Landroid/net/Uri;
    ...
    :try_start_0
    iget-object v0, p0, Lcom/android/camera/i5;->e:Landroid/net/Uri;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized h()I
    ...
    :try_start_0
    iget v0, p0, Lcom/android/camera/i5;->b:I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized i(Landroid/net/Uri;Landroid/graphics/Bitmap;)Z
    ...
    invoke-virtual {p0, v3}, Lcom/android/camera/i5;->j(Landroid/os/MemoryFile;)V

    invoke-virtual {p2}, Landroid/graphics/Bitmap;->getWidth()I

    move-result v2

    iput v2, p0, Lcom/android/camera/i5;->b:I

    invoke-virtual {p2}, Landroid/graphics/Bitmap;->getHeight()I

    move-result p2

    iput p2, p0, Lcom/android/camera/i5;->c:I

    iput v1, p0, Lcom/android/camera/i5;->d:I
    ...
    :try_start_2
    invoke-virtual {p0, p1}, Lcom/android/camera/i5;->a(Ljava/io/IOException;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
...
.method public final declared-synchronized j(Landroid/os/MemoryFile;)V
    ...
    :try_start_0
    iput-object p1, p0, Lcom/android/camera/i5;->a:Landroid/os/MemoryFile;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
