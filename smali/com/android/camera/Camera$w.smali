...
.method private synthetic c(Lj7/h;)V
    ...
    invoke-interface {p1, p0}, Lj7/h;->q(I)V
...
.method private synthetic d(Lj7/h2;)V
    ...
    invoke-interface {p1, p0}, Lj7/h2;->Q2(I)V
...
.method public final e(IIZI)V
    ...
    invoke-static {p1, v0}, Lcom/android/camera/o6;->n3(II)Z
    ...
    iget-object v1, v1, Lcom/android/camera/ActivityBase;->K2:Lcom/android/camera/ui/CameraRootView;

    const/16 v2, 0x7d0

    invoke-virtual {v0, v1, v2}, Lid/d;->j(Landroid/view/View;I)V
    ...
    invoke-static {p1}, Lcom/android/camera/Camera;->um(Lcom/android/camera/Camera;)Lcom/android/camera/fragment/v;
    ...
    invoke-direct {p2, p0}, Lcom/android/camera/n2;-><init>(Lcom/android/camera/Camera$w;)V
    ...
    invoke-direct {p2, p0}, Lcom/android/camera/o2;-><init>(Lcom/android/camera/Camera$w;)V
...
.method public onOrientationChanged(I)V
    ...
    invoke-static {p1, v1}, Lcom/android/camera/o6;->u4(II)I
    ...
    iget-object v6, v5, Lcom/android/camera/ActivityBase;->K1:Lcom/android/camera/ui/h1;

    if-eqz v6, :cond_2

    iget v5, v5, Lcom/android/camera/ActivityBase;->m:I

    invoke-interface {v6, v5}, Lcom/android/camera/ui/h1;->q(I)V

    :cond_2
    iget-object v5, p0, Lcom/android/camera/Camera$w;->a:Lcom/android/camera/Camera;

    invoke-static {v5}, Lcom/android/camera/Camera;->wm(Lcom/android/camera/Camera;)Z
    ...
    invoke-static {v5, v3}, Lcom/android/camera/Camera;->Dm(Lcom/android/camera/Camera;Z)V
