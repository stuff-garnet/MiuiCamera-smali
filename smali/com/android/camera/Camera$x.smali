...
.method public synthetic constructor <init>(Lcom/android/camera/Camera;Lcom/android/camera/p2;)V
    .locals 0
...
.method public surfaceChanged(Landroid/view/SurfaceHolder;III)V
    ...
    invoke-static {p2}, Lcom/android/camera/Camera;->tm(Lcom/android/camera/Camera;)Ljava/lang/String;
    ...
    iget-object p2, p2, Lcom/android/camera/ActivityBase;->e:Ld6/d5;
    ...
    iget v1, p2, Lcom/android/camera/d3;->a:I

    if-ne v1, p3, :cond_0

    iget p3, p2, Lcom/android/camera/d3;->b:I
    ...
    invoke-static {p0}, Lcom/android/camera/Camera;->tm(Lcom/android/camera/Camera;)Ljava/lang/String;
    ...
    iget-object p2, p2, Lcom/android/camera/ActivityBase;->K1:Lcom/android/camera/ui/h1;
    ...
    invoke-interface {p2, p1}, Lcom/android/camera/ui/h1;->Y0(Landroid/view/Surface;)V

    iget-object p0, p0, Lcom/android/camera/Camera$x;->a:Lcom/android/camera/Camera;

    const/4 p1, 0x4

    invoke-virtual {p0, p1}, Lcom/android/camera/Camera;->K0(I)V
...
.method public surfaceDestroyed(Landroid/view/SurfaceHolder;)V
    ...
    invoke-static {p1}, Lcom/android/camera/Camera;->tm(Lcom/android/camera/Camera;)Ljava/lang/String;
    ...
    iget-object p1, p1, Lcom/android/camera/ActivityBase;->e:Ld6/d5;

    if-eqz p1, :cond_0

    invoke-interface {p1}, Ld6/d5;->M9()Z
    ...
    iget-object p1, p1, Lcom/android/camera/ActivityBase;->K1:Lcom/android/camera/ui/h1;

    if-eqz p1, :cond_1

    const/4 v1, 0x0

    invoke-interface {p1, v1}, Lcom/android/camera/ui/h1;->Y0(Landroid/view/Surface;)V
