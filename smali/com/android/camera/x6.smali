...
.method public static synthetic a(Lorg/xmlpull/v1/XmlSerializer;Ljava/lang/Class;Lzb/g;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lcom/android/camera/x6;->d(Lorg/xmlpull/v1/XmlSerializer;Ljava/lang/Class;Lzb/g;)V
...
.method public static c(Lorg/xmlpull/v1/XmlSerializer;Lc/i;J)V
    ...
    invoke-virtual {v0, p1}, Lyb/a;->a(Lc/i;)Ljava/util/Map;
...
.method public static synthetic d(Lorg/xmlpull/v1/XmlSerializer;Ljava/lang/Class;Lzb/g;)V
    .locals 0

    instance-of p1, p2, Lzb/b;

    if-nez p1, :cond_0

    instance-of p1, p2, Lzb/e;

    if-nez p1, :cond_0

    instance-of p1, p2, Lzb/c;

    if-eqz p1, :cond_1

    :cond_0
    :try_start_0
    invoke-virtual {p2, p0}, Lzb/g;->b(Lorg/xmlpull/v1/XmlSerializer;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
