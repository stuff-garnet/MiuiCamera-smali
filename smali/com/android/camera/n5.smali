...
.method public constructor <init>(Lcom/android/camera/ActivityBase;)V
    ...
    iput-object v2, p0, Lcom/android/camera/n5;->f:Lud/d;
    ...
    new-instance v2, Lud/d$b;

    invoke-direct {v2}, Lud/d$b;-><init>()V

    iput-object v2, p0, Lcom/android/camera/n5;->m:Lud/d$b;

    iput-boolean v0, v2, Lud/d$b;->z:Z
...
.method public static m(Landroid/content/Intent;)Z
    ...
    invoke-static {p0}, Lcom/android/camera/z2;->C(Landroid/content/Intent;)Z
    ...
    :cond_0
    invoke-static {p0}, Lcom/android/camera/z2;->S(Landroid/content/Intent;)Z
...
.method public A()V
    ...
    iget-object v1, p0, Lcom/android/camera/n5;->f:Lud/d;
    ...
    invoke-virtual {v1}, Lud/d;->m()V

    const/4 v1, 0x0

    iput-object v1, p0, Lcom/android/camera/n5;->f:Lud/d;

    :cond_0
    iget-object v1, p0, Lcom/android/camera/n5;->d:Lge/h;
    ...
    iget-object p0, p0, Lcom/android/camera/n5;->d:Lge/h;

    invoke-virtual {p0, v1}, Lge/h;->s(Landroid/os/Bundle;)V
    :try_end_1
    .catch Lge/h$g; {:try_start_1 .. :try_end_1} :catch_0
...
.method public a(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-static {p2}, Lge/j;->n(Landroid/os/Bundle;)Ljava/lang/String;
    ...
    invoke-interface {p0, p1, p2}, Ld6/d5;->Ld(Ljava/lang/String;Landroid/os/Bundle;)V
...
.method public b(ILandroid/os/Bundle;)V
    ...
    invoke-static {p2}, Lge/j;->g(Landroid/os/Bundle;)Ljava/lang/String;

    move-result-object v1

    invoke-static {v0, v1}, Lge/j;->t(Landroid/os/Bundle;Ljava/lang/String;)V

    invoke-static {v0, p1}, Lge/j;->u(Landroid/os/Bundle;I)V
    ...
    invoke-static {v1}, Lpe/a;->h(Ljava/lang/Object;)Ljava/lang/String;
    ...
    iget-object p2, p0, Lcom/android/camera/n5;->f:Lud/d;
    ...
    invoke-virtual {p2}, Lud/d;->m()V

    const/4 p2, 0x0

    iput-object p2, p0, Lcom/android/camera/n5;->f:Lud/d;
    ...
    :cond_2
    invoke-static {p2}, Lge/j;->a(Landroid/os/Bundle;)Landroid/view/Surface;
    ...
    invoke-interface {p0, p1, v0}, Ld6/d5;->Ld(Ljava/lang/String;Landroid/os/Bundle;)V
...
.method public c(ILandroid/os/Bundle;)V
    ...
    invoke-static {p2}, Lge/j;->i(Landroid/os/Bundle;)I
    ...
    invoke-static {p2, p1}, Lge/j;->v(Landroid/os/Bundle;I)V
    ...
    invoke-virtual {p0, p1}, Lhe/t0;->s0(Ljava/lang/String;)V
...
.method public d(I)V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/android/camera/n5;->d:Lge/h;
    ...
    invoke-virtual {p0, v0}, Lge/h;->r(Landroid/os/Bundle;)V
    :try_end_0
    .catch Lge/h$g; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public varargs e([I)V
    ...
    :cond_1
    :goto_1
    iget-object p0, p0, Lcom/android/camera/n5;->f:Lud/d;

    if-eqz p0, :cond_2

    invoke-virtual {p0}, Lud/d;->k()V
...
.method public h(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    :try_start_1
    invoke-virtual {p0, p1, p2}, Lge/h;->f(Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    :try_end_1
    .catch Lge/h$g; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public i(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    :try_start_1
    invoke-virtual {p0, p1, p2}, Lge/h;->g(Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    :try_end_1
    .catch Lge/h$g; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public j()V
    ...
    invoke-static {v1, p0, p0, p0}, Lge/h;->k(Landroid/content/Context;Lge/h$b;Lge/h$d;Lge/h$c;)Lge/h;

    move-result-object v1

    iput-object v1, p0, Lcom/android/camera/n5;->d:Lge/h;
...
.method public l()Z
    ...
    invoke-static {v2, v3, p0}, Lpe/a;->l(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public p()V
    ...
    invoke-static {v0}, Lcom/android/camera/z2;->S(Landroid/content/Intent;)Z
...
.method public r()V
    ...
    :try_start_1
    iget-object v3, p0, Lcom/android/camera/n5;->d:Lge/h;

    if-eqz v3, :cond_1

    if-nez v0, :cond_1

    invoke-virtual {v3, v2}, Lge/h;->s(Landroid/os/Bundle;)V
    ...
    throw v0
    :try_end_2
    .catch Lge/h$g; {:try_start_2 .. :try_end_2} :catch_0
...
.method public s(II)V
    ...
    invoke-static {v1, p1}, Lge/j;->s(Landroid/os/Bundle;I)V

    invoke-static {v1, p2}, Lge/j;->q(Landroid/os/Bundle;I)V

    iget-object p0, p0, Lcom/android/camera/n5;->d:Lge/h;

    const-string p1, "com.xiaomi.camera.rcs.setCapturingMode"

    invoke-virtual {p0, p1, v1}, Lge/h;->g(Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;

    move-result-object p0

    invoke-static {p0}, Lge/j;->d(Landroid/os/Bundle;)I
...
.method public t(Lcom/android/gallery3d/ui/h;Lf2/c;)V
    ...
    iget-object v0, p0, Lcom/android/camera/n5;->f:Lud/d;
    ...
    iget-object v1, p0, Lcom/android/camera/n5;->m:Lud/d$b;

    check-cast p2, Lf2/g;

    invoke-virtual {v1, p2}, Lud/d$b;->h(Lf2/g;)V

    iget-object p2, p0, Lcom/android/camera/n5;->m:Lud/d$b;

    iget v1, p0, Lcom/android/camera/n5;->p:I

    iput v1, p2, Lud/d$b;->y:I
    ...
    :goto_0
    iput-boolean v3, p2, Lud/d$b;->A:Z
    ...
    iget-object p1, p0, Lcom/android/camera/n5;->m:Lud/d$b;
    ...
    iget-object p1, p0, Lcom/android/camera/n5;->f:Lud/d;
    ...
    invoke-virtual {p1, p2, v1}, Lud/d;->p(II)V
    ...
    iget-object p0, p0, Lcom/android/camera/n5;->m:Lud/d$b;

    invoke-virtual {p1, p0}, Lud/d;->i(Lud/d$b;)V
...
.method public final y(Landroid/os/Bundle;Landroid/view/Surface;Ljava/lang/String;)V
    ...
    invoke-interface {v5}, Lcom/android/camera/ui/h1;->R0()Landroid/opengl/EGLContext;

    move-result-object v8

    invoke-static/range {p1 .. p1}, Lge/j;->m(Landroid/os/Bundle;)Landroid/util/Size;

    move-result-object v13

    invoke-static/range {p1 .. p1}, Lge/j;->l(Landroid/os/Bundle;)I
    ...
    :cond_0
    invoke-static/range {p1 .. p1}, Lge/j;->b(Landroid/os/Bundle;)I
    ...
    iget-object v4, v0, Lcom/android/camera/n5;->f:Lud/d;
    ...
    invoke-direct/range {v6 .. v12}, Lud/d;-><init>(Ljava/lang/String;Landroid/opengl/EGLContext;Landroid/view/Surface;IIZ)V

    iput-object v1, v0, Lcom/android/camera/n5;->f:Lud/d;

    int-to-float v3, v14

    invoke-virtual {v1, v3}, Lud/d;->o(F)V
    ...
    iget-object v1, v0, Lcom/android/camera/n5;->f:Lud/d;

    invoke-virtual {v1}, Ljava/lang/Thread;->start()V

    iget-object v1, v0, Lcom/android/camera/n5;->f:Lud/d;

    invoke-virtual {v1}, Lud/d;->t()V
...
.method public z(Z)V
    ...
    iget-object p1, p0, Lcom/android/camera/n5;->d:Lge/h;
    ...
    invoke-static {p1, p0, p0, p0}, Lge/h;->k(Landroid/content/Context;Lge/h$b;Lge/h$d;Lge/h$c;)Lge/h;

    move-result-object p1

    iput-object p1, p0, Lcom/android/camera/n5;->d:Lge/h;
    ...
    invoke-virtual {p0, p1}, Lge/h;->r(Landroid/os/Bundle;)V
    :try_end_1
    .catch Lge/h$g; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
