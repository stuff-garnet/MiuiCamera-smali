...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/camera/z2$e;,
        Lcom/android/camera/z2$g;,
        Lcom/android/camera/z2$f;,
        Lcom/android/camera/z2$c;,
        Lcom/android/camera/z2$b;,
        Lcom/android/camera/z2$d;,
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/camera/z2;->e:Ljava/util/WeakHashMap;
...
.method public constructor <init>(Landroid/content/Intent;)V
    ...
    iput-object v0, p0, Lcom/android/camera/z2;->c:Ljava/lang/Boolean;

    iput-object p1, p0, Lcom/android/camera/z2;->a:Landroid/content/Intent;

    invoke-virtual {p0, p1}, Lcom/android/camera/z2;->U(Landroid/content/Intent;)Landroid/net/Uri;

    move-result-object p1

    iput-object p1, p0, Lcom/android/camera/z2;->b:Landroid/net/Uri;
...
.method public static N(Landroid/content/Intent;)Z
    ...
    invoke-static {p0}, Lcom/android/camera/z2;->o(Landroid/content/Intent;)I
...
.method public static V()V
    ...
    sget-object v0, Lcom/android/camera/z2;->e:Ljava/util/WeakHashMap;
...
.method public static l(Landroid/content/Intent;)Lcom/android/camera/z2;
    .locals 2
    ...
    check-cast v0, Lcom/android/camera/z2;

    if-nez v0, :cond_0

    new-instance v0, Lcom/android/camera/z2;

    invoke-direct {v0, p0}, Lcom/android/camera/z2;-><init>(Landroid/content/Intent;)V

    sget-object v1, Lcom/android/camera/z2;->e:Ljava/util/WeakHashMap;

    invoke-virtual {v1, p0, v0}, Ljava/util/WeakHashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "CameraIntentManager"

    invoke-static {v1, p0}, Lcom/android/camera/z2$e;->a(Ljava/lang/String;Landroid/content/Intent;)V
...
.method public A()Z
    ...
    iget-object p0, p0, Lcom/android/camera/z2;->a:Landroid/content/Intent;
...
.method public D(Landroid/app/Activity;)Z
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/z2;->I(Landroid/app/Activity;)Z
...
.method public G(Landroid/app/Activity;)Z
    ...
    iget-object v0, p0, Lcom/android/camera/z2;->a:Landroid/content/Intent;
    ...
    invoke-virtual {p0}, Lcom/android/camera/z2;->d()Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/android/camera/z2;->a:Landroid/content/Intent;
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/z2;->x(Landroid/app/Activity;)Z
    ...
    :cond_6
    iget-object p1, p0, Lcom/android/camera/z2;->a:Landroid/content/Intent;
...
.method public I(Landroid/app/Activity;)Z
    ...
    invoke-virtual {p0}, Lcom/android/camera/z2;->M()Z
...
.method public a()Z
    ...
    iget-object v0, p0, Lcom/android/camera/z2;->c:Ljava/lang/Boolean;
    ...
    :cond_9
    :goto_1
    iget-object p0, p0, Lcom/android/camera/z2;->c:Ljava/lang/Boolean;
...
.method public b(Landroid/app/Activity;)Z
    ...
    invoke-virtual {p0}, Lcom/android/camera/z2;->z()Z
...
.method public c()V
    ...
    iget-object v1, p0, Lcom/android/camera/z2;->a:Landroid/content/Intent;

    invoke-virtual {v0, v1}, Ljava/util/WeakHashMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/android/camera/z2;->b:Landroid/net/Uri;
...
.method public d()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/android/camera/z2;->b:Landroid/net/Uri;

    if-nez v0, :cond_0

    iget-object v0, p0, Lcom/android/camera/z2;->a:Landroid/content/Intent;

    invoke-virtual {p0, v0}, Lcom/android/camera/z2;->U(Landroid/content/Intent;)Landroid/net/Uri;
    ...
    :cond_0
    iget-object p0, p0, Lcom/android/camera/z2;->b:Landroid/net/Uri;
...
.method public g()I
    ...
    invoke-virtual {p0}, Lcom/android/camera/z2;->f()Ljava/lang/String;
...
.method public w()Ljava/lang/Boolean;
    ...
    invoke-virtual {p0}, Lcom/android/camera/z2;->e()I
...
.method public final x(Landroid/app/Activity;)Z
    ...
    invoke-static {}, Lcom/android/camera/y3;->b()Lcom/android/camera/y3;

    move-result-object p1

    invoke-virtual {p1}, Lcom/android/camera/y3;->a()I
