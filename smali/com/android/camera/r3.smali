...
.method public constructor <init>(Lcom/android/camera/Camera;)V
    ...
    iput-boolean v0, p0, Lcom/android/camera/r3;->c:Z

    new-instance v0, Lcom/android/camera/r3$a;

    invoke-direct {v0, p0}, Lcom/android/camera/r3$a;-><init>(Lcom/android/camera/r3;)V

    iput-object v0, p0, Lcom/android/camera/r3;->f:Landroid/content/ServiceConnection;

    new-instance v0, Lcom/android/camera/p3;

    invoke-direct {v0, p0}, Lcom/android/camera/p3;-><init>(Lcom/android/camera/r3;)V

    iput-object v0, p0, Lcom/android/camera/r3;->g:Ljava/lang/Runnable;

    new-instance v0, Lcom/android/camera/q3;

    invoke-direct {v0, p0}, Lcom/android/camera/q3;-><init>(Lcom/android/camera/r3;)V

    iput-object v0, p0, Lcom/android/camera/r3;->h:Ljava/lang/Runnable;
...
.method public static synthetic a(Lcom/android/camera/r3;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/camera/r3;->u()V

    return-void
.end method

.method public static synthetic b(Lcom/android/camera/r3;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/camera/r3;->t()V
...
.method public static l(Lcom/android/camera/Camera;Landroid/net/Uri;)V
    ...
    invoke-static {p1, p0}, Lcom/android/camera/o6;->F3(Landroid/net/Uri;Landroid/content/ContentResolver;)Z
...
.method private synthetic t()V
    ...
    iget-boolean v2, p0, Lcom/android/camera/r3;->c:Z
    ...
    invoke-virtual {p0}, Lcom/android/camera/r3;->k()V

    iget-boolean v1, p0, Lcom/android/camera/r3;->c:Z
    ...
    invoke-virtual {v1, v2, v4}, Lid/d;->a(II)Z
    ...
    iget-object v2, p0, Lcom/android/camera/r3;->f:Landroid/content/ServiceConnection;
...
.method private synthetic u()V
    ...
    invoke-virtual {p0}, Lcom/android/camera/r3;->j()V
    ...
    :try_start_0
    iget-object v1, p0, Lcom/android/camera/r3;->f:Landroid/content/ServiceConnection;
    ...
    :goto_0
    iput-boolean v2, p0, Lcom/android/camera/r3;->c:Z
...
.method public final A(Lcom/android/camera/Camera;Lcom/android/camera/v5;Landroid/net/Uri;)Z
    ...
    invoke-virtual {p0, p3}, Lcom/android/camera/r3;->h(Landroid/net/Uri;)Z
    ...
    invoke-static {p3, p0}, Lcom/android/camera/o6;->F3(Landroid/net/Uri;Landroid/content/ContentResolver;)Z
...
.method public final c(Lcom/android/camera/Camera;Landroid/content/Intent;)V
    ...
    invoke-virtual {p0}, Lcom/android/camera/r3;->o()Lcom/android/camera/w2;

    move-result-object v0

    invoke-virtual {v0}, Lcom/android/camera/w2;->d()F
    ...
    invoke-virtual {p0}, Lcom/android/camera/w2;->d()F
    ...
    invoke-virtual {p1, p0}, Lcom/android/camera/ActivityBase;->fl(I)V

    :cond_1
    invoke-virtual {p1}, Lcom/android/camera/ActivityBase;->zg()I
...
.method public final e(Lcom/android/camera/Camera;Landroid/content/Intent;)V
    ...
    invoke-virtual {p1}, Lcom/android/camera/ActivityBase;->wl()Z
    ...
    invoke-virtual {p1}, Lcom/android/camera/ActivityBase;->mj()Z
    ...
    :cond_0
    invoke-static {p2, v0}, Lcom/android/camera/z2;->Y(Landroid/content/Intent;Z)V
    ...
    invoke-static {p0, p1}, Lcom/android/camera/o6;->F2(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public final f(Lcom/android/camera/Camera;Landroid/content/Intent;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/r3;->p(Ljava/util/ArrayList;)[J
...
.method public g(J)V
    ...
    iget-object v1, p0, Lcom/android/camera/r3;->g:Ljava/lang/Runnable;
    ...
    iput-object p1, p0, Lcom/android/camera/r3;->d:Lio/reactivex/disposables/Disposable;
    ...
    iget-object p0, p0, Lcom/android/camera/r3;->g:Ljava/lang/Runnable;
...
.method public final i(Lcom/android/camera/Camera;Lcom/android/camera/v5;Landroid/net/Uri;)Landroid/content/Intent;
    ...
    invoke-virtual {p0, p1, p3}, Lcom/android/camera/r3;->n(Lcom/android/camera/Camera;Landroid/net/Uri;)Landroid/content/Intent;

    move-result-object p3

    invoke-virtual {p0, p1, p3}, Lcom/android/camera/r3;->c(Lcom/android/camera/Camera;Landroid/content/Intent;)V

    invoke-virtual {p0, p1, p3}, Lcom/android/camera/r3;->e(Lcom/android/camera/Camera;Landroid/content/Intent;)V

    if-eqz p2, :cond_0

    invoke-virtual {p0, p2, p3}, Lcom/android/camera/r3;->d(Lcom/android/camera/v5;Landroid/content/Intent;)V

    :cond_0
    invoke-virtual {p0, p1, p3}, Lcom/android/camera/r3;->f(Lcom/android/camera/Camera;Landroid/content/Intent;)V
...
.method public final j()V
    ...
    iget-object v0, p0, Lcom/android/camera/r3;->d:Lio/reactivex/disposables/Disposable;
    ...
    iput-object v0, p0, Lcom/android/camera/r3;->d:Lio/reactivex/disposables/Disposable;
...
.method public k()V
    ...
    iget-object v0, p0, Lcom/android/camera/r3;->e:Lio/reactivex/disposables/Disposable;
    ...
    iput-object v0, p0, Lcom/android/camera/r3;->e:Lio/reactivex/disposables/Disposable;
...
.method public final m(Lcom/android/camera/Camera;)V
    ...
    sget-boolean p0, Lcom/android/camera/o6;->x0:Z
...
.method public final o()Lcom/android/camera/w2;
    .locals 0
...
.method public q(Z)V
    ...
    invoke-virtual {p0, v0, v1}, Lcom/android/camera/r3;->y(Lcom/android/camera/Camera;Lcom/android/camera/v5;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/camera/r3;->m(Lcom/android/camera/Camera;)V
...
.method public r(Lcom/android/camera/Camera;Landroid/net/Uri;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/r3;->w(Lcom/android/camera/Camera;)V

    const/4 v2, 0x0

    invoke-virtual {p0, p1, v2, p2}, Lcom/android/camera/r3;->i(Lcom/android/camera/Camera;Lcom/android/camera/v5;Landroid/net/Uri;)Landroid/content/Intent;
    ...
    invoke-virtual {p1, p0}, Lcom/android/camera/ActivityBase;->jl(I)V
    ...
    invoke-interface {p0, v1}, Le6/l;->c0(Z)V
...
.method public final s(Ljava/lang/Exception;Landroid/net/Uri;Lcom/android/camera/Camera;Lcom/android/camera/v5;)V
    .locals 2
...
.method public final v(Lcom/android/camera/v5;Lcom/android/camera/Camera;)V
    ...
    iget-object v0, p2, Lcom/android/camera/ActivityBase;->K1:Lcom/android/camera/ui/h1;

    if-eqz v0, :cond_4

    invoke-virtual {p2}, Lcom/android/camera/ActivityBase;->Dk()Z
    ...
    :cond_1
    invoke-virtual {p2}, Lcom/android/camera/ActivityBase;->u1()Ld6/d5;

    move-result-object p2

    invoke-interface {p2}, Ld6/d5;->M9()Z
    ...
    invoke-interface {v0, v1, p2}, Lcom/android/camera/ui/h1;->W0(Lek/a;Z)V
    ...
    invoke-interface {v0, p2, v2}, Lcom/android/camera/ui/h1;->L0(Lek/a;Ljava/lang/Object;)V

    goto :goto_1

    :cond_3
    :goto_0
    sget-object p2, Lek/a;->a:Lek/a;

    invoke-interface {v0, p2, v2}, Lcom/android/camera/ui/h1;->L0(Lek/a;Ljava/lang/Object;)V

    :cond_4
    :goto_1
    iget-object p2, p0, Lcom/android/camera/r3;->b:Landroid/os/Messenger;
    ...
    :cond_6
    invoke-static {}, Lcom/android/camera/i5;->e()Lcom/android/camera/i5;
    ...
    invoke-virtual {p2, v1, p1}, Lcom/android/camera/i5;->i(Landroid/net/Uri;Landroid/graphics/Bitmap;)Z
    ...
    :cond_7
    :try_start_1
    invoke-virtual {p2}, Lcom/android/camera/i5;->f()Landroid/os/ParcelFileDescriptor;
    ...
    iget-object v3, p0, Lcom/android/camera/r3;->b:Landroid/os/Messenger;
    ...
    invoke-virtual {p2}, Lcom/android/camera/i5;->g()Landroid/net/Uri;
    ...
    invoke-virtual {p2}, Lcom/android/camera/i5;->c()I
    ...
    invoke-virtual {p2}, Lcom/android/camera/i5;->h()I
    ...
    invoke-virtual {p2}, Lcom/android/camera/i5;->d()I
    ...
    iget-object v2, p0, Lcom/android/camera/r3;->b:Landroid/os/Messenger;
    ...
    iget-object p0, p0, Lcom/android/camera/r3;->b:Landroid/os/Messenger;
...
.method public final w(Lcom/android/camera/Camera;)V
    ...
    invoke-virtual {p1}, Lcom/android/camera/Camera;->Co()V
...
.method public x(Landroid/os/Messenger;)V
    ...
    iput-object p1, p0, Lcom/android/camera/r3;->b:Landroid/os/Messenger;
...
.method public final y(Lcom/android/camera/Camera;Lcom/android/camera/v5;)V
    ...
    invoke-virtual {p0, p1, p2, v0}, Lcom/android/camera/r3;->A(Lcom/android/camera/Camera;Lcom/android/camera/v5;Landroid/net/Uri;)Z
    ...
    invoke-virtual {p0, p2, p1}, Lcom/android/camera/r3;->v(Lcom/android/camera/v5;Lcom/android/camera/Camera;)V

    invoke-static {p1, v0}, Lcom/android/camera/r3;->l(Lcom/android/camera/Camera;Landroid/net/Uri;)V

    invoke-virtual {p0, p1, p2, v0}, Lcom/android/camera/r3;->i(Lcom/android/camera/Camera;Lcom/android/camera/v5;Landroid/net/Uri;)Landroid/content/Intent;
    ...
    invoke-virtual {p1, v1}, Lcom/android/camera/ActivityBase;->jl(I)V
    ...
    invoke-virtual {p0, v1, v0, p1, p2}, Lcom/android/camera/r3;->s(Ljava/lang/Exception;Landroid/net/Uri;Lcom/android/camera/Camera;Lcom/android/camera/v5;)V
...
.method public z(Z)V
    ...
    iget-object v0, p0, Lcom/android/camera/r3;->h:Ljava/lang/Runnable;
    ...
    iput-object p1, p0, Lcom/android/camera/r3;->e:Lio/reactivex/disposables/Disposable;
    ...
    iget-object p0, p0, Lcom/android/camera/r3;->h:Ljava/lang/Runnable;
