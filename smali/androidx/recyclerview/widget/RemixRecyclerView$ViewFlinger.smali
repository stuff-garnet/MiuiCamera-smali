...
.field private mHapticFeedbackCompat:Lsq/c;
...
.method public constructor <init>(Landroidx/recyclerview/widget/RemixRecyclerView;)V
    ...
    invoke-direct {v1, p1, v0}, Lhp/d;-><init>(Landroid/content/Context;Landroid/view/animation/Interpolator;)V

    iput-object v1, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lhp/d;
...
.method private getHapticFeedbackCompat()Lsq/c;
    ...
    iget-object v0, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mHapticFeedbackCompat:Lsq/c;
    ...
    iput-object v0, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mHapticFeedbackCompat:Lsq/c;

    :cond_0
    iget-object p0, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mHapticFeedbackCompat:Lsq/c;
...
.method private internalPostOnAnimation()V
    ...
    invoke-static {v0, p0}, Lhp/a;->b(Landroid/view/View;Ljava/lang/Runnable;)V
...
.method public fling(II)V
    ...
    invoke-direct {v2, v4, v3}, Lhp/d;-><init>(Landroid/content/Context;Landroid/view/animation/Interpolator;)V

    iput-object v2, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lhp/d;
    ...
    :cond_9
    :goto_4
    iget-object v3, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lhp/d;
    ...
    invoke-virtual/range {v3 .. v11}, Lhp/d;->d(IIIIIIII)V
...
.method public resetFlingPosition()V
    ...
    iget-object p0, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lhp/d;

    invoke-virtual {p0}, Lhp/d;->w()V
...
.method public run()V
    ...
    iget-object v1, v0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lhp/d;

    invoke-virtual {v1}, Lhp/d;->b()Z

    move-result v4

    if-eqz v4, :cond_21

    invoke-virtual {v1}, Lhp/d;->j()I
    ...
    iget-object v6, v0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lhp/d;

    invoke-virtual {v6}, Lhp/d;->o()I

    move-result v6

    if-ne v6, v3, :cond_1

    invoke-virtual {v1}, Lhp/d;->h()F
    ...
    iget-object v4, v0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lhp/d;

    invoke-virtual {v4}, Lhp/d;->o()I
    ...
    iget-object v8, v0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lhp/d;

    invoke-virtual {v8}, Lhp/d;->h()F

    move-result v8

    iget-object v9, v0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lhp/d;

    invoke-virtual {v9}, Lhp/d;->i()F

    move-result v9

    invoke-interface {v7, v8, v9}, Lun/c;->c(FF)Z
    ...
    iget-object v5, v0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lhp/d;

    invoke-virtual {v5}, Lhp/d;->q()I
    ...
    invoke-direct/range {p0 .. p0}, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->getHapticFeedbackCompat()Lsq/c;

    move-result-object v1

    const/16 v4, 0xc9

    invoke-virtual {v1, v4}, Lsq/c;->o(I)V
...
.method public smoothScrollBy(IIILandroid/view/animation/Interpolator;)V
    ...
    :cond_2
    iget-object p3, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lhp/d;

    invoke-virtual {p3}, Lhp/d;->o()I
    ...
    invoke-direct {p3, v2, p4}, Lhp/d;-><init>(Landroid/content/Context;Landroid/view/animation/Interpolator;)V

    iput-object p3, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lhp/d;
    ...
    iget-object v1, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lhp/d;
    ...
    invoke-virtual/range {v1 .. v7}, Lhp/d;->G(IIIIII)V
