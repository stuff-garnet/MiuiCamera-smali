...
.method public static b(Ld/p;Ljava/lang/String;Ljava/lang/String;)[Ljava/lang/Object;
    ...
    invoke-virtual {v8}, Ld/p;->I()Z

    move-result v9

    if-eqz v9, :cond_5

    invoke-virtual {v8, v5}, Ld/p;->C(I)Ld/p;

    move-result-object v9

    invoke-virtual {v9}, Ld/p;->y()Ljava/lang/String;
    ...
    invoke-virtual {v9}, Ld/p;->G()Ljava/lang/String;
    ...
    invoke-virtual {p0, v5}, Ld/p;->q(I)Ld/p;
...
.method public static c(Ld/p;)V
    ...
    invoke-virtual {v0, p0}, Ld/p;->T(Ld/p;)V
    ...
    invoke-virtual {v0}, Ld/p;->B()Ld/p;

    move-result-object p0

    invoke-virtual {p0, v0}, Ld/p;->R(Ld/p;)V
...
.method public static e(Ld/p;Ljava/lang/String;Z)Ld/p;
    ...
    :cond_2
    :goto_0
    invoke-virtual {p0, p1}, Ld/p;->o(Ljava/lang/String;)Ld/p;
    ...
    invoke-virtual {v0, v1}, Ld/p;->a0(Z)V
...
.method public static f(Ld/p;Ljava/lang/String;Z)I
    ...
    invoke-virtual {p2, v2}, Ld/p;->a0(Z)V
...
.method public static g(Ld/p;Le/b;ZLf/e;)Ld/p;
    ...
    invoke-virtual {p0, v0}, Ld/p;->a0(Z)V
    ...
    invoke-virtual {p0, p1}, Ld/p;->c0(Lf/e;)V
...
.method public static h(Ld/p;Ljava/lang/String;Z)Ld/p;
    ...
    invoke-virtual {v0, p1}, Ld/p;->a0(Z)V
...
.method public static k(Ld/p;Le/d;Z)Ld/p;
    ...
    invoke-virtual {p0, p1}, Ld/p;->q(I)Ld/p;
...
.method public static l(Ld/p;Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-virtual {p0, v2}, Ld/p;->q(I)Ld/p;

    move-result-object v3

    invoke-virtual {v3}, Ld/p;->z()Lf/e;
    ...
    :goto_1
    invoke-virtual {v3}, Ld/p;->s()I

    move-result v5

    if-gt v4, v5, :cond_2

    invoke-virtual {v3, v4}, Ld/p;->q(I)Ld/p;

    move-result-object v5

    invoke-virtual {v5}, Ld/p;->y()Ljava/lang/String;
    ...
    :cond_0
    invoke-virtual {v5}, Ld/p;->G()Ljava/lang/String;
...
.method public static m(Ld/p;Ljava/lang/String;)I
    ...
    invoke-virtual {p0, v1}, Ld/p;->q(I)Ld/p;

    move-result-object v2

    invoke-virtual {v2}, Ld/p;->I()Z

    move-result v3

    if-eqz v3, :cond_1

    invoke-virtual {v2, v0}, Ld/p;->C(I)Ld/p;

    move-result-object v3

    invoke-virtual {v3}, Ld/p;->y()Ljava/lang/String;
    ...
    invoke-virtual {v2}, Ld/p;->G()Ljava/lang/String;
...
.method public static n(Ld/p;Ljava/lang/String;Ljava/lang/String;I)I
    ...
    invoke-virtual {p3}, Ld/p;->P()Ljava/util/Iterator;
...
.method public static o(Ld/p;)V
    ...
    invoke-virtual {v2, v3}, Ld/p;->C(I)Ld/p;
    ...
    :try_start_0
    invoke-virtual {p0, v1}, Ld/p;->Q(I)V
