...
.method private synthetic i(Lt1/i;Landroid/graphics/Rect;Lu1/e$c;Landroid/animation/ValueAnimator;)V
    ...
    invoke-interface {v1, v0}, Lcom/android/camera/display/manager/CamLayoutManager$c;->p4(Landroid/graphics/Rect;)V
    ...
    invoke-interface {p0, p1, p2}, Lcom/android/camera/display/manager/CamLayoutManager$c;->b0(II)V
...
.method public k(Landroid/app/Activity;Lt1/i;Lt1/i;)V
    ...
    invoke-interface {v0, v1, v2}, Lcom/android/camera/display/manager/CamLayoutManager$c;->L4(II)Landroid/graphics/Rect;
    ...
    invoke-interface {p0, v1, v0}, Lcom/android/camera/display/manager/CamLayoutManager$c;->b0(II)V
...
.method public final n(Landroid/app/Activity;Lt1/i;Lt1/i;)V
    ...
    invoke-interface {v2, v0, v1}, Lcom/android/camera/display/manager/CamLayoutManager$c;->L4(II)Landroid/graphics/Rect;
    ...
    const-string/jumbo p1, "startPreviewAnimation, cancel animation"
    ...
    invoke-interface {p1, v9}, Lcom/android/camera/display/manager/CamLayoutManager$c;->p4(Landroid/graphics/Rect;)V
    ...
    const-string/jumbo p2, "start animator."
...
.method public final o(Lt1/i;Landroid/graphics/Rect;FLi0/f$a$b;)V
    ...
    invoke-interface {p0, p1, p2, p3, p4}, Lcom/android/camera/display/manager/CamLayoutManager$c;->c0(Lt1/i;Landroid/graphics/Rect;FLi0/f$a$b;)V
