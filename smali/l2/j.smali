...
.method public c()V
    ...
    :cond_2
    :goto_0
    invoke-static {v5}, Lif/c;->i(Landroid/graphics/Rect;)Landroid/util/Size;
    ...
    invoke-virtual {v7}, Ll2/a;->e()Lhk/h;

    move-result-object v7

    sget-object v8, Lek/e;->w:Lek/e;

    invoke-virtual {v7, v8}, Lhk/h;->g(Lek/e;)Lkk/s;
    ...
    invoke-virtual {v9, v7, v8, v10}, Ll2/a;->p(Lhk/h;Lek/e;[Ljava/lang/Object;)V

    invoke-virtual {v7}, Lhk/h;->k()Lhk/a;

    move-result-object v8

    iget-object v9, v6, Ll2/j;->a:Ll2/n;

    iget-object v9, v9, Ll2/a;->e:Ldk/b;

    invoke-virtual {v9}, Ldk/b;->a()I

    move-result v9

    invoke-virtual {v8, v9}, Lhk/a;->k(I)Lhk/a;
    ...
    invoke-virtual {v9}, Ldk/b;->c()I

    move-result v9

    invoke-virtual {v8, v9}, Lhk/a;->l(I)Lhk/a;

    move-result-object v8

    invoke-virtual {v8, v0}, Lhk/a;->e(Landroid/util/Size;)Lhk/a;

    move-result-object v8

    invoke-virtual {v8, v5}, Lhk/a;->g(Landroid/graphics/Rect;)Lhk/a;

    move-result-object v8

    invoke-virtual {v8}, Lhk/a;->a()V

    invoke-virtual {v7}, Lhk/h;->y()V

    invoke-virtual {v7}, Lhk/h;->B()V
    ...
    invoke-static {v9, v5, v10, v11}, Lnk/j;->a(Landroid/media/Image;Landroid/graphics/Rect;ZI)[B
    ...
    invoke-static {v8, v9}, Lcom/android/camera/m3;->q([B[B)[B
    ...
    iget-object v10, v8, Ll2/a;->e:Ldk/b;

    invoke-virtual {v10}, Ldk/b;->a()I

    move-result v13

    iget-object v10, v6, Ll2/j;->a:Ll2/n;

    iget-object v10, v10, Ll2/a;->e:Ldk/b;

    invoke-virtual {v10}, Ldk/b;->d()I
    ...
    invoke-virtual {v2}, Ll2/a;->e()Lhk/h;

    move-result-object v2

    sget-object v7, Lek/e;->y:Lek/e;

    invoke-virtual {v2, v7}, Lhk/h;->g(Lek/e;)Lkk/s;

    new-instance v14, Lfk/e;
    ...
    invoke-static {v3}, Lif/c;->g(Landroid/util/Size;)Landroid/graphics/Rect;

    move-result-object v10

    iget-object v7, v6, Ll2/j;->b:Lf2/t;

    iget-object v13, v7, Lf2/t;->t:Lnk/b;
    ...
    invoke-direct/range {v7 .. v13}, Lfk/e;-><init>(ZLandroid/util/Size;Landroid/graphics/Rect;Landroid/util/Size;Landroid/graphics/Rect;Lnk/b;)V

    invoke-virtual {v2, v14}, Lhk/h;->C(Lfk/d;)V
    ...
    invoke-virtual {v7, v8, v3}, Lhk/a;->f(II)Lhk/a;

    move-result-object v3

    iget-object v7, v6, Ll2/j;->b:Lf2/t;

    iget-object v7, v7, Lf2/t;->t:Lnk/b;

    invoke-virtual {v7}, Lnk/b;->a()I

    move-result v7

    invoke-virtual {v3, v7}, Lhk/a;->k(I)Lhk/a;
    ...
    invoke-virtual {v7}, Lnk/b;->b()I

    move-result v7

    invoke-virtual {v3, v7}, Lhk/a;->l(I)Lhk/a;

    move-result-object v3

    iget-object v7, v6, Ll2/j;->a:Ll2/n;

    iget-object v7, v7, Ll2/a;->e:Ldk/b;

    invoke-virtual {v7}, Ldk/b;->c()I

    move-result v7

    invoke-virtual {v3, v7}, Lhk/a;->i(I)Lhk/a;
...
.method public final d(IIIILandroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    :cond_2
    invoke-static {p5, v0}, Lif/c;->j(Landroid/graphics/Rect;F)Landroid/graphics/Rect;
