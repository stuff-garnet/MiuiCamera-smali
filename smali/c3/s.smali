...
# static fields
.field public static final Ua:Ljava/lang/String; = "DocModule"

.field public static final Va:Z


# instance fields
.field public Sa:Landroid/net/Uri;

.field public volatile Ta:Z
...
.method public static synthetic Bs(Lcom/android/camera/Camera;)V
    .locals 0

    invoke-static {p0}, Lc3/s;->Ps(Lcom/android/camera/Camera;)V

    return-void
.end method

.method public static synthetic Cs(Lcom/android/camera/Camera;)V
    .locals 0

    invoke-static {p0}, Lc3/s;->Vs(Lcom/android/camera/Camera;)V

    return-void
.end method

.method public static synthetic Ds(Lc3/s;Landroid/graphics/Bitmap;[FLda/d;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lc3/s;->Ts(Landroid/graphics/Bitmap;[FLda/d;)V

    return-void
.end method

.method public static synthetic Es(Lc3/s;Lcom/android/camera2/u5;)V
    .locals 0

    invoke-direct {p0, p1}, Lc3/s;->Os(Lcom/android/camera2/u5;)V
...
.method private synthetic Ls(Lea/g;)V
    .locals 3
    ...
    iput-object v1, p0, Ld6/p2;->xa:Lea/g$a;
...
.method public static synthetic Ms(Landroid/net/Uri;)V
    .locals 2
...
.method private synthetic Os(Lcom/android/camera2/u5;)V
    .locals 0
...
.method public static synthetic Ps(Lcom/android/camera/Camera;)V
    .locals 1
...
.method public static synthetic Qs(Lj7/d0;)V
    .locals 1
...
.method private synthetic Ss(Landroid/graphics/Bitmap;[FLda/d;Lj7/d;)V
    .locals 2
    ...
    invoke-interface {p4, p1, p2, v0, p3}, Lj7/d;->pa(Landroid/graphics/Bitmap;[FLandroid/util/Size;Ljava/lang/Runnable;)V

    return-void
.end method

.method private synthetic Ts(Landroid/graphics/Bitmap;[FLda/d;)V
    .locals 2
...
.method private synthetic Us(Ljava/lang/String;Landroid/graphics/Bitmap;)V
    .locals 4
    ...
    invoke-static {p2, v1, v2}, Lff/c;->o(Landroid/graphics/Bitmap;IZ)Landroid/graphics/Bitmap;
    ...
    invoke-static {p2, p1, v3, v1}, Lcom/android/camera/o6;->C4(Landroid/graphics/Bitmap;Ljava/lang/String;ILandroid/graphics/Bitmap$CompressFormat;)Z
...
.method public static synthetic Vs(Lcom/android/camera/Camera;)V
    .locals 1

    const/4 v0, 0x0

    invoke-virtual {p0, v0}, Lcom/android/camera/ActivityBase;->ll(Z)V

    return-void
.end method

.method public static synthetic Ws(Lj7/o1;)V
    .locals 1
    ...
    invoke-interface {p0, v0}, Lj7/e1;->Fd(Z)V

    return-void
.end method

.method public static synthetic ts(Landroid/net/Uri;)V
    .locals 0

    invoke-static {p0}, Lc3/s;->Ms(Landroid/net/Uri;)V

    return-void
.end method

.method public static synthetic us(Lj7/d0;)V
    .locals 0

    invoke-static {p0}, Lc3/s;->Qs(Lj7/d0;)V

    return-void
.end method

.method public static synthetic vs(Lc3/s;Lea/g;)V
    .locals 0

    invoke-direct {p0, p1}, Lc3/s;->Ls(Lea/g;)V

    return-void
.end method

.method public static synthetic ws(Lc3/s;Ljava/lang/String;Landroid/graphics/Bitmap;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lc3/s;->Us(Ljava/lang/String;Landroid/graphics/Bitmap;)V
...
.method public static synthetic xs(Lj7/o1;)V
    ...
    invoke-static {p0}, Lc3/s;->Ws(Lj7/o1;)V

    return-void
.end method

.method public static synthetic ys(Lc3/s;Landroid/graphics/Bitmap;[FLda/d;Lj7/d;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3, p4}, Lc3/s;->Ss(Landroid/graphics/Bitmap;[FLda/d;Lj7/d;)V

    return-void
.end method

.method public static synthetic zs(Lc3/s;)V
    .locals 0

    invoke-direct {p0}, Lc3/s;->Rs()V
...
.method public final Hs(Ljava/lang/String;Ljava/lang/String;Lcom/android/camera/Camera;)V
    .locals 5
    ...
    :goto_0
    iget-object v2, p0, Lc3/s;->Sa:Landroid/net/Uri;
    ...
    iget-object p1, p0, Lc3/s;->Sa:Landroid/net/Uri;
    ...
    :cond_2
    invoke-static {p1}, Lcom/android/camera/o6;->n4(Ljava/lang/String;)Landroid/net/Uri;
    ...
    invoke-virtual {p3}, Lcom/android/camera/ActivityBase;->wl()Z

    move-result p1

    if-eqz p1, :cond_3

    invoke-static {v1, v2}, Lcom/android/camera/z2;->Y(Landroid/content/Intent;Z)V

    :cond_3
    const p1, 0x8c35

    invoke-static {p3, v1, p1}, Lcom/android/camera/o6;->f5(Landroid/app/Activity;Landroid/content/Intent;I)Z

    move-result p1

    iput-boolean p1, p0, Lc3/s;->Ta:Z

    iget-boolean p0, p0, Lc3/s;->Ta:Z

    if-eqz p0, :cond_4

    const/4 p0, 0x6

    invoke-virtual {p3, p0}, Lcom/android/camera/ActivityBase;->jl(I)V
...
.method public final Is()V
    ...
    iget-object v0, p0, Lc3/s;->Sa:Landroid/net/Uri;

    if-eqz v0, :cond_0

    const/4 v1, 0x0

    iput-object v1, p0, Lc3/s;->Sa:Landroid/net/Uri;
...
.method public Js()V
    ...
    invoke-virtual {p0}, Lc3/s;->Is()V

    const/4 v0, 0x0

    iput-boolean v0, p0, Lc3/s;->Ta:Z
...
.method public Ko(Landroid/net/Uri;Ljava/lang/String;)V
    ...
    invoke-super {p0, p1, p2}, Ld6/p2;->Ko(Landroid/net/Uri;Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lc3/s;->Sa:Landroid/net/Uri;
    ...
    invoke-virtual {p0, p1, p2, v0}, Lc3/s;->Hs(Ljava/lang/String;Ljava/lang/String;Lcom/android/camera/Camera;)V

    :cond_2
    iput-boolean v1, p0, Ld6/p2;->ha:Z
...
.method public Pr()V
    ...
    invoke-virtual {p0, v0}, Ld6/p2;->sr(Z)V
...
.method public Sb(Landroid/net/Uri;ZLjava/lang/String;Z)V
    ...
    :cond_0
    invoke-virtual {p0, p1, p3}, Lc3/s;->Ko(Landroid/net/Uri;Ljava/lang/String;)V
...
.method public Vn(I)I
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/l3;->b(Z)I
...
.method public final Xs(Lea/g$a;)V
    .locals 18
    ...
    invoke-virtual {v0, v1}, Ld6/p2;->k0(I)V
    ...
    const-string/jumbo v4, "showDocumentPreview: savePath = "
    ...
    const-string/jumbo v6, "showDocumentPreview: points = "
    ...
    :cond_1
    sget-object v2, Lcom/android/camera/l3;->d:Lcom/android/camera/l3;

    invoke-virtual {v2, v1}, Lcom/android/camera/l3;->b(Z)I

    move-result v2

    invoke-static {v3, v2}, Lff/c;->h(Landroid/graphics/Bitmap;I)[B
    ...
    new-instance v6, Lid/z;

    iget-object v7, v0, Ld6/j0;->b:Le6/m;

    invoke-interface {v7}, Le6/m;->E0()I
    ...
    invoke-direct/range {v12 .. v17}, Lid/z;-><init>(IJILjava/lang/String;)V

    invoke-virtual {v6, v5}, Lid/z;->b1(Z)V
    ...
    invoke-virtual {v6, v2, v1}, Lid/z;->a([BI)V
    ...
    invoke-direct {v1, v2, v7, v8, v3}, Lid/a0$a;-><init>(Landroid/util/Size;Landroid/util/Size;Landroid/util/Size;I)V
    ...
    invoke-virtual {v1, v2}, Lid/a0$a;->C(I)Lid/a0$a;
    ...
    invoke-virtual {v6, v1}, Lid/z;->b(Lid/a0;)V
    ...
    invoke-virtual {v6, v5}, Lid/z;->n1(Z)V
    ...
    invoke-virtual {v0, v6, v1, v1, v1}, La8/i;->m(Lid/z;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)Z
    ...
    :cond_6
    :goto_1
    const-string/jumbo v0, "showDocumentPreview: jpegData is null!"
    ...
    :cond_7
    :goto_2
    invoke-virtual/range {p0 .. p0}, Lc3/s;->Ys()V
...
.method public final Zs()V
    ...
    invoke-virtual {p0, v0, v1}, Lcom/android/camera2/x5;->k(Ly9/cr;Ljava/lang/Object;)V
...
.method public ho()V
    ...
    invoke-interface {v0, v1}, Lj7/d0;->q5(Z)V
...
.method public io()Ljava/lang/String;
    ...
    invoke-virtual {p0, v1}, Ld6/p2;->In(Z)V

    return-object v0

    :cond_0
    invoke-super {p0}, Ld6/p2;->io()Ljava/lang/String;
...
.method public wq(Lcom/android/camera2/u5;)V
    ...
    iget-object v0, p0, Ld6/p2;->xa:Lea/g$a;

    if-eqz v0, :cond_0

    invoke-virtual {p0, v0}, Lc3/s;->Xs(Lea/g$a;)V
