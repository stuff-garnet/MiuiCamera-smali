...
.method public static b(Lm2/c;)[Lm2/f;
    ...
    sget-object v6, Lm2/f;->ha:Lm2/f;

    if-eq v5, v6, :cond_0

    sget-object v6, Lm2/f;->ia:Lm2/f;

    if-eq v5, v6, :cond_0

    sget-object v6, Lm2/f;->ja:Lm2/f;

    if-eq v5, v6, :cond_0

    sget-object v6, Lm2/f;->Ra:Lm2/f;

    if-eq v5, v6, :cond_0

    sget-object v6, Lm2/f;->Sa:Lm2/f;

    if-eq v5, v6, :cond_0

    sget-object v6, Lm2/f;->Ta:Lm2/f;
    ...
    sget-object v8, Lm2/f;->fa:Lm2/f;

    if-eq v5, v8, :cond_3

    sget-object v8, Lm2/f;->ga:Lm2/f;

    if-eq v5, v8, :cond_3

    sget-object v8, Lm2/f;->Pa:Lm2/f;

    if-eq v5, v8, :cond_3

    sget-object v8, Lm2/f;->Qa:Lm2/f;
