...
# static fields
.field public static final j:Ljava/lang/String; = "CvLensStateContainer"
...
.method public constructor <init>(Landroid/content/Context;Landroid/widget/LinearLayout;)V
    ...
    iput-boolean v1, p0, Lq4/g;->i:Z

    iput-object p2, p0, Lq4/g;->a:Landroid/widget/LinearLayout;

    invoke-virtual {p0, p1}, Lq4/g;->b(Landroid/content/Context;)V

    invoke-static {}, Lr0/b;->k()Lx0/g1;

    move-result-object p2

    invoke-virtual {p2}, Lx0/g1;->H()Lcom/android/camera2/compat/theme/custom/cv/cvlens/ComponentRunningCvLens;

    move-result-object p2

    iput-object p2, p0, Lq4/g;->b:Lcom/android/camera2/compat/theme/custom/cv/cvlens/ComponentRunningCvLens;

    new-instance v1, Lcom/android/camera2/compat/theme/custom/cv/cvlens/CvLensAdapter;

    invoke-direct {v1, p1, p2, v0}, Lcom/android/camera2/compat/theme/custom/cv/cvlens/CvLensAdapter;-><init>(Landroid/content/Context;Lcom/android/camera/data/data/b;Z)V

    iput-object v1, p0, Lq4/g;->c:Lcom/android/camera2/compat/theme/custom/cv/cvlens/CvLensAdapter;

    return-void
.end method

.method public static synthetic a(Lq4/g;Lj7/m0;)V
    .locals 0

    invoke-direct {p0, p1}, Lq4/g;->j(Lj7/m0;)V
...
.method private synthetic j(Lj7/m0;)V
    ...
    iget p0, p0, Lq4/g;->h:I

    invoke-interface {p1, v0, p0}, Lj7/m0;->c9(II)V
...
.method public b(Landroid/content/Context;)V
    ...
    iget-object v0, p0, Lq4/g;->a:Landroid/widget/LinearLayout;
    ...
    iput-object v0, p0, Lq4/g;->d:Landroid/widget/FrameLayout;
    ...
    iput-object v0, p0, Lq4/g;->e:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iput-object v0, p0, Lq4/g;->f:Lcom/android/camera/fragment/beauty/LinearLayoutManagerWrapper;

    iget-object v1, p0, Lq4/g;->e:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-object p0, p0, Lq4/g;->e:Landroidx/recyclerview/widget/RecyclerView;
    ...
    :cond_0
    iget-object p1, p0, Lq4/g;->a:Landroid/widget/LinearLayout;
    ...
    iput-object p1, p0, Lq4/g;->e:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iput-object p1, p0, Lq4/g;->f:Lcom/android/camera/fragment/beauty/LinearLayoutManagerWrapper;
...
.method public c()V
    ...
    iget-object v0, p0, Lq4/g;->d:Landroid/widget/FrameLayout;
...
.method public d()Z
    ...
    iget-object v0, p0, Lq4/g;->e:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-object p0, p0, Lq4/g;->d:Landroid/widget/FrameLayout;
...
.method public h(Landroid/content/Context;)V
    ...
    iput-boolean p1, p0, Lq4/g;->i:Z

    iget-object p1, p0, Lq4/g;->d:Landroid/widget/FrameLayout;

    invoke-static {p1}, Lk0/a;->j(Landroid/view/View;)V

    iget-object p1, p0, Lq4/g;->b:Lcom/android/camera2/compat/theme/custom/cv/cvlens/ComponentRunningCvLens;
    ...
    iput p1, p0, Lq4/g;->g:I

    iget-object p1, p0, Lq4/g;->e:Landroidx/recyclerview/widget/RecyclerView;

    iget-object v0, p0, Lq4/g;->c:Lcom/android/camera2/compat/theme/custom/cv/cvlens/CvLensAdapter;

    invoke-virtual {p1, v0}, Landroidx/recyclerview/widget/RecyclerView;->setAdapter(Landroidx/recyclerview/widget/RecyclerView$Adapter;)V

    iget-object p1, p0, Lq4/g;->c:Lcom/android/camera2/compat/theme/custom/cv/cvlens/CvLensAdapter;
    ...
    invoke-direct {v0, p0}, Lq4/f;-><init>(Lq4/g;)V
...
.method public final k(II)V
    ...
    iget-object v4, p0, Lq4/g;->b:Lcom/android/camera2/compat/theme/custom/cv/cvlens/ComponentRunningCvLens;
    ...
    iget-object v5, p0, Lq4/g;->e:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-object v6, p0, Lq4/g;->e:Landroidx/recyclerview/widget/RecyclerView;
    ...
    :cond_2
    iget-object v4, p0, Lq4/g;->c:Lcom/android/camera2/compat/theme/custom/cv/cvlens/CvLensAdapter;
    ...
    invoke-virtual {p0}, Lq4/g;->isAdded()Z

    move-result v3

    if-eqz v3, :cond_4

    iget-object v3, p0, Lq4/g;->c:Lcom/android/camera2/compat/theme/custom/cv/cvlens/CvLensAdapter;
    ...
    :cond_4
    iget-object p0, p0, Lq4/g;->c:Lcom/android/camera2/compat/theme/custom/cv/cvlens/CvLensAdapter;
...
.method public final m(IZ)V
    ...
    :cond_0
    :try_start_0
    iget-object v3, p0, Lq4/g;->b:Lcom/android/camera2/compat/theme/custom/cv/cvlens/ComponentRunningCvLens;
    ...
    invoke-interface {p2, v3}, Lj7/a0;->Mj(Ljava/lang/String;)V

    invoke-virtual {p0, p1}, Lq4/g;->p(I)V
    :try_end_0
...
.method public final o(I)V
    ...
    iget-object v0, p0, Lq4/g;->f:Lcom/android/camera/fragment/beauty/LinearLayoutManagerWrapper;
    ...
    :cond_2
    :goto_0
    iget-object p0, p0, Lq4/g;->f:Lcom/android/camera/fragment/beauty/LinearLayoutManagerWrapper;
...
.method public onClick(Landroid/view/View;)V
    ...
    invoke-virtual {p0, v0, p1}, Lq4/g;->m(IZ)V
...
.method public final p(I)V
    ...
    invoke-virtual {p0, p1}, Lq4/g;->o(I)V

    iget p1, p0, Lq4/g;->h:I

    iget v0, p0, Lq4/g;->g:I

    invoke-virtual {p0, p1, v0}, Lq4/g;->k(II)V
