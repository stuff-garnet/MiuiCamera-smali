...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 1
    invoke-direct {p0, p1, p2, v0}, Lxo/k;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 3
    invoke-virtual {p0, p1, p2, p3}, Lxo/k;->c(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    return-void
.end method

.method public static synthetic a(Lxo/k;)Lxo/k$b;
    .locals 0

    iget-object p0, p0, Lxo/k;->e:Lxo/k$b;
...
.method public final b()V
    ...
    sget v3, Lwo/b$g;->miuix_appcompat_message_view_text_margin_right:I
    ...
    sget v2, Lwo/b$i;->close:I

    invoke-virtual {v0, v2}, Landroid/view/View;->setId(I)V

    iget-object v2, p0, Lxo/k;->c:Landroid/graphics/drawable/Drawable;
    ...
    new-instance v2, Lxo/k$a;

    invoke-direct {v2, p0}, Lxo/k$a;-><init>(Lxo/k;)V
...
.method public final c(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget-object v0, Lwo/b$o;->MessageView:[I

    sget v1, Lwo/b$n;->Widget_MessageView:I

    invoke-virtual {p1, p2, v0, p3, v1}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;

    move-result-object p2

    sget p3, Lwo/b$o;->MessageView_android_text:I

    invoke-virtual {p2, p3}, Landroid/content/res/TypedArray;->getString(I)Ljava/lang/String;

    move-result-object p3

    sget v0, Lwo/b$o;->MessageView_android_textColor:I

    sget v1, Lwo/b$f;->miuix_appcompat_message_view_text_color_light:I
    ...
    sget v1, Lwo/b$o;->MessageView_closeBackground:I

    sget v2, Lwo/b$h;->miuix_appcompat_ic_message_view_close_guide_light:I
    ...
    iput-object p1, p0, Lxo/k;->c:Landroid/graphics/drawable/Drawable;

    sget p1, Lwo/b$o;->MessageView_closable:I
    ...
    iput-object p2, p0, Lxo/k;->a:Landroid/widget/TextView;
    ...
    iget-object v3, p0, Lxo/k;->a:Landroid/widget/TextView;
    ...
    sget v5, Lwo/b$g;->miuix_appcompat_message_view_text_padding_start:I
    ...
    iget-object p3, p0, Lxo/k;->a:Landroid/widget/TextView;
    ...
    sget v3, Lwo/b$g;->miuix_appcompat_message_view_text_size:I
    ...
    invoke-virtual {p0, p1}, Lxo/k;->setClosable(Z)V
...
.method public setMessage(Ljava/lang/CharSequence;)V
    ...
    iget-object p0, p0, Lxo/k;->a:Landroid/widget/TextView;
...
.method public setOnMessageViewCloseListener(Lxo/k$b;)V
    .locals 0

    iput-object p1, p0, Lxo/k;->e:Lxo/k$b;
