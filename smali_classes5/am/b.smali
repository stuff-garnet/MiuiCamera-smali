...
# direct methods
.method public static synthetic a(Lzl/m;)Ljava/util/Spliterator;
    .locals 0

    invoke-static {p0}, Lam/b;->g(Lzl/m;)Ljava/util/Spliterator;
...
.method public static final b(Ljava/util/stream/DoubleStream;)Lzl/m;
    .locals 1
    ...
    invoke-direct {v0, p0}, Lam/b$d;-><init>(Ljava/util/stream/DoubleStream;)V

    return-object v0
.end method

.method public static final c(Ljava/util/stream/IntStream;)Lzl/m;
    .locals 1
    ...
    new-instance v0, Lam/b$b;

    invoke-direct {v0, p0}, Lam/b$b;-><init>(Ljava/util/stream/IntStream;)V

    return-object v0
.end method

.method public static final d(Ljava/util/stream/LongStream;)Lzl/m;
    .locals 1
    ...
    invoke-direct {v0, p0}, Lam/b$c;-><init>(Ljava/util/stream/LongStream;)V

    return-object v0
.end method

.method public static final e(Ljava/util/stream/Stream;)Lzl/m;
    .locals 1
    ...
    invoke-direct {v0, p0}, Lam/b$a;-><init>(Ljava/util/stream/Stream;)V

    return-object v0
.end method

.method public static final f(Lzl/m;)Ljava/util/stream/Stream;
    .locals 2
    .param p0    # Lzl/m;
        .annotation build Lls/d;
        .end annotation
    ...
    invoke-direct {v0, p0}, Lam/a;-><init>(Lzl/m;)V
...
.method public static final g(Lzl/m;)Ljava/util/Spliterator;
    .locals 1
...
.method public static final h(Ljava/util/stream/DoubleStream;)Ljava/util/List;
    ...
    invoke-static {p0}, Ltk/o;->p([D)Ljava/util/List;
...
.method public static final i(Ljava/util/stream/IntStream;)Ljava/util/List;
    ...
    invoke-static {p0}, Ltk/o;->r([I)Ljava/util/List;
...
.method public static final j(Ljava/util/stream/LongStream;)Ljava/util/List;
    ...
    invoke-static {p0}, Ltk/o;->s([J)Ljava/util/List;
