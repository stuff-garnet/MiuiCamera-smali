...
.method public static synthetic a(Landroidx/appcompat/widget/AppCompatImageView;Landroid/content/Context;)V
    ...
    invoke-static {p0, p1}, Lgn/c;->g(Landroidx/appcompat/widget/AppCompatImageView;Landroid/content/Context;)V
...
.method public static synthetic b(Landroid/widget/FrameLayout;I)V
    ...
    invoke-static {p0, p1}, Lgn/c;->f(Landroid/widget/FrameLayout;I)V

    return-void
.end method

.method public static c(Landroid/content/Context;II)Len/c;
    .locals 1

    new-instance v0, Len/c;

    invoke-direct {v0, p0, p1, p2}, Len/c;-><init>(Landroid/content/Context;II)V

    invoke-virtual {v0}, Len/c;->k()V

    return-object v0
.end method

.method public static d(Landroid/content/Context;)Len/e;
    .locals 1

    new-instance v0, Len/e;

    invoke-direct {v0, p0}, Len/e;-><init>(Landroid/content/Context;)V

    invoke-virtual {v0}, Len/e;->e()V
...
.method public static e(Landroid/content/Context;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    sget v1, Lwm/b$g;->miuix_appcompat_action_bar_title_view_padding_horizontal:I
    ...
    invoke-direct {v2, v1, v0}, Lgn/a;-><init>(Landroid/widget/FrameLayout;I)V

    invoke-virtual {v1, v2}, Landroid/view/View;->post(Ljava/lang/Runnable;)Z

    sget v0, Lwm/b$j;->up:I
    ...
    sget v2, Lwm/b$p;->actionbar_button_up_description:I
    ...
    invoke-direct {v2, v0, p0}, Lgn/b;-><init>(Landroidx/appcompat/widget/AppCompatImageView;Landroid/content/Context;)V
