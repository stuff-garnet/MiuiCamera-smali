...
.method public onLayoutChange(Landroid/view/View;IIIIIIII)V
    ...
    invoke-static {p2}, Lmiuix/preference/PreferenceFragment;->Bk(Lmiuix/preference/PreferenceFragment;)Lmiuix/preference/PreferenceFragment$c;
    ...
    invoke-static {p2}, Lmiuix/preference/PreferenceFragment;->Fk(Lmiuix/preference/PreferenceFragment;)Lnn/b;
    ...
    invoke-static {p2, p1, p3, p4, p5}, Lmiuix/preference/PreferenceFragment;->Gk(Lmiuix/preference/PreferenceFragment;Landroid/content/Context;Lnn/b;II)Z
    ...
    invoke-virtual {p1}, Lmiuix/preference/PreferenceFragment;->c7()I

    move-result p1

    iget-object p2, p0, Lmiuix/preference/PreferenceFragment$a;->a:Lmiuix/preference/PreferenceFragment;

    invoke-static {p2}, Lmiuix/preference/PreferenceFragment;->Hk(Lmiuix/preference/PreferenceFragment;)Ljava/util/List;
    ...
    invoke-static {p3}, Lmiuix/preference/PreferenceFragment;->Hk(Lmiuix/preference/PreferenceFragment;)Ljava/util/List;
    ...
    invoke-interface {p3, p1}, Lnn/a;->ud(I)V
    ...
    invoke-virtual {p2, p1}, Lmiuix/preference/PreferenceFragment;->ud(I)V
    ...
    invoke-static {p3}, Lmiuix/preference/PreferenceFragment;->Ik(Lmiuix/preference/PreferenceFragment;)Lmiuix/preference/b;
    ...
    invoke-virtual {p0, p1}, Lmiuix/preference/b;->ud(I)V

    :cond_3
    new-instance p0, Lqp/h;

    invoke-direct {p0, p2}, Lqp/h;-><init>(Landroidx/recyclerview/widget/RecyclerView;)V
