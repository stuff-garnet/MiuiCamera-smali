...
.method public static synthetic a(Lmiuix/flexible/template/AbstractMarkTemplate;Lco/d;Lco/d;)I
    .locals 0

    invoke-direct {p0, p1, p2}, Lmiuix/flexible/template/AbstractMarkTemplate;->lambda$measureViewList$0(Lco/d;Lco/d;)I
...
.method public static addAuxiliaryView(Landroid/view/ViewGroup;Landroid/content/Context;III)V
    ...
    .line 5
    invoke-virtual {p1, p2}, Lmiuix/flexible/view/HyperCellLayout$a;->r(I)Lmiuix/flexible/view/HyperCellLayout$a;
...
.method public static generateLayoutParams(IFFIIIIII)Lmiuix/flexible/view/HyperCellLayout$a;
    ...
    .line 3
    invoke-virtual {v0, p0}, Lmiuix/flexible/view/HyperCellLayout$a;->x(I)Lmiuix/flexible/view/HyperCellLayout$a;

    .line 4
    invoke-virtual {v0, p1}, Lmiuix/flexible/view/HyperCellLayout$a;->A(F)Lmiuix/flexible/view/HyperCellLayout$a;

    .line 5
    invoke-virtual {v0, p2}, Lmiuix/flexible/view/HyperCellLayout$a;->v(F)Lmiuix/flexible/view/HyperCellLayout$a;

    .line 6
    invoke-virtual {v0, p3}, Lmiuix/flexible/view/HyperCellLayout$a;->t(I)Lmiuix/flexible/view/HyperCellLayout$a;

    .line 7
    invoke-virtual {v0, p4}, Lmiuix/flexible/view/HyperCellLayout$a;->y(I)Lmiuix/flexible/view/HyperCellLayout$a;
...
.method private synthetic lambda$measureViewList$0(Lco/d;Lco/d;)I
    .locals 0

    invoke-virtual {p0, p1}, Lmiuix/flexible/template/AbstractMarkTemplate;->getViewNodePriority(Lco/d;)I

    move-result p1

    invoke-virtual {p0, p2}, Lmiuix/flexible/template/AbstractMarkTemplate;->getViewNodePriority(Lco/d;)I
...
.method private layoutViewList(Lco/c;ZIII)V
    .locals 17

    move-object/from16 v8, p0

    invoke-virtual/range {p1 .. p1}, Lco/d;->e()I

    move-result v0

    add-int v0, p4, v0

    invoke-virtual/range {p1 .. p1}, Lco/d;->a()I
    ...
    invoke-virtual/range {p1 .. p1}, Lco/c;->k()Ljava/util/List;
    ...
    invoke-virtual {v4}, Lco/d;->c()Landroid/view/View;
    ...
    invoke-virtual {v5}, Lmiuix/flexible/view/HyperCellLayout$a;->f()I

    move-result v5

    invoke-virtual/range {p1 .. p1}, Lco/c;->l()I
    ...
    check-cast v15, Lco/c;

    invoke-virtual {v15}, Lco/c;->k()Ljava/util/List;
    ...
    invoke-virtual {v0}, Lco/d;->c()Landroid/view/View;
    ...
    invoke-virtual {v0}, Lmiuix/flexible/view/HyperCellLayout$a;->f()I
    ...
    invoke-direct/range {v0 .. v5}, Lmiuix/flexible/template/AbstractMarkTemplate;->layoutViewList(Lco/c;ZIII)V
    ...
    invoke-virtual {v3}, Lmiuix/flexible/view/HyperCellLayout$a;->f()I
...
.method private measureChildView(Lco/d;IIII)V
    .locals 7

    invoke-virtual {p1}, Lco/d;->c()Landroid/view/View;
    ...
    invoke-virtual {p0}, Lmiuix/flexible/view/HyperCellLayout$a;->m()Z
    ...
    invoke-virtual {p0}, Lmiuix/flexible/view/HyperCellLayout$a;->c()F
    ...
    :cond_9
    invoke-virtual {p1, p2}, Lco/d;->j(I)V

    invoke-virtual {p1, p3}, Lco/d;->f(I)V

    :cond_a
    return-void
.end method

.method private measureViewList(Lco/c;Lco/c;IIII)V
    .locals 19
    ...
    invoke-virtual/range {p2 .. p2}, Lco/c;->k()Ljava/util/List;
    ...
    :cond_1
    invoke-virtual/range {p2 .. p2}, Lco/c;->l()I
    ...
    :goto_2
    instance-of v0, v4, Lco/c;

    if-eqz v0, :cond_5

    move-object/from16 v17, v4

    check-cast v17, Lco/c;
    ...
    invoke-direct/range {v0 .. v6}, Lmiuix/flexible/template/AbstractMarkTemplate;->measureViewList(Lco/c;Lco/c;IIII)V
    ...
    invoke-virtual/range {v17 .. v17}, Lco/d;->e()I
    ...
    invoke-virtual/range {v17 .. v17}, Lco/d;->a()I
    ...
    invoke-direct/range {v0 .. v5}, Lmiuix/flexible/template/AbstractMarkTemplate;->measureChildView(Lco/d;IIII)V
    ...
    invoke-virtual/range {p2 .. p2}, Lco/d;->d()F
    ...
    :cond_12
    invoke-virtual {v8, v13}, Lco/d;->j(I)V
    ...
    :cond_14
    invoke-virtual {v8, v14}, Lco/d;->f(I)V
    ...
    invoke-virtual {v2}, Lco/d;->a()I

    move-result v0

    invoke-virtual/range {p2 .. p2}, Lco/d;->a()I
    ...
    invoke-virtual {v7, v2, v10}, Lmiuix/flexible/template/AbstractMarkTemplate;->hasMatchParentChild(Lco/c;I)Z

    move-result v0

    if-eqz v0, :cond_17

    invoke-virtual {v2}, Lco/d;->e()I
    ...
    invoke-virtual/range {p2 .. p2}, Lco/d;->e()I

    move-result v1

    if-ge v0, v1, :cond_15

    invoke-virtual {v7, v2, v11}, Lmiuix/flexible/template/AbstractMarkTemplate;->hasMatchParentChild(Lco/c;I)Z
    ...
    invoke-virtual {v1}, Lco/d;->c()Landroid/view/View;
...
.method public applyLevel()V
    ...
    iget-object v0, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mLevelCallback:Lmiuix/flexible/view/HyperCellLayout$b;
    ...
    invoke-interface {v0, p0, v1}, Lmiuix/flexible/view/HyperCellLayout$b;->a(I[Ljava/lang/Object;)V
...
.method public buildViewTree(Landroid/view/ViewGroup;)V
    ...
    :cond_0
    invoke-static {v1, p0}, Lco/b;->b([Landroid/view/View;Lco/b$a;)Lco/c;

    move-result-object p1

    iput-object p1, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:Lco/c;
...
.method public dp2px(F)I
    ...
    invoke-static {p0, p1}, Lqn/k;->c(FF)I
...
.method public getGroupWeight(Landroid/view/View;)F
    ...
    invoke-virtual {v0}, Lmiuix/flexible/view/HyperCellLayout$a;->h()F
    ...
    invoke-virtual {p0}, Lmiuix/flexible/view/HyperCellLayout$a;->h()F
...
.method public getViewNodePriority(Lco/d;)I
    .locals 2
    ...
    invoke-virtual {p0}, Lmiuix/flexible/view/HyperCellLayout$a;->k()I
    ...
    invoke-virtual {p1}, Lco/c;->k()Ljava/util/List;
...
.method public getWeight(Landroid/view/View;)F
    ...
    invoke-virtual {v0}, Lmiuix/flexible/view/HyperCellLayout$a;->l()F
    ...
    invoke-virtual {p0}, Lmiuix/flexible/view/HyperCellLayout$a;->l()F
...
.method public hasMatchParentChild(Lco/c;I)Z
    .locals 4
    ...
    invoke-virtual {p0, v0, p2}, Lmiuix/flexible/template/AbstractMarkTemplate;->hasMatchParentChild(Lco/c;I)Z
...
.method public init(Landroid/view/ViewGroup;Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object p1, Lyn/b$m;->HyperCellLayout:[I
    ...
    sget v2, Lyn/b$m;->HyperCellLayout_android_gravity:I
    ...
    :cond_0
    sget v2, Lyn/b$m;->HyperCellLayout_column_spacing:I
    ...
    :cond_1
    sget v2, Lyn/b$m;->HyperCellLayout_row_spacing:I
...
.method public onLayout(Landroid/view/ViewGroup;ZIIII)V
    ...
    iget-object p2, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:Lco/c;
    ...
    iget-object p5, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:Lco/c;

    invoke-virtual {p5}, Lco/d;->a()I
    ...
    iget-object p3, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:Lco/c;

    invoke-virtual {p3}, Lco/d;->a()I
    ...
    iget-object p1, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:Lco/c;

    invoke-virtual {p1}, Lco/d;->e()I
    ...
    iget-object v2, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:Lco/c;

    move-object v1, p0

    invoke-direct/range {v1 .. v6}, Lmiuix/flexible/template/AbstractMarkTemplate;->layoutViewList(Lco/c;ZIII)V
...
.method public onMeasure(Landroid/view/ViewGroup;II)[I
    ...
    iget-object v4, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:Lco/c;
    ...
    invoke-direct/range {v2 .. v8}, Lmiuix/flexible/template/AbstractMarkTemplate;->measureViewList(Lco/c;Lco/c;IIII)V
    ...
    :cond_1
    iget-object p0, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:Lco/c;

    invoke-virtual {p0}, Lco/d;->a()I
...
.method public setGravity(Lmiuix/flexible/view/HyperCellLayout$a;Lmiuix/flexible/view/HyperCellLayout$a;)V
    ...
    .line 1
    invoke-virtual {p1}, Lmiuix/flexible/view/HyperCellLayout$a;->e()I
...
.method public setLevelCallback(Lmiuix/flexible/view/HyperCellLayout$b;)V
    ...
    iput-object p1, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mLevelCallback:Lmiuix/flexible/view/HyperCellLayout$b;
...
.method public setPriority(Lmiuix/flexible/view/HyperCellLayout$a;Lmiuix/flexible/view/HyperCellLayout$a;)V
    ...
    invoke-virtual {p2}, Lmiuix/flexible/view/HyperCellLayout$a;->k()I
    ...
    invoke-virtual {p1, p0}, Lmiuix/flexible/view/HyperCellLayout$a;->z(I)Lmiuix/flexible/view/HyperCellLayout$a;
    ...
    invoke-virtual {p2}, Lmiuix/flexible/view/HyperCellLayout$a;->g()I
    ...
    invoke-virtual {p1, p0}, Lmiuix/flexible/view/HyperCellLayout$a;->u(I)Lmiuix/flexible/view/HyperCellLayout$a;
