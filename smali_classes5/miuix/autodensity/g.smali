...
.method public onDensityChangedBeforeActivityConfigChanged(Landroid/app/Activity;Landroid/content/res/Configuration;Lqn/s;)V
    .locals 0

    invoke-static {p2, p3}, Lqn/d;->E(Landroid/content/res/Configuration;Lqn/s;)V

    invoke-static {p1, p3}, Lqn/d;->C(Landroid/content/Context;Lqn/s;)V

    invoke-static {p1}, Lqn/d;->t(Landroid/content/Context;)V

    invoke-static {p3}, Lqn/d;->w(Lqn/s;)V
...
.method public registerCallback(Landroid/app/Activity;)V
    ...
    iget-object p0, p0, Lmiuix/autodensity/g;->mUiHandler:Landroid/os/Handler;
...
.method public unregisterDisplayListener(Lmiuix/autodensity/g$a;)V
    .locals 0

    iget-object p0, p0, Lmiuix/autodensity/g;->mDisplayManager:Landroid/hardware/display/DisplayManager;
