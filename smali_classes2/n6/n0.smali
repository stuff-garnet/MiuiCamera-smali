...
.field public q1:Lcom/android/camera/a3;
...
.method private synthetic J(Ld6/j0;Lj7/o1;)V
    ...
    :cond_0
    invoke-virtual {p1}, Ld6/j0;->te()Lm9/s;
    ...
    :goto_1
    invoke-interface {p2, v0, v1, p0, v2}, Lj7/e1;->Wf([Landroid/hardware/camera2/params/MeteringRectangle;Landroid/graphics/Rect;FZ)V
...
.method public F(Ld6/j0;)V
    ...
    invoke-virtual {v0, p0}, Lcom/android/camera/ActivityBase;->sl(Ljava/lang/String;)V
...
.method public G(Lcom/android/camera2/a;Ld6/j0;)Z
    ...
    invoke-interface {p2}, Lj7/o2;->o0()Z
    ...
    invoke-static {}, Lcom/android/camera/o6;->s3()Z
...
.method public H(Ld6/j0;Lcom/android/camera2/f;)Z
    ...
    invoke-virtual {p1}, Ld6/j0;->ck()Ljava/util/Optional;
    ...
    check-cast p1, Lcom/android/camera/a3;

    iput-object p1, p0, Ln6/n0;->q1:Lcom/android/camera/a3;

    invoke-static {p2}, Lcom/android/camera2/g;->B9(Lcom/android/camera2/f;)Z
...
.method public K(Landroid/hardware/camera2/CaptureResult;Ld6/j0;Lcom/android/camera2/a;)V
    ...
    invoke-static {p1, p2, p3, v0}, Lcom/android/camera/o6;->P0(Landroid/hardware/camera2/CaptureResult;Ljava/util/List;II)Ljava/lang/String;
...
.method public final L(Landroid/hardware/camera2/CaptureResult;Ld6/j0;)V
    ...
    invoke-virtual {p2}, Ld6/j0;->Dk()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Lm6/n;->c(Ljava/lang/String;)V

    iget-object v0, p0, Ln6/n0;->q1:Lcom/android/camera/a3;
    ...
    iget-object v3, p0, Ln6/n0;->q1:Lcom/android/camera/a3;

    invoke-virtual {v3}, Lcom/android/camera/o5;->n()I

    move-result v3

    iget-object v4, p0, Ln6/n0;->q1:Lcom/android/camera/a3;
    ...
    iget-object v1, p0, Ln6/n0;->q1:Lcom/android/camera/a3;

    invoke-virtual {v1}, Lcom/android/camera/o5;->n()I

    move-result v1

    iget-object v2, p0, Ln6/n0;->q1:Lcom/android/camera/a3;
