...
.field public f:Lcom/android/camera/a4$c;
...
.method public static synthetic l(Ld6/p2;)V
    ...
    invoke-virtual {v0, p0}, Lcom/android/camera/a4$b;->Q(I)V
...
.method public c(Lid/z;Z)V
    ...
    iget-object p2, p0, Lj6/f;->f:Lcom/android/camera/a4$c;
    ...
    invoke-virtual {p2}, Ld6/j0;->gf()Le6/m;
    ...
    iput-object v0, p0, Lj6/f;->f:Lcom/android/camera/a4$c;

    invoke-static {}, La7/a;->a()La7/a;

    move-result-object p2

    iget-object v0, p0, Lj6/f;->f:Lcom/android/camera/a4$c;

    invoke-virtual {p2, v0}, La7/a;->d(Lcom/android/camera/a4$c;)V

    iget-object p0, p0, Lj6/f;->f:Lcom/android/camera/a4$c;

    invoke-virtual {p1, p0}, Lid/z;->r1(Lcom/android/camera/a4$c;)V
...
.method public final d()V
    ...
    invoke-virtual {v0}, Ld6/p2;->Bo()I

    move-result v3

    invoke-virtual {v0}, Ld6/p2;->po()Lcom/xiaomi/engine/GraphDescriptorBean;
    ...
    iget-object v6, v0, Ld6/p2;->q9:Lg6/g0;

    iget-object v6, v6, Lg6/g0;->A:Lcom/android/camera/d3;
    ...
    iget-object v6, v6, Lg6/g0;->B:Lcom/android/camera/d3;
    ...
    iget-object v1, v0, Ld6/p2;->q9:Lg6/g0;

    iget-boolean v5, v0, Ld6/p2;->Aa:Z
    ...
    invoke-virtual/range {v1 .. v6}, Lg6/g0;->a(IILcom/xiaomi/engine/GraphDescriptorBean;ZLcom/android/camera/d3;)Lcom/xiaomi/engine/BufferFormat;

    move-result-object v1

    iget-object v2, v0, Ld6/p2;->q9:Lg6/g0;

    iget-object v2, v2, Lg6/g0;->z:Lcom/android/camera/d3;
    ...
    iget-object v0, v0, Ld6/p2;->q9:Lg6/g0;

    iget-object v0, v0, Lg6/g0;->z:Lcom/android/camera/d3;

    invoke-virtual {v0}, Lcom/android/camera/d3;->j()Landroid/util/Size;
    ...
    invoke-virtual {v0, v2}, La7/a;->c(Z)Lcom/android/camera/a4$b;

    move-result-object v0

    if-eqz v0, :cond_2

    invoke-virtual {v0, v1}, Lcom/android/camera/a4$b;->g(Lcom/xiaomi/engine/BufferFormat;)V
...
.method public e(Lcom/android/camera2/p3;Landroid/util/Size;I)Lid/a0;
    .locals 4
    ...
    invoke-virtual {p1}, Lcom/android/camera2/p3;->d()Lcom/android/camera/d3;
    ...
    invoke-virtual {v2}, Lcom/android/camera/d3;->j()Landroid/util/Size;
    ...
    iget-object v3, v0, Ld6/p2;->q9:Lg6/g0;

    iget v3, v3, Lg6/g0;->D:I

    invoke-direct {v1, v2, p1, p2, v3}, Lid/a0$a;-><init>(Landroid/util/Size;Landroid/util/Size;Landroid/util/Size;I)V
    ...
    invoke-virtual {v1, p1}, Lid/a0$a;->P(Z)Lid/a0$a;
    ...
    invoke-virtual {v1, p1}, Lid/a0$a;->O(Z)Lid/a0$a;

    const/4 p1, 0x0

    invoke-virtual {v1, p1}, Lid/a0$a;->q(Z)Lid/a0$a;

    move-result-object p2

    invoke-virtual {v0}, Ld6/p2;->Zo()Z

    move-result v1

    invoke-virtual {p2, v1}, Lid/a0$a;->z(Z)Lid/a0$a;
    ...
    invoke-virtual {p2, v1}, Lid/a0$a;->v(I)Lid/a0$a;

    move-result-object p2

    sget v1, Lcom/android/camera/effect/p;->p3:I

    invoke-virtual {p2, v1}, Lid/a0$a;->h(I)Lid/a0$a;

    move-result-object p2

    sget v1, Lcom/android/camera/effect/p;->K2:I

    invoke-virtual {p2, v1}, Lid/a0$a;->n(I)Lid/a0$a;

    move-result-object p2

    sget v1, Lcom/android/camera/effect/p;->q3:I

    invoke-virtual {p2, v1}, Lid/a0$a;->T(I)Lid/a0$a;
    ...
    invoke-virtual {p2, p1}, Lid/a0$a;->S(I)Lid/a0$a;

    move-result-object p2

    invoke-virtual {p2, p1}, Lid/a0$a;->U(I)Lid/a0$a;

    move-result-object p2

    invoke-virtual {p2, p1}, Lid/a0$a;->B(Z)Lid/a0$a;

    move-result-object p2

    invoke-virtual {v0}, Ld6/j0;->Xc()Le6/b;
    ...
    :goto_0
    invoke-virtual {p2, v1}, Lid/a0$a;->C(I)Lid/a0$a;
    ...
    invoke-virtual {p2, v1}, Lid/a0$a;->u(I)Lid/a0$a;
    ...
    invoke-virtual {p2, v1}, Lid/a0$a;->L(F)Lid/a0$a;
    ...
    invoke-virtual {p2, v1}, Lid/a0$a;->K(I)Lid/a0$a;
    ...
    invoke-virtual {p2, v1}, Lid/a0$a;->w(Landroid/location/Location;)Lid/a0$a;
    ...
    invoke-virtual {p2, v1}, Lid/a0$a;->o(Z)Lid/a0$a;

    move-result-object p2

    invoke-virtual {v0}, Ld6/p2;->qo()Lg6/r;
    ...
    invoke-virtual {p2, v1}, Lid/a0$a;->d(Z)Lid/a0$a;

    move-result-object p2

    iget-object v1, v0, Ld6/p2;->S9:Ljava/lang/String;

    invoke-virtual {p2, v1}, Lid/a0$a;->b(Ljava/lang/String;)Lid/a0$a;

    move-result-object p2

    invoke-virtual {v0, p1}, Ld6/p2;->yo(Z)Lid/d0;

    move-result-object v1

    invoke-virtual {p2, v1}, Lid/a0$a;->E(Lid/d0;)Lid/a0$a;

    move-result-object p2

    const-string v1, ""

    invoke-virtual {p2, v1}, Lid/a0$a;->N(Ljava/lang/String;)Lid/a0$a;
    ...
    invoke-virtual {p2, p0}, Lid/a0$a;->k(Lcom/android/camera/effect/renders/f;)Lid/a0$a;

    move-result-object p0

    invoke-virtual {p0, p3}, Lid/a0$a;->t(I)Lid/a0$a;
    ...
    :cond_1
    invoke-virtual {p0, p1}, Lid/a0$a;->J(Z)Lid/a0$a;

    move-result-object p0

    invoke-virtual {p0}, Lid/a0$a;->a()Lid/a0;
...
.method public f()V
    ...
    invoke-static {v0, v3}, Lcom/android/camera2/g;->L1(Lcom/android/camera2/f;I)Lcom/android/camera/d3;
    ...
    :cond_5
    invoke-virtual {v1, v2}, Lcom/android/camera/a4$b;->i(Ljava/util/HashMap;)V
...
.method public h()V
    ...
    invoke-virtual {v3, v4}, La7/a;->c(Z)Lcom/android/camera/a4$b;
    ...
    :cond_2
    invoke-virtual {v1}, Ld6/j0;->A0()Lcom/android/camera/Camera;
    ...
    invoke-virtual {v3, p0}, Lcom/android/camera/a4$b;->J(La8/i;)V

    :cond_3
    iget-object p0, v1, Ld6/p2;->q9:Lg6/g0;

    iget-object v1, p0, Lg6/g0;->B:Lcom/android/camera/d3;

    iget v4, v1, Lcom/android/camera/d3;->a:I

    iget v1, v1, Lcom/android/camera/d3;->b:I

    iget p0, p0, Lg6/g0;->D:I

    invoke-virtual {v3, v4, v1, p0}, Lcom/android/camera/a4$b;->M(III)V

    invoke-static {}, Lub/c;->r2()Lub/c;

    move-result-object p0

    invoke-virtual {p0}, Lub/c;->G4()Z

    move-result p0

    invoke-virtual {v3, p0}, Lcom/android/camera/a4$b;->O(Z)V
...
.method public k()Z
    ...
    invoke-virtual {v1}, Lcom/android/camera/a4$b;->r()Z
...
.method public m()V
    ...
    invoke-virtual {v1}, Lid/t;->v()Landroid/os/Handler;
...
.method public n()V
    ...
    invoke-virtual {v1, p0}, Lcom/android/camera/a4$b;->L(Lcom/xiaomi/protocol/ISessionStatusCallBackListener;)V

    :cond_0
    if-eqz v1, :cond_1

    iget-boolean p0, v0, Ld6/p2;->qa:Z
    ...
    invoke-interface {p0}, Le6/m;->v2()Lid/k;

    move-result-object p0

    invoke-virtual {v1, p0}, Lcom/android/camera/a4$b;->N(Lid/k;)V
