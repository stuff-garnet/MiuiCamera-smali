...
.method public constructor <init>(Ld6/k;[BJLd6/k$j;)V
    ...
    invoke-static {p1}, Ld6/k;->Tm(Ld6/k;)I

    move-result p2

    iput p2, p0, Ld6/k$i;->e:I

    invoke-static {p1}, Ld6/k;->Sm(Ld6/k;)I

    move-result p2

    iput p2, p0, Ld6/k$i;->f:I

    invoke-static {p1}, Ld6/k;->dn(Ld6/k;)I
    ...
    invoke-static {p1}, Ld6/k;->Vm(Ld6/k;)Landroid/hardware/camera2/CaptureResult;
    ...
    invoke-static {p1}, Ld6/k;->Ym(Ld6/k;)Landroid/util/SparseArray;
...
# virtual methods
.method public final a(Lxb/e;[BLandroid/location/Location;S)[B
    .locals 15
    ...
    invoke-static {v11, v0}, Lcom/android/camera/m3;->c(Lxb/e;S)V

    invoke-static {}, Lcom/android/camera/effect/r;->a()[B

    move-result-object v0

    invoke-static {v12, v11, v0}, Lxb/d;->H([BLxb/e;[B)[B
...
.method public varargs d([Ljava/lang/Void;)Ljava/lang/Integer;
    ...
    invoke-static {p1}, Lcom/android/camera/c3;->i0(Z)Lcom/android/camera/l3;

    move-result-object v0

    invoke-virtual {v0, p1}, Lcom/android/camera/l3;->b(Z)I
    ...
    invoke-virtual {v2}, Lcom/android/camera/d4;->h()Landroid/location/Location;
    ...
    :try_start_0
    invoke-virtual {p0, v5, v0, v2, v1}, Ld6/k$i;->a(Lxb/e;[BLandroid/location/Location;S)[B
    ...
    invoke-direct/range {v6 .. v13}, Lid/z;-><init>(IJILjava/lang/String;J)V

    invoke-virtual {v2, v1, p1}, Lid/z;->a([BI)V

    iget-object v1, v2, Lid/z;->l0:Lid/h;

    invoke-virtual {v1, v5}, Lid/h;->f(Lxb/e;)V

    new-instance v1, Lid/a0$a;

    const/16 v3, 0x100

    invoke-direct {v1, v0, v0, v0, v3}, Lid/a0$a;-><init>(Landroid/util/Size;Landroid/util/Size;Landroid/util/Size;I)V
    ...
    invoke-static {v5}, Lcom/android/camera/c3;->W(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v1, v3}, Lid/a0$a;->q(Z)Lid/a0$a;

    move-result-object v1

    iget v3, p0, Ld6/k$i;->g:I

    invoke-virtual {v1, v3}, Lid/a0$a;->u(I)Lid/a0$a;
    ...
    invoke-virtual {v3, p1}, Lcom/android/camera/l3;->b(Z)I

    move-result v3

    invoke-virtual {v1, v3}, Lid/a0$a;->t(I)Lid/a0$a;

    move-result-object v1

    sget v3, Lcom/android/camera/effect/p;->p3:I

    invoke-virtual {v1, v3}, Lid/a0$a;->h(I)Lid/a0$a;
    ...
    invoke-virtual {v1, v3}, Lid/a0$a;->V(I)Lid/a0$a;

    move-result-object v1

    invoke-virtual {v1, p1}, Lid/a0$a;->S(I)Lid/a0$a;

    move-result-object v1

    invoke-virtual {v1, p1}, Lid/a0$a;->U(I)Lid/a0$a;
    ...
    :goto_4
    invoke-virtual {p1, v1}, Lid/a0$a;->R(Ljava/lang/String;)Lid/a0$a;

    move-result-object p1

    invoke-virtual {p1, v0}, Lid/a0$a;->k(Lcom/android/camera/effect/renders/f;)Lid/a0$a;
    ...
    invoke-static {v0}, Ld6/k;->An(Ld6/k;)Lid/d0;
    ...
    invoke-virtual {p1, v0}, Lid/a0$a;->E(Lid/d0;)Lid/a0$a;

    move-result-object p1

    invoke-virtual {p1}, Lid/a0$a;->a()Lid/a0;

    move-result-object p1

    invoke-virtual {v2, p1}, Lid/z;->b(Lid/a0;)V

    invoke-virtual {v2, v6}, Lid/z;->b1(Z)V
    ...
    invoke-virtual {p0, v2, v4, v4, v4}, La8/i;->m(Lid/z;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)Z
...
.method public final e(SLandroid/location/Location;I)[B
    ...
    invoke-static {p1, p2, p0, p3}, Lcom/android/camera/x3;->c([BIII)[B
...
.method public final g(SLandroid/location/Location;I)[B
    ...
    invoke-static {v2}, Lcom/android/camera/o6;->l1(I)I
