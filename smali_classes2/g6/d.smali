...
.method public final f(Ljava/lang/Object;IIZZ)V
    ...
    :cond_0
    invoke-virtual {v14}, Ld6/j0;->gf()Le6/m;
    ...
    invoke-virtual {v14}, Ld6/p2;->Zo()Z
    ...
    invoke-virtual {v14}, Ld6/j0;->Xc()Le6/b;
    ...
    invoke-interface {v1, v2, v3}, Lj7/x2;->kg(ZI)I
    ...
    invoke-virtual {v14}, Ld6/j0;->X()I

    move-result v16

    invoke-static/range {v16 .. v16}, Lcom/android/camera/c3;->y3(I)Z
    ...
    invoke-virtual {v4, v5}, Lub/c;->I8(I)Z
    ...
    :try_start_0
    invoke-static {v0}, Lxb/d;->k([B)Lxb/e;
    ...
    invoke-static {v0, v5, v7}, Lxb/d;->H([BLxb/e;[B)[B
    ...
    invoke-virtual {v14, v3}, Ld6/p2;->xo(I)I
    ...
    iget-object v5, v14, Ld6/p2;->Ka:Lj6/f;
    ...
    iget-boolean v5, v14, Ld6/p2;->N9:Z
    ...
    invoke-virtual {v14}, Ld6/p2;->ro()Lg6/s;
    ...
    invoke-direct/range {v26 .. v33}, Lid/z;-><init>(IJILjava/lang/String;J)V

    iget-object v2, v14, Ld6/p2;->Ka:Lj6/f;

    iget-boolean v2, v2, Lj6/f;->e:Z

    if-nez v2, :cond_e

    iget-boolean v2, v14, Ld6/p2;->N9:Z

    if-nez v2, :cond_e

    iget-boolean v2, v14, Ld6/p2;->ra:Z
    ...
    :goto_9
    invoke-virtual {v4, v6}, Lid/z;->b1(Z)V

    const/4 v2, 0x0

    invoke-virtual {v4, v0, v2}, Lid/z;->a([BI)V

    invoke-virtual {v4, v11}, Lid/z;->c1(Z)V

    move/from16 v0, v24

    invoke-virtual {v4, v0}, Lid/z;->t1(Z)V

    move/from16 v0, v19

    invoke-virtual {v4, v0}, Lid/z;->Y0(Z)V
    ...
    invoke-direct {v0, v2, v5, v6, v3}, Lid/a0$a;-><init>(Landroid/util/Size;Landroid/util/Size;Landroid/util/Size;I)V
    ...
    invoke-static {v2}, Lcom/android/camera2/g;->W2(Lcom/android/camera2/f;)Z
    ...
    :goto_a
    invoke-virtual {v0, v6}, Lid/a0$a;->P(Z)Lid/a0$a;

    invoke-virtual {v0, v1}, Lid/a0$a;->C(I)Lid/a0$a;
    ...
    invoke-virtual {v0, v1}, Lid/a0$a;->L(F)Lid/a0$a;
    ...
    invoke-virtual {v0, v1}, Lid/a0$a;->K(I)Lid/a0$a;
    ...
    invoke-virtual {v0, v1}, Lid/a0$a;->w(Landroid/location/Location;)Lid/a0$a;

    move-result-object v0

    move/from16 v1, v23

    invoke-virtual {v0, v1}, Lid/a0$a;->h(I)Lid/a0$a;

    move-result-object v0

    move/from16 v1, v18

    invoke-virtual {v0, v1}, Lid/a0$a;->T(I)Lid/a0$a;

    move-result-object v0

    move/from16 v2, v22

    invoke-virtual {v0, v2}, Lid/a0$a;->V(I)Lid/a0$a;
    ...
    invoke-virtual {v0, v1}, Lid/a0$a;->S(I)Lid/a0$a;
    ...
    invoke-virtual {v0, v12}, Lid/a0$a;->n(I)Lid/a0$a;

    move-result-object v0

    move/from16 v1, v17

    invoke-virtual {v0, v1}, Lid/a0$a;->B(Z)Lid/a0$a;

    move-result-object v0

    invoke-virtual {v0, v10}, Lid/a0$a;->c(Z)Lid/a0$a;

    move-result-object v0

    const/4 v1, 0x1

    invoke-virtual {v14, v1}, Ld6/p2;->yo(Z)Lid/d0;

    move-result-object v2

    invoke-virtual {v0, v2}, Lid/a0$a;->E(Lid/d0;)Lid/a0$a;

    move-result-object v0

    move/from16 v12, v25

    invoke-virtual {v0, v12}, Lid/a0$a;->z(Z)Lid/a0$a;
    ...
    invoke-virtual {v0, v2}, Lid/a0$a;->Q(Ljava/lang/String;)Lid/a0$a;
    ...
    invoke-virtual {v0, v2}, Lid/a0$a;->o(Z)Lid/a0$a;
    ...
    invoke-virtual {v0, v2}, Lid/a0$a;->k(Lcom/android/camera/effect/renders/f;)Lid/a0$a;
    ...
    invoke-virtual {v0, v2}, Lid/a0$a;->p(Z)Lid/a0$a;

    move-result-object v0

    invoke-virtual {v0, v7}, Lid/a0$a;->g(I)Lid/a0$a;
    ...
    invoke-virtual {v0, v2}, Lid/a0$a;->i(Z)Lid/a0$a;
    ...
    invoke-virtual {v0, v2}, Lid/a0$a;->j(Z)Lid/a0$a;

    move-result-object v0

    invoke-virtual {v14}, Ld6/p2;->lo()J

    move-result-wide v2

    invoke-virtual {v0, v2, v3}, Lid/a0$a;->f(J)Lid/a0$a;
    ...
    invoke-virtual {v4, v0}, Lid/z;->b(Lid/a0;)V
    ...
    invoke-virtual {v4, v1}, Lid/z;->n1(Z)V

    :cond_11
    invoke-virtual {v14}, Ld6/j0;->A0()Lcom/android/camera/Camera;
    ...
    invoke-virtual {v0, v4, v1, v1, v1}, La8/i;->m(Lid/z;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)Z
...
.method public final g(Landroid/graphics/Bitmap;ZZZIZ)[B
    ...
    invoke-virtual {p0, p2}, Lcom/android/camera/l3;->b(Z)I

    move-result p0

    invoke-static {p1, p0}, Lff/c;->h(Landroid/graphics/Bitmap;I)[B
...
.method public final h([BZZZIZZ)[B
    ...
    :cond_3
    invoke-virtual {v2}, Ld6/j0;->Xc()Le6/b;
    ...
    sget-object v0, Lcom/android/camera/l3;->d:Lcom/android/camera/l3;

    invoke-virtual {v0, v8}, Lcom/android/camera/l3;->b(Z)I

    move-result v0

    invoke-static {v1, v0}, Lff/c;->h(Landroid/graphics/Bitmap;I)[B
