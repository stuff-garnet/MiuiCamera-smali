...
.method public constructor <init>(Lg6/x0;Ld6/p2;)V
    ...
    iput-object p1, p0, Lg6/x0$b;->d:Lid/a0;
...
.method public F7(ZJI)V
    ...
    invoke-virtual {v0, p4}, Lcom/android/camera/ActivityBase;->ll(Z)V

    :cond_2
    invoke-virtual {p0, p1, p2, p3}, Ld6/p2;->Aq(ZJ)V
...
.method public c8(Lid/z;Lcom/android/camera2/p3;)Lid/z;
    ...
    iget-object v3, v2, Ld6/p2;->Ka:Lj6/f;
    ...
    :cond_0
    invoke-virtual {v2}, Ld6/j0;->z8()Le6/h;
    ...
    invoke-virtual {v2}, Ld6/j0;->A0()Lcom/android/camera/Camera;
    ...
    :cond_3
    iget-object v3, v2, Ld6/p2;->q9:Lg6/g0;
    ...
    :cond_4
    invoke-virtual/range {p2 .. p2}, Lcom/android/camera2/p3;->d()Lcom/android/camera/d3;

    move-result-object v15

    iget-object v9, v0, Lg6/x0$b;->d:Lid/a0;
    ...
    invoke-virtual {v2}, Ld6/j0;->gf()Le6/m;

    move-result-object v9

    invoke-interface {v9}, Le6/m;->E0()I

    move-result v9

    invoke-static {v9}, Lp6/g;->k0(I)Z
    ...
    invoke-interface {v9}, Le6/m;->q2()Lcom/android/camera/d3;

    move-result-object v9

    invoke-virtual {v15, v9}, Lcom/android/camera/d3;->equals(Ljava/lang/Object;)Z
    ...
    iget-object v9, v3, Lg6/g0;->B:Lcom/android/camera/d3;
    ...
    :cond_9
    iget-object v9, v3, Lg6/g0;->A:Lcom/android/camera/d3;

    if-eqz v9, :cond_a

    invoke-virtual {v9, v15}, Lcom/android/camera/d3;->equals(Ljava/lang/Object;)Z
    ...
    invoke-interface {v9, v15}, Le6/m;->v1(Lcom/android/camera/d3;)V
    ...
    invoke-virtual/range {v9 .. v14}, Lg6/g0;->r(Lcom/android/camera/d3;ILe6/m;IZ)V
    ...
    invoke-virtual {v15}, Lcom/android/camera/d3;->j()Landroid/util/Size;
    ...
    invoke-static {v6}, Lcom/android/camera/c3;->i0(Z)Lcom/android/camera/l3;

    move-result-object v11

    invoke-virtual {v11, v10}, Lcom/android/camera/l3;->b(Z)I
    ...
    invoke-static {v10}, Lcom/android/camera2/g;->P8(Lcom/android/camera2/f;)Z
    ...
    :cond_e
    iget-object v10, v2, Ld6/p2;->Ka:Lj6/f;

    move-object/from16 v12, p2

    invoke-virtual {v10, v12, v9, v11}, Lj6/f;->e(Lcom/android/camera2/p3;Landroid/util/Size;I)Lid/a0;

    move-result-object v9

    iput-object v9, v0, Lg6/x0$b;->d:Lid/a0;

    :cond_f
    iget-object v9, v0, Lg6/x0$b;->d:Lid/a0;

    invoke-virtual {v1, v9}, Lid/z;->b(Lid/a0;)V

    invoke-static {}, Lub/c;->r2()Lub/c;

    move-result-object v9

    invoke-virtual {v9}, Lub/c;->mb()Z

    move-result v9

    if-eqz v9, :cond_10

    invoke-virtual {v1, v6}, Lid/z;->n1(Z)V
    ...
    invoke-virtual {v9}, Lcom/android/camera/Camera;->J2()La8/i;
    ...
    invoke-virtual {v2, v9}, Ld6/p2;->k0(I)V
    ...
    invoke-virtual {v1, v3}, Lid/z;->p1(Ljava/lang/String;)V
    ...
    :cond_14
    :goto_3
    invoke-virtual {v1, v6}, Lid/z;->b1(Z)V

    iget-object v2, v2, Ld6/p2;->Ka:Lj6/f;

    invoke-virtual {v2, v1, v7}, Lj6/f;->c(Lid/z;Z)V
    ...
    :cond_1a
    invoke-virtual {v1, v6}, Lid/z;->x0(Z)V
