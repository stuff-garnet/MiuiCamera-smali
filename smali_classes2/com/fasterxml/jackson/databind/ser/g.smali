...
.method public L(Lxa/e0;Lfb/s;Lcom/fasterxml/jackson/databind/ser/m;ZLfb/h;)Lcom/fasterxml/jackson/databind/ser/d;
    ...
    invoke-virtual {p2}, Lfb/s;->h()Lxa/y;
...
.method public V(Lxa/e0;Lxa/c;Lcom/fasterxml/jackson/databind/ser/f;)Ljava/util/List;
    ...
    invoke-virtual {v6}, Lfb/s;->y()Lfb/h;

    move-result-object v3

    invoke-virtual {v6}, Lfb/s;->T()Z
    ...
    :cond_3
    invoke-virtual {v6}, Lfb/s;->t()Lxa/b$a;
...
.method public b0(Lxa/c0;Lxa/c;Ljava/util/List;)V
    ...
    invoke-virtual {v0}, Lfb/s;->y()Lfb/h;
    ...
    :cond_1
    invoke-virtual {v0}, Lfb/s;->J()Ljava/lang/Class;
...
.method public d0(Lxa/c0;Lxa/c;Ljava/util/List;)V
    ...
    invoke-virtual {p1}, Lfb/s;->o()Z

    move-result p2

    if-nez p2, :cond_0

    invoke-virtual {p1}, Lfb/s;->R()Z
