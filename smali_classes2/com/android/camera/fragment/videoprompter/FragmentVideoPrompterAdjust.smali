...
.method public static synthetic Ik(ILh7/f;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/android/camera/fragment/videoprompter/FragmentVideoPrompterAdjust;->Ok(ILh7/f;)V

    return-void
.end method

.method public static synthetic Jk(ILh7/f;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/android/camera/fragment/videoprompter/FragmentVideoPrompterAdjust;->Nk(ILh7/f;)V
...
.method public static synthetic Kk(Lh7/f;)V
    ...
    invoke-static {p0}, Lcom/android/camera/fragment/videoprompter/FragmentVideoPrompterAdjust;->Pk(Lh7/f;)V

    return-void
.end method

.method public static synthetic Nk(ILh7/f;)V
    .locals 0

    invoke-interface {p1, p0}, Lh7/f;->U9(I)V

    return-void
.end method

.method public static synthetic Ok(ILh7/f;)V
    .locals 0

    invoke-interface {p1, p0}, Lh7/f;->rk(I)V

    return-void
.end method

.method public static synthetic Pk(Lh7/f;)V
    .locals 1

    const/4 v0, 0x0

    invoke-interface {p0, v0}, Lh7/f;->V8(Z)V
...
.method public final Lk()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/camera/fragment/videoprompter/FragmentVideoPrompterAdjust;->Sk(I)I
    ...
    invoke-virtual {p0, v1}, Lcom/android/camera/fragment/videoprompter/FragmentVideoPrompterAdjust;->Sk(I)I
...
.method public final Mk()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/camera/fragment/videoprompter/FragmentVideoPrompterAdjust;->Uk(I)I
    ...
    invoke-virtual {p0, v1}, Lcom/android/camera/fragment/videoprompter/FragmentVideoPrompterAdjust;->Uk(I)I
...
.method public final Rk(I)I
    ...
    invoke-virtual {p0, v0, v1, v2, p1}, Lcom/android/camera/fragment/videoprompter/FragmentVideoPrompterAdjust;->Qk([IIII)I
...
.method public final Sk(I)I
    ...
    invoke-virtual {p0, v0, v1, v2, p1}, Lcom/android/camera/fragment/videoprompter/FragmentVideoPrompterAdjust;->Vk([IIII)I
...
.method public initView(Landroid/view/View;)V
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/videoprompter/FragmentVideoPrompterAdjust;->Lk()V
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/videoprompter/FragmentVideoPrompterAdjust;->Mk()V
...
.method public j7(Landroid/view/View;FII)V
    .locals 0
    ...
    :cond_0
    invoke-virtual {p0, p3}, Lcom/android/camera/fragment/videoprompter/FragmentVideoPrompterAdjust;->Tk(I)I
    ...
    invoke-static {p0}, Lcom/android/camera/c3;->fa(I)V

    invoke-static {p3}, Lcom/android/camera/c3;->ga(I)V

    goto :goto_0

    :cond_1
    invoke-virtual {p0, p3}, Lcom/android/camera/fragment/videoprompter/FragmentVideoPrompterAdjust;->Rk(I)I
    ...
    invoke-static {p3}, Lcom/android/camera/c3;->ea(I)V
