...
.method public static synthetic a(Lcom/android/camera/provider/SplashProvider;Landroid/content/Context;Lcom/android/camera/display/manager/CamLayoutManager$b;Ljava/io/File;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/android/camera/provider/SplashProvider;->f(Landroid/content/Context;Lcom/android/camera/display/manager/CamLayoutManager$b;Ljava/io/File;)V

    return-void
.end method

.method private synthetic f(Landroid/content/Context;Lcom/android/camera/display/manager/CamLayoutManager$b;Ljava/io/File;)V
    .locals 4
    ...
    invoke-virtual {p0, p1, p2}, Lcom/android/camera/provider/SplashProvider;->e(Landroid/content/Context;Lcom/android/camera/display/manager/CamLayoutManager$b;)V
    ...
    invoke-static {p1, p2, v0, p3}, Lcom/android/camera/o6;->C4(Landroid/graphics/Bitmap;Ljava/lang/String;ILandroid/graphics/Bitmap$CompressFormat;)Z
    :try_end_0
...
# virtual methods
.method public final b(Lcom/android/camera/display/manager/CamLayoutManager$b;)Ljava/lang/String;
    .locals 2
...
.method public final c()Ljava/io/File;
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/android/camera/provider/SplashProvider;->d()Lcom/android/camera/display/manager/CamLayoutManager$b;
    ...
    invoke-virtual {p0, v1}, Lcom/android/camera/provider/SplashProvider;->b(Lcom/android/camera/display/manager/CamLayoutManager$b;)Ljava/lang/String;
    ...
    invoke-direct {v6, p0, v0, v1, v2}, Lr7/a;-><init>(Lcom/android/camera/provider/SplashProvider;Landroid/content/Context;Lcom/android/camera/display/manager/CamLayoutManager$b;Ljava/io/File;)V

    invoke-static {v3, v6}, Lcom/xiaomi/camera/rx/CameraSchedulers;->scheduleDirect(Lio/reactivex/Scheduler;Ljava/lang/Runnable;)Lio/reactivex/disposables/Disposable;
...
.method public final d()Lcom/android/camera/display/manager/CamLayoutManager$b;
    .locals 2
    ...
    invoke-static {p0}, Ld6/f5;->b(I)Lcom/android/camera/module/entry/b;

    move-result-object p0

    invoke-interface {p0}, Lcom/android/camera/module/entry/b;->getModeUI()Ld5/h;
    ...
    invoke-static {p0, v0, v1}, Lt1/k;->f(Ld5/h;ZI)Lcom/android/camera/display/manager/CamLayoutManager$b;
...
.method public final e(Landroid/content/Context;Lcom/android/camera/display/manager/CamLayoutManager$b;)V
    .locals 7
