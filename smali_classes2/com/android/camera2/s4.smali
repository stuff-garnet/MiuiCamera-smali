...
.method public final E()V
    ...
    invoke-direct {v1, v2}, Lid/z;-><init>(Lid/z;)V

    iget-object v2, p0, Lcom/android/camera2/s4;->w:[B

    const/4 v3, 0x3

    invoke-virtual {v1, v2, v3}, Lid/z;->a([BI)V

    iget v2, p0, Lcom/android/camera2/w4;->mPreviewThumbnailHash:I

    invoke-virtual {v1, v2}, Lid/z;->h1(I)V
    ...
    invoke-interface {v0, v1, v2, p0, v3}, Lid/p;->m(Lid/z;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)Z
...
.method public final F([BLandroid/hardware/camera2/CaptureResult;)V
    ...
    invoke-direct {v0, v2}, Lid/z;-><init>(Lid/z;)V

    const/4 v2, 0x3

    invoke-virtual {v0, p1, v2}, Lid/z;->a([BI)V

    const/16 p1, 0x14

    invoke-virtual {v0, p1}, Lid/z;->e1(I)V

    iget p1, p0, Lcom/android/camera2/w4;->mPreviewThumbnailHash:I

    invoke-virtual {v0, p1}, Lid/z;->h1(I)V
    ...
    invoke-interface {v1, v0, p2, p0, p1}, Lid/p;->m(Lid/z;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)Z
...
.method public final G([B[BLandroid/hardware/camera2/CaptureResult;)V
    ...
    invoke-direct {v2, v3}, Lid/z;-><init>(Lid/z;)V

    invoke-virtual {v2, p2, v0}, Lid/z;->a([BI)V

    const/4 p2, 0x3

    invoke-virtual {v2, p1, p2}, Lid/z;->a([BI)V

    const/16 p1, 0x14

    invoke-virtual {v2, p1}, Lid/z;->e1(I)V
    ...
    invoke-virtual {v2, p1}, Lid/z;->b1(Z)V
    ...
    invoke-interface {v1, v2, p3, p0, p1}, Lid/p;->m(Lid/z;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)Z
...
.method public handleCaptureFinished()V
    ...
    invoke-virtual {p0, v2, v3, v5, v6}, Lcom/android/camera2/p4;->notifyResultData(Lid/z;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)V
...
.method public x(Lcom/xiaomi/camera/mivi/qcom/bean/ResultOutputData;)V
    ...
    invoke-virtual {p0, p1, v0}, Lcom/android/camera2/p4;->C(Lcom/xiaomi/camera/mivi/qcom/bean/ResultOutputData;Lid/z;)V
    ...
    invoke-virtual {v0, v6}, Lid/z;->s0([B)V
    ...
    invoke-virtual {v3, v0}, Lid/z;->b1(Z)V
    ...
    iget-object v4, p0, Lcom/android/camera2/p4;->a:Lid/z;
    ...
    :cond_8
    invoke-virtual {p0, v0, p1, v1, v2}, Lcom/android/camera2/p4;->notifyResultData(Lid/z;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)V
