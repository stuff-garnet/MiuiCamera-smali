...
.method public static V(Landroid/hardware/camera2/CameraManager;)Lp6/g;
    .locals 2
...
.method public K(I)V
    ...
    invoke-static {p0, v0}, Lef/k;->b(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, p1}, Lz7/a;->i0(II)V
    ...
    invoke-static {v3, p1}, Lz7/a;->i0(II)V
...
.method public declared-synchronized L(II)I
    .locals 1
    ...
    :try_start_0
    invoke-virtual {p0, p1, p2, v0}, Lp6/g;->M(IIZ)I
...
.method public declared-synchronized M(IIZ)I
    .locals 9
    ...
    invoke-virtual {p0, p1, p2}, Lp6/g;->T(II)I
    ...
    invoke-static {v3}, Lcom/android/camera2/g;->P6(Lcom/android/camera2/f;)Z
    ...
    :pswitch_0
    invoke-static {p2}, Lcom/android/camera/c3;->e6(I)Z
    ...
    :cond_2f
    invoke-static {p2}, Lcom/android/camera/c3;->w7(I)Z

    move-result p3

    if-eqz p3, :cond_31

    invoke-static {p2}, Lcom/android/camera/c3;->I(I)Ljava/lang/String;
    ...
    :cond_34
    invoke-static {p2}, Lcom/android/camera/c3;->k3(I)Z
    ...
    invoke-virtual {p0, p1, p2, p3}, Lp6/g;->b0(IIZ)I
    ...
    invoke-static {p2, v3}, Lcom/android/camera/c3;->Da(ILjava/lang/String;)Z

    move-result v3

    invoke-static {p2}, Lcom/android/camera/c3;->e7(I)Z
    ...
    :cond_3a
    invoke-static {p2}, Lcom/android/camera/c3;->a6(I)Z

    move-result v3

    if-eqz v3, :cond_3e

    invoke-static {p2}, Lcom/android/camera/c3;->D1(I)Ljava/lang/String;
    ...
    :cond_3f
    invoke-static {p2}, Lcom/android/camera/c3;->I2(I)Z
    ...
    :goto_6
    invoke-static {p2, v6}, Lcom/android/camera/c3;->Da(ILjava/lang/String;)Z
    ...
    :cond_45
    invoke-static {p2}, Lcom/android/camera/c3;->w3(I)Z
    ...
    invoke-virtual {p0, p1}, Lp6/g;->N(I)I
    ...
    :cond_55
    invoke-virtual {p0, p2}, Lp6/g;->P(I)I
...
.method public final N(I)I
    ...
    invoke-static {}, Lcom/android/camera/o6;->K2()Z
    ...
    invoke-virtual {p0, v0}, Lp6/g;->K(I)V

    return v1

    :cond_2
    iget-object v1, p0, Lp6/g;->a:Lp6/c;

    invoke-virtual {v1}, Lp6/c;->getCapabilities()Landroid/util/SparseArray;
    ...
    :cond_3
    invoke-static {v3}, Lcom/android/camera2/g;->L(Lcom/android/camera2/f;)I

    move-result v4

    if-ne v4, v2, :cond_4

    invoke-static {v3}, Lcom/android/camera2/g;->t(Lcom/android/camera2/f;)I

    move-result p1

    invoke-virtual {p0, p1}, Lp6/g;->K(I)V
...
.method public declared-synchronized O(II)Lcom/android/camera2/f;
    .locals 0

    monitor-enter p0

    :try_start_0
    invoke-virtual {p0, p1, p2}, Lp6/g;->L(II)I
...
.method public declared-synchronized Q(I)I
    .locals 1
...
.method public declared-synchronized a0()Lcom/android/camera2/f;
    .locals 1
...
.method public declared-synchronized c0()Lcom/android/camera2/f;
    .locals 1
...
.method public declared-synchronized g0(I)Z
    .locals 0
...
.method public declared-synchronized l0(II)Lcom/android/camera2/f;
    .locals 1
