...
.method public static D1(Lla/l;)Lpb/b0;
    ...
    invoke-virtual {v0, p0}, Lpb/b0;->p(Lla/l;)V
...
.method public A1(Lla/l;)V
    ...
    invoke-virtual {p0, v2}, Lpb/b0;->q0(Ljava/lang/String;)V

    goto :goto_0

    :cond_3
    invoke-virtual {p0}, Lpb/b0;->m0()V
...
.method public final B1(Lla/l;Lla/p;)V
    ...
    invoke-virtual {p0, p1}, Lpb/b0;->h0(Z)V

    goto/16 :goto_0

    :pswitch_3
    invoke-virtual {p0, v1}, Lpb/b0;->h0(Z)V
    ...
    invoke-virtual {p0, p1}, Lpb/b0;->B0(Ljava/math/BigDecimal;)V
    ...
    invoke-virtual {p0, p1, p2}, Lpb/b0;->v0(D)V
    ...
    invoke-virtual {p0, p1}, Lpb/b0;->w0(F)V
    ...
    invoke-virtual {p0, p1, p2}, Lpb/b0;->y0(J)V

    goto :goto_0

    :cond_4
    invoke-virtual {p1}, Lla/l;->x()Ljava/math/BigInteger;

    move-result-object p1

    invoke-virtual {p0, p1}, Lpb/b0;->C0(Ljava/math/BigInteger;)V
    ...
    invoke-virtual {p0, p1}, Lpb/b0;->x0(I)V
    ...
    invoke-virtual {p1}, Lla/l;->e0()[C

    move-result-object p2

    invoke-virtual {p1}, Lla/l;->h0()I

    move-result v0

    invoke-virtual {p1}, Lla/l;->g0()I
    ...
    :cond_6
    invoke-virtual {p1}, Lla/l;->d0()Ljava/lang/String;
...
.method public C1(Lpb/b0;)Lpb/b0;
    ...
    invoke-virtual {p0, p1}, Lpb/b0;->p(Lla/l;)V
...
.method public F1(Lla/l;)Lla/l;
    ...
    invoke-virtual {p1}, Lla/l;->j0()Lla/j;
...
.method public I1(Lla/l;Lxa/g;)Lpb/b0;
    ...
    invoke-virtual {p1, v0}, Lla/l;->B0(Lla/p;)Z
...
.method public N1(Lla/i;)V
    ...
    :cond_8
    invoke-virtual {p1, v5}, Lla/i;->k0(Ljava/lang/Object;)V

    goto :goto_1

    :pswitch_1
    invoke-virtual {p1}, Lla/i;->t0()V

    goto :goto_1

    :pswitch_2
    invoke-virtual {p1, v2}, Lla/i;->h0(Z)V

    goto :goto_1

    :pswitch_3
    invoke-virtual {p1, v1}, Lla/i;->h0(Z)V
    ...
    invoke-virtual {p1, v5, v6}, Lla/i;->v0(D)V
    ...
    invoke-virtual {p1, v5}, Lla/i;->B0(Ljava/math/BigDecimal;)V
    ...
    invoke-virtual {p1, v5}, Lla/i;->w0(F)V
    ...
    invoke-virtual {p1, v5}, Lla/i;->A0(Ljava/lang/String;)V
    ...
    invoke-virtual {p1, v5}, Lla/i;->x0(I)V
    ...
    invoke-virtual {p1, v5}, Lla/i;->C0(Ljava/math/BigInteger;)V
    ...
    invoke-virtual {p1, v5, v6}, Lla/i;->y0(J)V
    ...
    invoke-virtual {p1, v5}, Lla/i;->D0(S)V
    ...
    invoke-virtual {p1, v5}, Lla/i;->r0(Lla/u;)V
    ...
    invoke-virtual {p1, v5}, Lla/i;->q0(Ljava/lang/String;)V

    goto/16 :goto_1

    :pswitch_8
    invoke-virtual {p1}, Lla/i;->m0()V
...
.method public o(Lla/l;)V
    ...
    invoke-virtual {p1}, Lla/l;->p()Lla/p;
    ...
    invoke-virtual {p0, v0, v1}, Lpb/b0;->v0(D)V
    ...
    invoke-virtual {p0, v0, v1}, Lpb/b0;->y0(J)V
    ...
    invoke-virtual {p0, p1}, Lpb/b0;->q0(Ljava/lang/String;)V
...
.method public p(Lla/l;)V
    ...
    invoke-virtual {p0, v0}, Lpb/b0;->q0(Ljava/lang/String;)V
...
.method public final z1(Lla/l;)V
    ...
    invoke-virtual {p1}, Lla/l;->k0()Ljava/lang/Object;
