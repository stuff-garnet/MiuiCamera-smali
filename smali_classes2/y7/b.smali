...
.field public s:Lcom/android/camera/i4;
...
.method public constructor <init>(Landroid/content/Context;Ly7/b$h;)V
    ...
    invoke-virtual {v1, v2}, Lcom/android/camera/d4;->o(Z)V
...
.method public static w(Landroid/content/Context;)Z
    ...
    invoke-static {v0}, Lcom/android/camera/c3;->Q0(Ljava/lang/String;)Ljava/lang/String;
...
.method public declared-synchronized A()V
    ...
    :cond_0
    iget-object v1, p0, Ly7/b;->s:Lcom/android/camera/i4;

    if-eqz v1, :cond_1

    invoke-virtual {v1}, Lcom/android/camera/i4;->v()V

    iput-object v0, p0, Ly7/b;->s:Lcom/android/camera/i4;
    :try_end_1
...
.method public final declared-synchronized o()V
    ...
    invoke-static {v1, v2}, Lcom/android/camera/o6;->q1(II)I
...
.method public final q()V
    ...
    invoke-static {v1, v2, v3, v4, v5}, Lcom/android/camera/r4;->q(Ljava/util/List;IIILcom/android/camera2/f;)V
    ...
    invoke-static {v1, v0, v3, v2, v4}, Lcom/android/camera/r4;->o(Ljava/util/List;IIILcom/android/camera2/f;)V
    ...
    iget v5, v1, Lcom/android/camera/d3;->b:I
    ...
    invoke-static {v0, v3, v2, v4, v5}, Lcom/android/camera/o6;->G1(ZILjava/util/List;D)Lcom/android/camera/d3;
    ...
    iget v0, v2, Lcom/android/camera/d3;->a:I
    ...
    invoke-virtual {p0, v1}, Ly7/b;->z(Lcom/android/camera/d3;)V

    iget v0, v1, Lcom/android/camera/d3;->a:I

    iput v0, p0, Ly7/b;->d:I

    iget v0, v1, Lcom/android/camera/d3;->b:I
...
.method public final u()V
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/camera/i4;-><init>(Landroid/content/Context;Z)V

    iput-object v0, p0, Ly7/b;->s:Lcom/android/camera/i4;

    const/4 p0, 0x0

    invoke-virtual {v0, p0}, Lcom/android/camera/i4;->l(I)V
...
.method public final x([B)V
    ...
    invoke-virtual {p0}, Ly7/b;->p()Lid/d0;
    ...
    invoke-static/range {v4 .. v13}, Lcom/android/camera/m3;->p([BJZLjava/lang/String;Lid/d0;IIILandroid/location/Location;)[B
...
.method public final y()V
    ...
    iget-object p0, p0, Ly7/b;->s:Lcom/android/camera/i4;

    if-eqz p0, :cond_0

    const/4 v0, 0x0

    invoke-virtual {p0, v0}, Lcom/android/camera/i4;->s(I)V

    :cond_0
    return-void
.end method

.method public final z(Lcom/android/camera/d3;)V
    .locals 3
