...
.method public static bridge synthetic a(Lgs/j0;Ljava/lang/String;[B)V
    .locals 0

    invoke-static {p0, p1, p2}, Lw5/c;->b(Lgs/j0;Ljava/lang/String;[B)V

    return-void
.end method

.method public static b(Lgs/j0;Ljava/lang/String;[B)V
    .locals 2

    const-class v0, Lgs/p1;
    ...
    check-cast v0, Lgs/p1;

    if-nez v0, :cond_0

    invoke-static {}, Lgs/p1;->E()Lgs/p1;
    ...
    :cond_0
    invoke-static {}, Lgs/p0;->n()Ljava/lang/String;
    ...
    invoke-static {p2}, Lgs/p0;->m([B)Lgs/p0;
    ...
    :cond_1
    invoke-static {}, Lgs/q0;->n()Ljava/lang/String;
    ...
    invoke-static {p2}, Lgs/q0;->m([B)Lgs/q0;
    ...
    invoke-static {v0, p0, p1}, Lgs/s0;->w(Lgs/s0;Ljava/lang/Class;Ljava/lang/String;)Lgs/c;
...
.method public static c(Landroid/media/MediaMetadataRetriever;Landroid/os/ParcelFileDescriptor;Ljava/lang/String;Lcom/android/camera/d3;[Landroid/graphics/Bitmap;)V
    .locals 2
    ...
    iget v1, p3, Lcom/android/camera/d3;->b:I
    ...
    invoke-direct {p3, v0, v1}, Lcom/android/camera/d3;-><init>(II)V
    ...
    iget p2, p3, Lcom/android/camera/d3;->a:I
    ...
    :cond_2
    iget p1, p3, Lcom/android/camera/d3;->a:I
...
.method public static d(Ljava/io/File;)Lgs/p1;
    .locals 1
    ...
    :try_start_1
    invoke-static {p0}, Lw5/c;->e(Lds/d;)Lgs/p1;
...
.method public static e(Lds/d;)Lgs/p1;
    .locals 10
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public static f(Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0, v0}, Lcom/android/camera/o6;->w5(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v4}, Lw5/c;->d(Ljava/io/File;)Lgs/p1;
    ...
    invoke-static {v0, v4, v5}, Lgs/s0;->x(Lgs/s0;Ljava/lang/Class;[Ljava/lang/String;)Lgs/c;
...
.method public static g(Ljava/lang/String;Ljava/util/List;J)V
    ...
    :cond_1
    :try_start_0
    new-instance p0, Ljs/e;

    invoke-direct {p0}, Ljs/e;-><init>()V

    new-instance p3, Lw5/c$a;

    invoke-direct {p3, p1}, Lw5/c$a;-><init>(Ljava/util/List;)V

    invoke-virtual {p0, p2, p3}, Ljs/e;->c(Ljava/io/File;Ljs/c;)V
    :try_end_0
