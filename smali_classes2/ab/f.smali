...
.method public n0(Lxa/g;Lxa/c;Lab/e;)V
    ...
    invoke-virtual {v1}, Lfb/s;->s()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v1}, Lfb/s;->I()Lxa/j;
...
.method public o0(Lxa/g;Lxa/c;Lab/e;)V
    ...
    invoke-virtual {v1}, Lfb/s;->Q()Z

    move-result v2

    if-eqz v2, :cond_8

    invoke-virtual {v1}, Lfb/s;->K()Lfb/i;
    ...
    :cond_8
    invoke-virtual {v1}, Lfb/s;->N()Z

    move-result v2

    if-eqz v2, :cond_9

    invoke-virtual {v1}, Lfb/s;->C()Lfb/f;
    ...
    :cond_9
    invoke-virtual {v1}, Lfb/s;->D()Lfb/i;
    ...
    :cond_11
    invoke-virtual {v1}, Lfb/s;->x()[Ljava/lang/Class;
...
.method public u0(Lxa/g;Lxa/j;Lxa/c;)Lxa/k;
    ...
    invoke-static {v2, v1, v3}, Lpb/y;->Y(Lza/i;Lfb/h;Lxa/y;)Lpb/y;
...
.method public x0(Lxa/g;Lxa/c;Lfb/s;Lxa/j;)Lab/v;
    ...
    invoke-virtual {p3}, Lfb/s;->G()Lfb/h;
    ...
    :cond_3
    invoke-virtual {p3}, Lfb/s;->t()Lxa/b$a;
    ...
    :cond_4
    invoke-virtual {p3}, Lfb/s;->r()Lfb/z;
...
.method public y0(Lxa/g;Lxa/c;Lfb/s;)Lab/v;
    ...
    invoke-virtual {p3}, Lfb/s;->D()Lfb/i;
...
.method public z0(Lxa/g;Lxa/c;Lab/e;Ljava/util/List;Ljava/util/Set;)Ljava/util/List;
    ...
    invoke-virtual {v1}, Lfb/s;->J()Ljava/lang/Class;
