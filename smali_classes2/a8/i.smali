...
.method public B(Landroid/net/Uri;Ljava/lang/String;Landroid/content/ContentValues;Z)Landroid/net/Uri;
    ...
    invoke-virtual {v0, p1, p0}, La8/d0;->g0(Landroid/content/Context;La8/u;)V

    invoke-virtual {v0}, La8/d0;->J()V
...
.method public final D(Lid/z;Landroid/hardware/camera2/CaptureResult;)V
    .locals 9
    ...
    invoke-virtual {p1}, Lid/a0;->s0()Lid/d0;
    ...
    invoke-virtual {v0, v2}, Lid/d0;->C(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p1}, Lid/d0;->z(Ljava/lang/String;)V

    :cond_b
    invoke-virtual {p0, p2, v0}, La8/i;->g0(Landroid/hardware/camera2/CaptureResult;Lid/d0;)V
...
.method public G()[B
    ...
    iget-object p0, p0, La8/i;->v:Lid/z;
...
.method public final H()V
    ...
    invoke-virtual {v1, p0}, Lcom/android/camera/l3;->b(Z)I
...
.method public final I(Lid/z;)V
    ...
    invoke-virtual {v0, p1}, La8/a$a;->w(Lid/z;)La8/a$a;

    invoke-static {p1}, La8/a;->a(Lid/z;)I

    move-result v1

    invoke-virtual {v0, v1}, La8/a$a;->x(I)La8/a$a;

    invoke-static {p1}, La8/a;->e(Lid/z;)Z
...
.method public final K(Lid/z;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;)V
    .locals 1
    ...
    invoke-virtual {p0, p1, p2, p3, v0}, La8/i;->L(Lid/z;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)V

    return-void
.end method

.method public final L(Lid/z;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)V
    .locals 1
    .param p2    # Landroid/hardware/camera2/CaptureResult;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    invoke-virtual {p0, p1, p2, p3}, La8/i;->N(Lid/z;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;)V

    goto :goto_0

    :cond_0
    invoke-virtual {p0, p1}, La8/i;->J(Lid/z;)V
    ...
    invoke-virtual {p0, p1}, La8/i;->I(Lid/z;)V
    ...
    :pswitch_5
    invoke-virtual {p0, p1}, La8/i;->M(Lid/z;)V

    goto :goto_0

    :pswitch_6
    invoke-virtual {p0, p1}, La8/i;->X(Lid/z;)V
    ...
    :pswitch_8
    invoke-virtual {p0, p1}, La8/i;->Y(Lid/z;)V
...
.method public N(Lid/z;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;)V
    .locals 12
    ...
    invoke-virtual {v5}, Lid/a0;->B0()Ljava/lang/String;
    ...
    invoke-static {v4}, Lcom/android/camera/o6;->g1(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    :goto_1
    invoke-virtual {v3}, Lid/a0;->x0()Landroid/util/Size;

    move-result-object v5

    if-nez v5, :cond_3

    invoke-virtual {v3}, Lid/a0;->r0()Landroid/util/Size;
    ...
    invoke-static {v2, v1}, Ldd/e;->c(Ljava/lang/Object;I)V
...
.method public final X(Lid/z;)V
    ...
    invoke-virtual {v0, p0}, La8/a;->q(La8/u;)V
    ...
    invoke-virtual {p0, p1, v1, v0}, La8/i;->i0(Lid/z;II)V

    return-void
.end method

.method public final Y(Lid/z;)V
    .locals 2
...
.method public final a0()V
    ...
    iput-object v0, p0, La8/i;->v:Lid/z;
...
.method public b(Ljava/util/function/Consumer;)V
    ...
    invoke-interface {p0}, La8/i$c;->S3()Lcom/android/camera/ThumbnailUpdater;
...
.method public final b0()V
    ...
    invoke-interface {v0}, La8/i$c;->j4()V
...
.method public d()V
    ...
    invoke-interface {p0}, La8/i$c;->d()V
...
.method public d0()V
    ...
    iget-object v0, p0, La8/i;->v:Lid/z;
    ...
    iget-object v5, p0, La8/i;->v:Lid/z;

    invoke-virtual {v5}, Lid/z;->y()[B

    move-result-object v5

    invoke-static {v5}, Lxb/d;->u([B)I
    ...
    iget-object v7, p0, La8/i;->v:Lid/z;

    invoke-virtual {v7}, Lid/z;->y()[B
    ...
    invoke-virtual {v6, v1}, La8/a$a;->r(Lid/d0;)La8/a$a;
...
.method public varargs e([Lf2/j;)V
    .locals 3
...
.method public final f0(Lid/z;Landroid/hardware/camera2/CaptureResult;)V
    .locals 0
    ...
    invoke-virtual {p0, p2}, Lid/d0;->C(Ljava/lang/String;)V
...
.method public final g0(Landroid/hardware/camera2/CaptureResult;Lid/d0;)V
    .locals 0
    ...
    invoke-virtual {p2}, Lid/d0;->i()Ljava/lang/String;
    ...
    invoke-virtual {p2, p1}, Lid/d0;->e0(Ljava/lang/String;)V
...
.method public final i0(Lid/z;II)V
    .locals 7
    ...
    iput-object p1, p0, La8/i;->v:Lid/z;

    int-to-double v3, p2

    invoke-virtual {v1}, Lid/a0;->w0()Landroid/util/Size;
    ...
    :cond_1
    invoke-interface {p0}, La8/i$c;->i()I
    ...
    invoke-interface {p1, p0}, Lj7/f1;->t9(Landroid/graphics/Bitmap;)V
...
.method public j(Landroid/net/Uri;ZLjava/lang/String;IZ)V
    ...
    invoke-interface/range {v1 .. v6}, La8/i$c;->d3(Landroid/net/Uri;ZLjava/lang/String;IZ)V
...
.method public k(Lcom/android/camera/v5;Z)V
    .locals 4
    ...
    invoke-interface {p0}, La8/i$c;->j1()V
...
.method public final k0(Z)V
    ...
    invoke-interface {p0}, La8/i$c;->c2()Z
...
.method public m(Lid/z;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)Z
    .locals 4
    .param p2    # Landroid/hardware/camera2/CaptureResult;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    invoke-virtual {p0, p1, p2}, La8/i;->f0(Lid/z;Landroid/hardware/camera2/CaptureResult;)V

    monitor-enter p0

    :try_start_0
    invoke-virtual {p1}, Lid/z;->z()Ljava/lang/String;
    ...
    invoke-virtual {p0, p1, p2, p2}, La8/i;->K(Lid/z;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;)V
    ...
    invoke-virtual {p0, p1, p2}, La8/i;->D(Lid/z;Landroid/hardware/camera2/CaptureResult;)V

    invoke-virtual {p0, p1, p2, p3, p4}, La8/i;->L(Lid/z;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)V
...
.method public n(Ljava/lang/Object;Ljava/lang/String;J)V
    ...
    invoke-virtual {p1, p2, p3, p4}, Lid/z;->c(Ljava/lang/String;J)V

    invoke-virtual {p1}, Lid/z;->a0()Z
    ...
    :cond_2
    invoke-virtual {p1}, Lid/z;->i0()Z

    move-result p2

    if-eqz p2, :cond_3

    invoke-virtual {p0, p1}, La8/i;->W(Lid/z;)V
...
.method public r(Ljava/lang/String;Landroid/net/Uri;II)Landroid/net/Uri;
    ...
    invoke-virtual {p1, p2, p0}, La8/c;->g0(Landroid/content/Context;La8/u;)V

    invoke-virtual {p1}, La8/c;->J()V
...
.method public s(Landroid/media/Image;Landroid/hardware/camera2/CaptureResult;Lid/z;La8/e$a;)V
    .locals 8
    ...
    invoke-direct/range {v2 .. v7}, La8/e;-><init>(Landroid/media/Image;Landroid/hardware/camera2/CaptureResult;Lid/z;La8/e$a;Landroid/os/Handler;)V
...
.method public t(La8/h$a;Landroid/hardware/camera2/CaptureResult;)V
    ...
    invoke-static {v0, v1}, Ldd/e;->c(Ljava/lang/Object;I)V

    invoke-virtual {p1}, La8/a$a;->f()Lid/d0;
...
.method public final w(La8/t;Z)V
    ...
    invoke-interface {p1, v0, p0}, La8/t;->g0(Landroid/content/Context;La8/u;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
