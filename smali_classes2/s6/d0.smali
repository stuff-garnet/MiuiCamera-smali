...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Ls6/d0;->ta:Ls6/l;
    ...
    iput-object v0, p0, Ls6/d0;->ua:Lx0/e1;

    const/4 v0, 0x0

    iput v0, p0, Ls6/d0;->va:I

    return-void
.end method

.method public static synthetic Cr(Ld6/j6$f;Ljava/util/List;)V
    .locals 0

    invoke-static {p0, p1}, Ls6/d0;->Jr(Ld6/j6$f;Ljava/util/List;)V

    return-void
.end method

.method public static synthetic Dr(Lj7/a0;)V
    .locals 0

    invoke-static {p0}, Ls6/d0;->Kr(Lj7/a0;)V
...
.method public static synthetic Kr(Lj7/a0;)V
    .locals 1

    const/4 v0, 0x2

    invoke-interface {p0, v0}, Lj7/a0;->a1(I)V
...
# virtual methods
.method public Er(Landroid/content/Intent;)V
    .locals 3
    ...
    invoke-virtual {p0, p1}, Ls6/d0;->Hr(Landroid/net/Uri;)V

    goto :goto_0

    :cond_0
    iget-object p1, p0, Ls6/d0;->ua:Lx0/e1;

    invoke-virtual {p1}, Lx0/e1;->k()I

    move-result p1

    iput p1, p0, Ls6/d0;->va:I

    invoke-virtual {p0, p1}, Ls6/d0;->Mr(I)V

    :cond_1
    :goto_0
    iget-object p0, p0, Ls6/d0;->ua:Lx0/e1;
...
.method public Fr()V
    ...
    iget-object p0, p0, Ls6/d0;->ta:Ls6/l;
...
.method public final Gr(Ld6/j6$f;)Ld6/j6$f;
    .locals 0

    new-instance p0, Ls6/c0;

    invoke-direct {p0, p1}, Ls6/c0;-><init>(Ld6/j6$f;)V

    return-object p0
.end method

.method public final Hr(Landroid/net/Uri;)V
    .locals 6

    iget-object v0, p0, Ls6/d0;->ua:Lx0/e1;
    ...
    invoke-virtual {p0, v2}, Ls6/d0;->Pr(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v1}, Ls6/d0;->Nr(I)V
    ...
    iget-object v2, p0, Ls6/d0;->ua:Lx0/e1;
    ...
    invoke-virtual {p0, p1}, Ls6/d0;->Nr(I)V
    ...
    invoke-virtual {p0, p1}, Ls6/d0;->Or(Ljava/lang/String;)V

    goto :goto_4

    :cond_3
    iput v3, p0, Ls6/d0;->va:I
...
.method public Ir()V
    ...
    iget-object v1, p0, Ls6/d0;->ta:Ls6/l;
...
.method public Kl(II)V
    ...
    iget-object v0, p0, Ls6/d0;->ta:Ls6/l;
    ...
    invoke-static {p1, p0}, Lcom/android/camera/c3;->j0(ILcom/android/camera2/f;)[F
    ...
    invoke-direct {v0, v1, p0}, Lfk/j;-><init>(FF)V

    invoke-interface {p2, p1, v0}, Lcom/android/camera/ui/h1;->g1(Lek/e;Lfk/d;)V
    ...
    invoke-interface {p2, p0}, Lcom/android/camera/ui/h1;->y1(Lek/e;)V
    ...
    invoke-interface {p2, p0}, Lcom/android/camera/ui/h1;->T0(Lek/e;)Lkk/s;

    :cond_3
    return-void
.end method

.method public final Lr(Lx0/e1;)V
    .locals 4
...
.method public final Or(Ljava/lang/String;)V
    ...
    invoke-static {p1, p0}, Lz7/a;->X1(Ljava/lang/String;Ljava/util/Map;)V
...
.method public Wm(Ld6/j6$f;)V
    ...
    invoke-virtual {p0, p1}, Ls6/d0;->Gr(Ld6/j6$f;)Ld6/j6$f;
...
.method public i9(II)V
    ...
    invoke-virtual {p0, p2}, Ls6/d0;->Lr(Lx0/e1;)V
...
.method public ir()V
    ...
    invoke-virtual {p0, v0}, Ls6/d0;->Lr(Lx0/e1;)V

    goto :goto_0

    :cond_0
    invoke-super {p0}, Ld6/r7;->ir()V
...
.method public onDestroy()V
    ...
    invoke-interface {v0, p0}, Lcom/android/camera/ui/h1;->E1(Lek/e;)V
