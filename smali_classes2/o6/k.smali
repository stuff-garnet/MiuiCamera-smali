...
.method public declared-synchronized a(Lo6/l;)Lo6/l;
    ...
    invoke-virtual {v3}, Lcom/android/camera/a3;->Y()Lcom/android/camera/o5$a;

    move-result-object v4

    if-eqz v4, :cond_4

    invoke-virtual {v3}, Lcom/android/camera/a3;->f0()Z

    move-result v4

    if-eqz v4, :cond_3

    invoke-virtual {v3, v2}, Lcom/android/camera/a3;->z0(Landroid/graphics/Rect;)V
    ...
    invoke-static {v4}, Lcom/android/camera/o6;->W0(Landroid/app/Activity;)I
    ...
    invoke-virtual {v3, v4}, Lcom/android/camera/a3;->z0(Landroid/graphics/Rect;)V
    ...
    invoke-interface {v4, v1, v2, v6}, Le6/l;->G2(Landroid/graphics/Rect;Landroid/graphics/Rect;I)V
    ...
    invoke-interface {v2, v1, v4}, Le6/l;->ga(Landroid/graphics/Rect;I)V
    ...
    invoke-interface {v3}, Lj7/l;->af()Li0/e;
    ...
    invoke-interface {v2, v0}, Lj7/o1;->p8(F)V
