...
.method public A0()Z
    ...
    invoke-virtual {p0, v0}, Lfb/b0;->a0(Lfb/b0$k;)Z
...
.method public C0(Ljava/util/Collection;)Ljava/util/Collection;
    ...
    invoke-virtual {p0, p1, v0, v1}, Lfb/b0;->c0(Ljava/util/Collection;Ljava/util/Map;Lfb/b0$k;)V
...
.method public E0()Ljava/util/Set;
    ...
    invoke-virtual {p0, v1, v0}, Lfb/b0;->g0(Lfb/b0$k;Ljava/util/Set;)Ljava/util/Set;
...
.method public I()Lxa/j;
    ...
    invoke-virtual {p0}, Lfb/b0;->D()Lfb/i;

    move-result-object v0

    if-nez v0, :cond_1

    invoke-virtual {p0}, Lfb/b0;->C()Lfb/f;
    ...
    :cond_2
    invoke-virtual {p0}, Lfb/b0;->z()Lfb/l;

    move-result-object v0

    if-nez v0, :cond_4

    invoke-virtual {p0}, Lfb/b0;->K()Lfb/i;
...
.method public I0(Z)V
    ...
    invoke-virtual {p0, v0, p1}, Lfb/b0;->b0(Lfb/b0$k;Lfb/p;)Lfb/b0$k;
...
.method public J()Ljava/lang/Class;
    ...
    invoke-virtual {p0}, Lfb/b0;->I()Lxa/j;
...
.method public bridge synthetic U(Lxa/y;)Lfb/s;
    .locals 0
...
.method public bridge synthetic W(Ljava/lang/String;)Lfb/s;
    .locals 0
...
.method public final Z(Lfb/b0$k;)Z
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public final a0(Lfb/b0$k;)Z
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public final b0(Lfb/b0$k;Lfb/p;)Lfb/b0$k;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-virtual {p0, v1, p2}, Lfb/b0;->b0(Lfb/b0$k;Lfb/p;)Lfb/b0$k;
...
.method public final c0(Ljava/util/Collection;Ljava/util/Map;Lfb/b0$k;)V
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final g0(Lfb/b0$k;Ljava/util/Set;)Ljava/util/Set;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public getMetadata()Lxa/x;
    ...
    invoke-virtual {p0}, Lfb/b0;->h0()Ljava/lang/Integer;

    move-result-object v2

    invoke-virtual {p0}, Lfb/b0;->d0()Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, Lfb/b0;->m0(Lxa/x;)Lxa/x;
...
.method public k()Lxa/y;
    ...
    invoke-virtual {p0}, Lfb/b0;->H()Lfb/h;
...
.method public m0(Lxa/x;)Lxa/x;
    ...
    :cond_3
    invoke-virtual {p0}, Lfb/b0;->J()Ljava/lang/Class;
...
.method public z0()Z
    ...
    invoke-virtual {p0, v0}, Lfb/b0;->Z(Lfb/b0$k;)Z
