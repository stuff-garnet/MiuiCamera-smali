...
.method public constructor <init>(Lgk/d;)V
    ...
    iput v0, p0, Lgk/f;->c:I

    iput v0, p0, Lgk/f;->d:I
...
.method public b()Landroid/opengl/EGLSurface;
    ...
    iget-object p0, p0, Lgk/f;->b:Landroid/opengl/EGLSurface;
...
.method public d()I
    ...
    iget-object v0, p0, Lgk/f;->b:Landroid/opengl/EGLSurface;

    const/16 v1, 0x3056

    invoke-virtual {p0, v0, v1}, Lgk/f;->i(Landroid/opengl/EGLSurface;I)I
...
.method public f(Landroid/opengl/EGLSurface;)Z
    ...
    invoke-virtual {p0}, Lgk/d;->d()Landroid/opengl/EGLContext;
...
.method public g()Z
    ...
    invoke-virtual {p0, v0}, Lgk/f;->f(Landroid/opengl/EGLSurface;)Z
    ...
    invoke-virtual {p0, v0}, Lgk/f;->h(Landroid/opengl/EGLSurface;)Z
...
.method public i(Landroid/opengl/EGLSurface;I)I
    ...
    iget-object v2, p0, Lgk/f;->a:Lgk/d;

    invoke-virtual {v2}, Lgk/d;->e()Landroid/opengl/EGLDisplay;
...
.method public j()Z
    ...
    :cond_0
    invoke-virtual {v0, v1}, Lgk/d;->b(Landroid/opengl/EGLSurface;)Z

    move-result v0

    const/4 v1, 0x0

    iput-object v1, p0, Lgk/f;->a:Lgk/d;

    iput-object v1, p0, Lgk/f;->b:Landroid/opengl/EGLSurface;

    const/4 v1, -0x1

    iput v1, p0, Lgk/f;->c:I

    iput v1, p0, Lgk/f;->d:I
...
.method public k()Z
    ...
    invoke-virtual {p0, v0}, Lgk/f;->l(Landroid/opengl/EGLSurface;)Z
