...
# direct methods
.method public constructor <init>(Lgk/d;Landroid/graphics/SurfaceTexture;[I)V
    .locals 0
    .param p1    # Lgk/d;
    ...
    .line 5
    invoke-direct {p0, p1}, Lgk/f;-><init>(Lgk/d;)V

    const/4 p1, 0x0

    .line 6
    iput-boolean p1, p0, Lgk/g;->f:Z
    ...
    iput-object p1, p0, Lgk/g;->g:Ljava/lang/Object;

    .line 8
    invoke-virtual {p0, p2, p3}, Lgk/g;->p(Ljava/lang/Object;[I)V

    return-void
.end method

.method public constructor <init>(Lgk/d;Landroid/view/Surface;[I)V
    .locals 0
    .param p1    # Lgk/d;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public g()Z
    ...
    iget-object v0, p0, Lgk/g;->g:Ljava/lang/Object;
...
.method public j()Z
    ...
    iput-boolean v2, p0, Lgk/g;->f:Z

    invoke-super {p0}, Lgk/f;->j()Z
...
.method public final m(Landroid/graphics/SurfaceTexture;[I)Landroid/opengl/EGLSurface;
    ...
    invoke-virtual {p0, p1, p2}, Lgk/g;->o(Ljava/lang/Object;[I)Landroid/opengl/EGLSurface;
...
.method public final o(Ljava/lang/Object;[I)Landroid/opengl/EGLSurface;
    ...
    :cond_1
    iget-object v1, p0, Lgk/f;->a:Lgk/d;

    invoke-virtual {v1}, Lgk/d;->e()Landroid/opengl/EGLDisplay;

    move-result-object v1

    iget-object v3, p0, Lgk/f;->a:Lgk/d;

    invoke-virtual {v3}, Lgk/d;->c()Landroid/opengl/EGLConfig;
    ...
    invoke-virtual {p0}, Lgk/d;->e()Landroid/opengl/EGLDisplay;
...
.method public final p(Ljava/lang/Object;[I)V
    ...
    invoke-virtual {p0, p1, p2}, Lgk/g;->n(Landroid/view/Surface;[I)Landroid/opengl/EGLSurface;

    move-result-object p1

    iput-object p1, p0, Lgk/f;->b:Landroid/opengl/EGLSurface;
    ...
    invoke-virtual {p0, p1, p2}, Lgk/g;->m(Landroid/graphics/SurfaceTexture;[I)Landroid/opengl/EGLSurface;
...
.method public q()Z
    ...
    iget-object v1, p0, Lgk/f;->b:Landroid/opengl/EGLSurface;

    invoke-virtual {p0, v1}, Lgk/f;->f(Landroid/opengl/EGLSurface;)Z
    ...
    invoke-virtual {p0, v1}, Lgk/f;->h(Landroid/opengl/EGLSurface;)Z
