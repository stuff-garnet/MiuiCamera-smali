...
# static fields
.field public static final x:Ljava/lang/String; = "ConfigInfoThumUtil"
...
.method public constructor <init>()V
    ...
    iput-object v1, p0, Lah/b;->a:[F

    new-array v1, v0, [F

    fill-array-data v1, :array_1

    iput-object v1, p0, Lah/b;->b:[F

    new-array v1, v0, [F

    fill-array-data v1, :array_2

    iput-object v1, p0, Lah/b;->c:[F

    new-array v1, v0, [F

    fill-array-data v1, :array_3

    iput-object v1, p0, Lah/b;->d:[F

    new-array v1, v0, [F

    fill-array-data v1, :array_4

    iput-object v1, p0, Lah/b;->e:[F

    new-array v1, v0, [F

    fill-array-data v1, :array_5

    iput-object v1, p0, Lah/b;->f:[F

    new-array v1, v0, [F

    fill-array-data v1, :array_6

    iput-object v1, p0, Lah/b;->g:[F

    new-array v1, v0, [F

    fill-array-data v1, :array_7

    iput-object v1, p0, Lah/b;->h:[F

    new-array v1, v0, [F

    fill-array-data v1, :array_8

    iput-object v1, p0, Lah/b;->i:[F

    new-array v1, v0, [F

    fill-array-data v1, :array_9

    iput-object v1, p0, Lah/b;->j:[F

    new-array v1, v0, [F

    fill-array-data v1, :array_a

    iput-object v1, p0, Lah/b;->k:[F

    new-array v1, v0, [F

    fill-array-data v1, :array_b

    iput-object v1, p0, Lah/b;->l:[F

    new-array v1, v0, [F

    fill-array-data v1, :array_c

    iput-object v1, p0, Lah/b;->m:[F

    new-array v1, v0, [F

    fill-array-data v1, :array_d

    iput-object v1, p0, Lah/b;->n:[F

    new-array v1, v0, [F

    fill-array-data v1, :array_e

    iput-object v1, p0, Lah/b;->o:[F

    new-array v1, v0, [F

    fill-array-data v1, :array_f

    iput-object v1, p0, Lah/b;->p:[F

    const-string v1, "Hat"

    iput-object v1, p0, Lah/b;->q:Ljava/lang/String;

    const-string v1, "Hea"

    iput-object v1, p0, Lah/b;->r:Ljava/lang/String;

    new-array v0, v0, [F

    iput-object v0, p0, Lah/b;->s:[F

    const/4 v0, 0x0

    iput-boolean v0, p0, Lah/b;->t:Z

    iput-boolean v0, p0, Lah/b;->u:Z
...
.method public a(Lcom/arcsoft/avatar2/AvatarEngine;Lcom/arcsoft/avatar2/AvatarConfig$ASAvatarConfigInfo;I[F)V
    ...
    iput-boolean v3, v0, Lah/b;->t:Z

    iput-boolean v3, v0, Lah/b;->u:Z
    ...
    iget-object v4, v0, Lah/b;->p:[F

    iput-object v4, v0, Lah/b;->s:[F

    goto/16 :goto_1

    :pswitch_0
    iget-object v4, v0, Lah/b;->f:[F

    iput-object v4, v0, Lah/b;->s:[F

    iput-boolean v7, v0, Lah/b;->u:Z

    goto :goto_1

    :pswitch_1
    iget-object v4, v0, Lah/b;->g:[F
    ...
    :cond_5
    :pswitch_5
    iget-object v4, v0, Lah/b;->m:[F

    iput-object v4, v0, Lah/b;->s:[F

    iput-boolean v7, v0, Lah/b;->t:Z
    ...
    iget-object v4, v0, Lah/b;->n:[F

    goto :goto_0

    :cond_8
    iget-object v4, v0, Lah/b;->o:[F
    ...
    :cond_9
    iget-object v4, v0, Lah/b;->a:[F

    iput-object v4, v0, Lah/b;->s:[F

    :goto_1
    iget-boolean v4, v0, Lah/b;->t:Z

    if-eqz v4, :cond_b

    iget-object v4, v0, Lah/b;->v:Ljava/util/ArrayList;
    ...
    iput-object v4, v0, Lah/b;->v:Ljava/util/ArrayList;
    ...
    :cond_b
    iget-boolean v4, v0, Lah/b;->u:Z

    if-eqz v4, :cond_d

    iget-object v4, v0, Lah/b;->w:Ljava/util/ArrayList;
    ...
    iput-object v2, v0, Lah/b;->w:Ljava/util/ArrayList;

    :cond_c
    iget-object v2, v0, Lah/b;->w:Ljava/util/ArrayList;
...
.method public b(Lcom/arcsoft/avatar2/AvatarEngine;Lcom/arcsoft/avatar2/AvatarConfig$ASAvatarConfigValue;)V
    ...
    :cond_1
    iget-object v4, p0, Lah/b;->v:Ljava/util/ArrayList;
    ...
    :goto_1
    iget-object p0, p0, Lah/b;->w:Ljava/util/ArrayList;
