...
.method public constructor <init>(Landroid/media/MediaFormat;Landroid/opengl/EGLContext;JJLjava/util/Queue;)V
    ...
    invoke-direct/range {v0 .. v6}, Ltd/b;-><init>(Landroid/media/MediaFormat;JJLjava/util/Queue;)V

    const/high16 p1, 0x7f800000    # Float.POSITIVE_INFINITY

    iput p1, p0, Ltd/c;->G:F

    iget-object p1, p0, Ltd/b;->b:Landroid/media/MediaFormat;
    ...
    iput-object p2, p0, Ltd/c;->E:Landroid/opengl/EGLContext;
    ...
    iput-object p1, p0, Ltd/b;->l:Landroid/media/MediaCodec;
    :try_end_0
    ...
    iput-object p1, p0, Ltd/c;->C:Ljava/util/concurrent/atomic/AtomicBoolean;

    const/4 p1, 0x1

    iput-boolean p1, p0, Ltd/b;->o:Z
...
.method public declared-synchronized c()V
    ...
    :try_start_0
    iget-boolean v0, p0, Ltd/b;->o:Z

    if-eqz v0, :cond_0

    invoke-super {p0}, Ltd/b;->c()V
...
.method public declared-synchronized d()V
    ...
    iget-object v1, p0, Ltd/b;->b:Landroid/media/MediaFormat;
    ...
    iput-object v0, p0, Ltd/c;->F:Landroid/view/Surface;
    :try_end_1
    ...
    iget-object v6, p0, Ltd/c;->E:Landroid/opengl/EGLContext;

    iget-object v7, p0, Ltd/c;->F:Landroid/view/Surface;

    iget v8, p0, Ltd/c;->A:I

    iget v9, p0, Ltd/c;->B:I

    const/4 v10, 0x1

    move-object v4, v0

    invoke-direct/range {v4 .. v10}, Lud/d;-><init>(Ljava/lang/String;Landroid/opengl/EGLContext;Landroid/view/Surface;IIZ)V

    iput-object v0, p0, Ltd/c;->D:Lud/d;

    iget v1, p0, Ltd/c;->G:F

    invoke-virtual {v0, v1}, Lud/d;->o(F)V

    iget-object v0, p0, Ltd/c;->D:Lud/d;

    invoke-virtual {v0}, Ljava/lang/Thread;->start()V

    iget-object v0, p0, Ltd/c;->D:Lud/d;

    invoke-virtual {v0}, Lud/d;->t()V

    iget-object v0, p0, Ltd/b;->l:Landroid/media/MediaCodec;

    new-instance v1, Landroid/os/Handler;

    iget-object v4, p0, Ltd/b;->i:Lvd/c;

    invoke-virtual {v4}, Lvd/c;->d()Landroid/os/Looper;
    ...
    iput-wide v0, p0, Ltd/c;->H:J

    iput-wide v0, p0, Ltd/c;->I:J

    invoke-super {p0}, Ltd/b;->d()V

    iput-boolean v3, p0, Ltd/b;->n:Z
...
.method public declared-synchronized e()V
    ...
    :cond_0
    iput-boolean v2, p0, Ltd/b;->n:Z

    invoke-virtual {p0}, Ltd/c;->q()V

    iget-object v0, p0, Ltd/c;->F:Landroid/view/Surface;
    ...
    :try_start_1
    iget-object v3, p0, Ltd/b;->g:Ljava/util/List;
...
.method public m(Z)V
    ...
    invoke-super {p0, p1}, Ltd/b;->m(Z)V
...
.method public n()V
    ...
    iget-object p0, p0, Ltd/c;->C:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public declared-synchronized o(Lud/d$b;)V
    .locals 3
    ...
    :cond_0
    iget-object v0, p0, Ltd/c;->C:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-virtual {v0}, Lud/d;->k()V

    :cond_1
    iget-object v0, p0, Ltd/c;->D:Lud/d;

    invoke-virtual {v0, p1}, Lud/d;->i(Lud/d$b;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
