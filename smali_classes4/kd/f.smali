...
# direct methods
.method public varargs constructor <init>(Ljava/lang/String;Lkd/a;Lkd/g;Z[Ljava/lang/String;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p1, p2}, Lkd/d;-><init>(Ljava/lang/String;Lkd/a;)V

    iput-boolean p4, p0, Lkd/f;->g:Z

    iput-object p5, p0, Lkd/f;->f:[Ljava/lang/String;

    new-instance p1, Ljd/o;

    invoke-direct {p1, p3}, Ljd/o;-><init>(Lkd/g;)V

    iput-object p1, p0, Lkd/f;->e:Landroid/hardware/camera2/CameraDevice$StateCallback;
...
.method public b()Lkd/b;
    ...
    invoke-virtual {v0, v1}, Ljd/b$b;->b(Ljava/lang/String;)Ljd/b$a;

    move-result-object v0

    iget-object v1, v0, Ljd/b$a;->e:Lcom/android/camera2/a;
    ...
    iget-object v1, v0, Ljd/b$a;->d:Lcom/android/camera2/f;
    ...
    iget-boolean v3, p0, Lkd/f;->g:Z

    invoke-virtual {v1, v3}, Lcom/android/camera2/a;->d(Z)V

    :cond_0
    iget-object p0, p0, Lkd/f;->e:Landroid/hardware/camera2/CameraDevice$StateCallback;
    ...
    invoke-direct {p0, v2}, Lkd/b;-><init>(Ljava/lang/Exception;)V
    ...
    iget-boolean v5, v1, Ljd/b$a;->a:Z
    ...
    iget-object v1, v1, Ljd/b$a;->g:Ljava/lang/String;
    ...
    iget-object v0, p0, Lkd/f;->f:[Ljava/lang/String;

    invoke-static {v0}, Ljd/g;->e([Ljava/lang/String;)V

    invoke-static {p0}, Ljd/g;->c(Lkd/d;)V
    ...
    :cond_4
    iget-boolean v5, v1, Ljd/b$a;->b:Z
    ...
    iget-object p0, p0, Lkd/d;->c:Ljava/lang/String;
    ...
    iget-object v5, p0, Lkd/d;->c:Ljava/lang/String;
    ...
    iget-object v6, p0, Lkd/d;->c:Ljava/lang/String;
    ...
    iget-object v1, v1, Ljd/b$b;->a:Landroid/hardware/camera2/CameraManager;

    iget-object v5, p0, Lkd/d;->c:Ljava/lang/String;

    iget-object v6, p0, Lkd/f;->e:Landroid/hardware/camera2/CameraDevice$StateCallback;
    ...
    invoke-virtual {v1, v5}, Ljd/b$b;->b(Ljava/lang/String;)Ljd/b$a;

    move-result-object v1

    iput-boolean v4, v1, Ljd/b$a;->a:Z
    ...
    invoke-direct {v1, v2}, Lkd/b;-><init>(Ljava/lang/Exception;)V
    :try_end_0
    ...
    iget-object v5, p0, Lkd/d;->a:Ljava/lang/String;
    ...
    iget-object v7, p0, Lkd/d;->c:Ljava/lang/String;
    ...
    invoke-direct {p0, v1}, Lkd/b;-><init>(Ljava/lang/Exception;)V
