...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lqe/s;->a:Landroid/media/MediaRecorder;

    return-void
.end method

.method public static synthetic u(Lqe/s;Lqe/i$b;Landroid/media/MediaRecorder;II)V
    .locals 0

    invoke-direct {p0, p1, p2, p3, p4}, Lqe/s;->x(Lqe/i$b;Landroid/media/MediaRecorder;II)V

    return-void
.end method

.method public static synthetic v(Lqe/s;Lqe/i$a;Landroid/media/MediaRecorder;II)V
    .locals 0

    invoke-direct {p0, p1, p2, p3, p4}, Lqe/s;->w(Lqe/i$a;Landroid/media/MediaRecorder;II)V

    return-void
.end method

.method private synthetic w(Lqe/i$a;Landroid/media/MediaRecorder;II)V
    .locals 0

    if-eqz p1, :cond_0

    invoke-interface {p1, p0, p3, p4}, Lqe/i$a;->a(Lqe/i;II)V

    :cond_0
    return-void
.end method

.method private synthetic x(Lqe/i$b;Landroid/media/MediaRecorder;II)V
    .locals 0

    if-eqz p1, :cond_0

    invoke-interface {p1, p0, p3, p4}, Lqe/i$b;->b(Lqe/i;II)V
...
.method public static z(Landroid/media/MediaRecorder;Lqe/j;)Landroid/media/MediaRecorder;
    .locals 4
    ...
    :cond_3
    invoke-virtual {p1}, Lqe/j;->L()Landroid/util/Pair;
    ...
    :cond_5
    invoke-virtual {p1}, Lqe/j;->R()Z

    move-result v0

    if-eqz v0, :cond_9

    invoke-virtual {p1}, Lqe/j;->x()I
    ...
    :cond_d
    invoke-virtual {p1}, Lqe/j;->E()Landroid/util/Pair;
    ...
    :cond_e
    invoke-virtual {p1}, Lqe/j;->D()Ljava/util/List;
    ...
    invoke-static {p0, v1}, Lqe/s;->y(Landroid/media/MediaRecorder;Ljava/lang/String;)V
    ...
    invoke-static {p0, p1}, Lqe/s;->y(Landroid/media/MediaRecorder;Ljava/lang/String;)V
...
.method public a()Landroid/media/MediaRecorder;
    ...
    iget-object p0, p0, Lqe/s;->a:Landroid/media/MediaRecorder;
...
.method public b(Lqe/j;)V
    ...
    invoke-static {p0, p1}, Lqe/s;->z(Landroid/media/MediaRecorder;Lqe/j;)Landroid/media/MediaRecorder;
...
.method public q(Lqe/i$a;)V
    ...
    iget-object v0, p0, Lqe/s;->a:Landroid/media/MediaRecorder;

    new-instance v1, Lqe/q;

    invoke-direct {v1, p0, p1}, Lqe/q;-><init>(Lqe/s;Lqe/i$a;)V
...
.method public s(Lqe/i$b;)V
    ...
    invoke-direct {v1, p0, p1}, Lqe/r;-><init>(Lqe/s;Lqe/i$b;)V
