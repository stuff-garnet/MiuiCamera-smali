...
.method public constructor <init>(Lrj/d;)V
    ...
    iput-object p1, p0, Lrj/d$a0;->a:Lrj/d;
...
.method public onCompleted()V
    ...
    iget-object v0, p0, Lrj/d$a0;->a:Lrj/d;
    ...
    invoke-static {v0}, Lrj/d;->q(Lrj/d;)Loi/a;
    ...
    :cond_1
    sget-object v0, Lrj/d;->F:Lcom/faceunity/core/avatar/model/Avatar;

    if-eqz v0, :cond_5

    iget-object v4, p0, Lrj/d$a0;->a:Lrj/d;

    invoke-static {v4}, Lrj/d;->x(Lrj/d;)Lui/b;
    ...
    :cond_2
    invoke-virtual {v5}, Lui/b;->m()Ljava/util/List;
    ...
    :cond_3
    invoke-virtual {v6}, Lui/b;->n()Ljava/util/HashMap;
    ...
    :cond_4
    invoke-virtual {v7}, Lui/b;->o()Ljava/util/ArrayList;

    move-result-object v1

    new-instance v7, Loi/a;

    invoke-direct {v7, v0}, Loi/a;-><init>(Lcom/faceunity/core/avatar/model/Avatar;)V

    invoke-virtual {v7, v5, v6, v1}, Loi/a;->b(Ljava/util/List;Ljava/util/HashMap;Ljava/util/ArrayList;)V

    invoke-static {v4, v7}, Lrj/d;->K(Lrj/d;Loi/a;)V
    ...
    :cond_7
    iget-object p0, p0, Lrj/d$a0;->a:Lrj/d;
    ...
    invoke-virtual {p0, v12}, Loi/a;->g(Lcom/faceunity/core/entity/FUAnimationBundleData;)V
