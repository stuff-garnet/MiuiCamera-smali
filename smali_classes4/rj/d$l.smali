...
.method public constructor <init>(Lrj/d;)V
    ...
    iput-object p1, p0, Lrj/d$l;->a:Lrj/d;
...
.method public a(Lsi/b;)V
    ...
    invoke-virtual {p1}, Lsi/b;->a()Lpi/e;
    ...
    new-instance v0, Lrj/d$l$a;

    invoke-direct {v0, p1}, Lrj/d$l$a;-><init>(Lsi/b;)V

    const-string v5, "KIT_EditorViewModel"

    invoke-static {v5, v0}, Lcom/faceunity/toolbox/utils/FULogger;->i(Ljava/lang/String;Lol/a;)V

    iget-object v0, p0, Lrj/d$l;->a:Lrj/d;

    invoke-static {v0}, Lrj/d;->u(Lrj/d;)Lui/a;
    ...
    :cond_0
    iget-object v5, p0, Lrj/d$l;->a:Lrj/d;

    invoke-static {v5}, Lrj/d;->F(Lrj/d;)Lcom/faceunity/core/avatar/model/Scene;
    ...
    :cond_1
    iget-object v1, p0, Lrj/d$l;->a:Lrj/d;

    invoke-static {v1}, Lrj/d;->w(Lrj/d;)Lcom/faceunity/core/avatar/model/Scene;
    ...
    :cond_2
    invoke-virtual {v0, v5, v1}, Lui/a;->c(Lcom/faceunity/core/avatar/model/Scene;Lcom/faceunity/core/avatar/model/Scene;)V
    ...
    :cond_3
    iget-object p0, p0, Lrj/d$l;->a:Lrj/d;

    invoke-static {p0}, Lrj/d;->w(Lrj/d;)Lcom/faceunity/core/avatar/model/Scene;
    ...
    :goto_0
    invoke-virtual {p1}, Lsi/b;->b()Ljava/lang/String;

    move-result-object p0

    invoke-virtual {v0, v4, p0}, Lui/a;->t(Lcom/faceunity/core/avatar/model/Scene;Ljava/lang/String;)V
    ...
    invoke-static {v5}, Lrj/d;->w(Lrj/d;)Lcom/faceunity/core/avatar/model/Scene;
    ...
    invoke-virtual {v0, v5, v6}, Lui/a;->q(Lcom/faceunity/core/avatar/model/Scene;Lpi/e;)V
    ...
    invoke-virtual {v6}, Lsi/a;->c()Lcom/faceunity/core/avatar/model/Avatar;

    move-result-object v6

    invoke-virtual {v0, v5, v6}, Lui/a;->p(Lcom/faceunity/core/avatar/model/Scene;Lcom/faceunity/core/avatar/model/Avatar;)V
    ...
    invoke-virtual {v0, v5, v6}, Lui/a;->s(Lcom/faceunity/core/avatar/model/Scene;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v5, v6, v7}, Lui/a;->r(Lcom/faceunity/core/avatar/model/Scene;Ljava/lang/String;Lpi/e;)V
    ...
    invoke-static {v0}, Lrj/d;->x(Lrj/d;)Lui/b;
    ...
    invoke-virtual {v0, v5}, Lui/b;->B(Ljava/lang/String;)Lpi/f;

    move-result-object v0

    iget-object v5, p0, Lrj/d$l;->a:Lrj/d;

    invoke-static {v5}, Lrj/d;->z(Lrj/d;)Lcom/faceunity/core/faceunity/FURenderKit;

    move-result-object v5

    iget-object v6, p0, Lrj/d$l;->a:Lrj/d;

    invoke-static {v6}, Lrj/d;->u(Lrj/d;)Lui/a;
    ...
    :goto_2
    invoke-virtual {v6, v0}, Lui/a;->b(F)Lcom/faceunity/core/entity/FURenderInputData;
    ...
    iget-object v3, p0, Lrj/d$l;->a:Lrj/d;
    ...
    invoke-static {v3}, Lrj/d;->E(Lrj/d;)Lcom/faceunity/core/media/photo/FUPhotoRecordHelper;
    ...
    :cond_13
    iget-object p1, p0, Lrj/d$l;->a:Lrj/d;

    invoke-static {p1}, Lrj/d;->A(Lrj/d;)Lcom/faceunity/core/faceunity/FUSceneKit;

    move-result-object p1

    iget-object p0, p0, Lrj/d$l;->a:Lrj/d;

    invoke-static {p0}, Lrj/d;->F(Lrj/d;)Lcom/faceunity/core/avatar/model/Scene;
