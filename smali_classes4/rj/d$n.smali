...
.method public constructor <init>(Lrj/d;)V
    ...
    iput-object p1, p0, Lrj/d$n;->a:Lrj/d;
...
.method public onRecordSuccess(Landroid/graphics/Bitmap;Ljava/lang/String;)V
    ...
    invoke-static/range {v0 .. v5}, Lcm/c0;->U4(Ljava/lang/CharSequence;[Ljava/lang/String;ZIILjava/lang/Object;)Ljava/util/List;
    ...
    iget-object p2, p0, Lrj/d$n;->a:Lrj/d;

    invoke-static {p2}, Lrj/d;->x(Lrj/d;)Lui/b;
    ...
    invoke-virtual {p2, v0}, Lui/b;->x(Ljava/lang/String;)Lpi/e;

    move-result-object p2

    if-eqz p2, :cond_2

    iget-object p0, p0, Lrj/d$n;->a:Lrj/d;
