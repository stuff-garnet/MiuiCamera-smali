...
.method public static a(Landroid/content/Context;Lfk/b;Ljava/lang/String;I)I
    .locals 9
    ...
    invoke-static {v2}, Lgk/h;->b(Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0, v2}, Lgk/h;->c(Landroid/content/Context;Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    iget-boolean p1, p1, Lfk/b;->i:Z

    if-eqz p1, :cond_2

    invoke-static {p2}, Lgk/h;->b(Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    :cond_2
    invoke-static {p0, p2}, Lgk/h;->c(Landroid/content/Context;Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    sget-object p0, Lek/b;->b:Lek/b;

    goto :goto_2

    :cond_4
    sget-object p0, Lek/b;->c:Lek/b;

    :goto_2
    invoke-virtual {p0}, Lek/b;->a()I
