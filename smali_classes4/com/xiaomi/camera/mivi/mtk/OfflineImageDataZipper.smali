...
.method private doJpeg(Lid/z;Landroid/media/Image;I)V
    .locals 8
    ...
    invoke-direct/range {v2 .. v7}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->generateReprocessData(Lid/z;Landroid/media/Image;Ljava/lang/String;IZ)Lcom/xiaomi/camera/imagecodec/ReprocessData;

    move-result-object p1

    const/4 p2, 0x0

    invoke-static {p3, p2}, Ldd/e;->d(II)V
...
.method private generateReprocessData(Lid/z;Landroid/media/Image;Ljava/lang/String;IZ)Lcom/xiaomi/camera/imagecodec/ReprocessData;
    .locals 16
    ...
    invoke-virtual/range {p1 .. p1}, Lid/z;->l0()Z
    ...
    invoke-virtual/range {p1 .. p1}, Lid/z;->m0()Z
    ...
    invoke-virtual/range {p1 .. p1}, Lid/z;->P()Landroid/media/Image;
    ...
    invoke-virtual/range {p1 .. p1}, Lid/z;->K()I

    move-result v1

    invoke-virtual/range {p1 .. p1}, Lid/z;->J()I
    ...
    invoke-virtual/range {p1 .. p1}, Lid/z;->x()Ljava/lang/String;
...
.method private handleDataBeanIfReady(Lcom/xiaomi/camera/mivi/mtk/OfflineImageData;Z)V
    ...
    invoke-virtual {p0, v0, v1}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->getParallelTaskData(J)Lid/z;
    ...
    :cond_1
    invoke-virtual {p2}, Lid/z;->w()J

    move-result-wide v0

    invoke-virtual {p2}, Lid/z;->x()Ljava/lang/String;
    ...
    invoke-static {v0}, Ldd/d;->g(Landroid/media/Image;)[B
    ...
    invoke-virtual {p2, v0, v1}, Lid/z;->a([BI)V
    ...
    invoke-virtual {p2, v0}, Lid/z;->v1(Landroid/media/Image;)V
    ...
    invoke-direct {p0, v1, p2, v0}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->postCvWaterMark(Landroid/media/Image;Lid/z;I)V
    ...
    invoke-direct {p0, p2, v0, v1}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->doJpeg(Lid/z;Landroid/media/Image;I)V
...
.method private handleRawImageData([BLjava/lang/String;)V
    ...
    invoke-static {p0, p1}, Lcom/xiaomi/camera/mivi/MIVICaptureManager;->notifyFinish(Lid/z;Ljava/lang/String;)V
...
.method private postCvWaterMark(Landroid/media/Image;Lid/z;I)V
    .locals 5
    ...
    invoke-static {p1}, Ldd/d;->f(Landroid/media/Image;)[B
    ...
    invoke-virtual {p2, v0}, Lid/z;->b1(Z)V
...
.method public getParallelTaskData(J)Lid/z;
    .locals 3
...
.method public putParallelTaskData(JLid/z;)V
    .locals 4
