...
.field protected volatile mCurrentParallelTaskData:Lid/z;
...
.field private mQuickViewData:Lid/z;
...
.method private generateQuickViewPictureData()V
    ...
    iget-object v1, p0, Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;->mCurrentParallelTaskData:Lid/z;

    invoke-direct {v0, v1}, Lid/z;-><init>(Lid/z;)V

    iput-object v0, p0, Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;->mQuickViewData:Lid/z;

    new-instance v0, Lid/a0$a;

    iget-object v1, p0, Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;->mCurrentParallelTaskData:Lid/z;

    invoke-virtual {v1}, Lid/z;->s()Lid/a0;

    move-result-object v1

    invoke-direct {v0, v1}, Lid/a0$a;-><init>(Lid/a0;)V
    ...
    invoke-virtual {v0, v1}, Lid/a0$a;->D(Landroid/util/Size;)Lid/a0$a;

    iget-object v1, p0, Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;->mQuickViewData:Lid/z;
    ...
    iget-object v2, p0, Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;->mQuickViewData:Lid/z;

    invoke-virtual {v2}, Lid/z;->s()Lid/a0;

    move-result-object v2

    invoke-virtual {v2}, Lid/a0;->S0()Z
    ...
    invoke-virtual {v0, v1}, Lid/a0$a;->u(I)Lid/a0$a;

    move-result-object v7

    invoke-virtual {v7, v3}, Lid/a0$a;->q(Z)Lid/a0$a;

    move-result-object v7

    const-string v8, ""

    invoke-virtual {v7, v8}, Lid/a0$a;->R(Ljava/lang/String;)Lid/a0$a;

    move-result-object v7

    const/4 v8, 0x1

    invoke-virtual {v7, v8}, Lid/a0$a;->c(Z)Lid/a0$a;

    move-result-object v7

    invoke-virtual {v7, v1}, Lid/a0$a;->g(I)Lid/a0$a;

    move-result-object v1

    invoke-virtual {v1, v4}, Lid/a0$a;->h(I)Lid/a0$a;

    move-result-object v1

    invoke-virtual {v1, v2}, Lid/a0$a;->n(I)Lid/a0$a;

    move-result-object v1

    invoke-virtual {v1, v5}, Lid/a0$a;->T(I)Lid/a0$a;
    ...
    invoke-virtual {v1, v6}, Lid/a0$a;->B(Z)Lid/a0$a;

    iget-object v1, p0, Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;->mQuickViewData:Lid/z;

    invoke-virtual {v1, v3}, Lid/z;->Y0(Z)V
    ...
    invoke-virtual {v1, v0}, Lid/z;->b(Lid/a0;)V

    iget-object v0, p0, Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;->mQuickViewData:Lid/z;

    invoke-virtual {v0}, Lid/z;->s()Lid/a0;

    move-result-object v1

    invoke-virtual {v1}, Lid/a0;->M0()Z

    move-result v1

    invoke-virtual {v0, v1}, Lid/z;->K0(Z)V
    ...
    invoke-virtual {v0, v1}, Lid/z;->c1(Z)V
    ...
    invoke-virtual {v0, v1}, Lid/z;->e1(I)V

    iget-object v0, p0, Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;->mQuickViewData:Lid/z;

    invoke-virtual {v0, v8}, Lid/z;->b1(Z)V

    iget-object p0, p0, Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;->mQuickViewData:Lid/z;

    invoke-virtual {p0, v3}, Lid/z;->W0(Z)V
...
.method public static bridge synthetic l(Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;)Lid/z;
    .locals 0
...
.method private needFreeBuffers(Lid/z;I)Z
    .locals 0
...
.method private onFinalImageReceived([BLjava/lang/String;)V
    ...
    iget-object v2, p0, Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;->mCurrentParallelTaskData:Lid/z;
    ...
    :cond_0
    iget-object v0, p0, Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;->mCurrentParallelTaskData:Lid/z;

    invoke-virtual {v0}, Lid/z;->R()Z
    ...
    iget-object v3, p0, Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;->mCurrentParallelTaskData:Lid/z;
    ...
    invoke-virtual {v0, p1, v1}, Lid/z;->t0([BI)V
    ...
    invoke-virtual {v0, p1, v2}, Lid/z;->t0([BI)V

    :goto_0
    iget-object v0, p0, Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;->mCurrentParallelTaskData:Lid/z;

    invoke-virtual {v0, v1}, Lid/z;->b1(Z)V
    ...
    iget-object p1, p0, Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;->mCurrentParallelTaskData:Lid/z;
    ...
    invoke-virtual {p0, p1, v0, v1, p2}, Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;->notifyResultData(Lid/z;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)V
    ...
    iget-object p0, p0, Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;->mCurrentParallelTaskData:Lid/z;
...
.method private onQuickViewJpegImageReady([BIZ)V
    ...
    invoke-virtual {v0, p1, p2}, Lid/z;->a([BI)V

    iget-object p1, p0, Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;->mQuickViewData:Lid/z;

    iget-object p1, p1, Lid/z;->l0:Lid/h;

    invoke-virtual {p1, p3}, Lid/h;->g(Z)V
    ...
    invoke-virtual {p0, p1, p2, p2, p2}, Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;->notifyResultData(Lid/z;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)V
...
.method public static bridge synthetic s(Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;Lid/z;I)Z
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;->needFreeBuffers(Lid/z;I)Z
...
.method public handleCaptureFinished()V
    ...
    invoke-virtual {p0, v2, v3, v3, v3}, Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;->notifyResultData(Lid/z;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)V
    ...
    invoke-interface {v0, v4, v2, v3, v1}, Lcom/android/camera2/a$m;->F7(ZJI)V
...
.method public notifyResultData(Lid/z;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)V
    .locals 3
    ...
    invoke-virtual {p0}, Lcom/android/camera2/w4;->getParallelCallback()Lid/p;
    ...
    invoke-virtual {p1, v2}, Lid/z;->h1(I)V

    invoke-interface {v0, p1, p2, p3, p4}, Lid/p;->m(Lid/z;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)Z
    ...
    invoke-interface {p1, p2, p3, p4, v1}, Lcom/android/camera2/a$m;->F7(ZJI)V
...
.method public onImageReceived(Landroid/media/Image;I)V
    ...
    invoke-virtual {v0, v5, v6}, Lid/z;->u1(J)V
    ...
    invoke-static {v0, p1, v9, v8}, Ldd/d;->m(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;IZ)Landroid/media/Image;
    ...
    iget-object v4, p0, Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;->mCurrentParallelTaskData:Lid/z;
    ...
    invoke-static {v0, p1, v4, v8}, Ldd/d;->m(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;IZ)Landroid/media/Image;
    ...
    iget-object v10, p0, Lcom/xiaomi/camera/mivi/mtk/OfflineBaseShot;->mCurrentParallelTaskData:Lid/z;

    invoke-virtual {v10}, Lid/z;->w()J
...
.method public updatePictureInfoIfNeed(Landroid/hardware/camera2/TotalCaptureResult;Lid/z;)V
    .locals 7
    ...
    invoke-virtual {p2}, Lid/a0;->s0()Lid/d0;

    move-result-object p2

    const/4 v1, 0x4

    new-array v2, v1, [Ly9/cr;

    sget-object v3, Ly9/br;->V0:Ly9/cr;

    aput-object v3, v2, v0

    sget-object v3, Ly9/br;->W0:Ly9/cr;
    ...
    sget-object v5, Ly9/br;->X0:Ly9/cr;

    aput-object v5, v2, v3

    const/4 v3, 0x3

    sget-object v5, Ly9/br;->Y0:Ly9/cr;
    ...
    invoke-static {p1, v5}, Ly9/dr;->m(Landroid/hardware/camera2/CaptureResult;Ly9/cr;)Ljava/lang/Object;
    ...
    :goto_1
    invoke-virtual {p2, v1}, Lid/d0;->K(Z)V

    sget-object v2, Ly9/br;->w1:Ly9/cr;

    invoke-static {p1, v2}, Ly9/dr;->m(Landroid/hardware/camera2/CaptureResult;Ly9/cr;)Ljava/lang/Object;
    ...
    :cond_3
    invoke-virtual {p2, v2}, Lid/d0;->V(Ljava/lang/String;)V
    ...
    invoke-static {p1, v1}, Ly9/dr;->m(Landroid/hardware/camera2/CaptureResult;Ly9/cr;)Ljava/lang/Object;
    ...
    invoke-virtual {p2, p1}, Lid/d0;->F(Ljava/lang/String;)V
