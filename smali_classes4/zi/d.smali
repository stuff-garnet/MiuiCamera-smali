...
.method public a(Ljava/lang/String;ZLjava/util/List;)V
    ...
    sget-object v0, Lzi/d;->a:Ljava/lang/String;
    ...
    :try_start_0
    invoke-static {p1}, Lqj/b;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_0
    invoke-static {p1}, Lqj/b;->d(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1, v0}, Lzi/d;->c(Ljava/lang/String;Lorg/json/JSONArray;)Ljava/util/List;
    ...
    invoke-virtual {v4, v5}, Lkg/a$b;->x(Ljava/lang/String;)Lkg/a$b;
    ...
    invoke-virtual {v4, v5}, Lkg/a$b;->y(Ljava/lang/String;)Lkg/a$b;
    ...
    invoke-virtual {v4, v5}, Lkg/a$b;->E(Ljava/lang/String;)Lkg/a$b;
    ...
    invoke-virtual {v4, v2}, Lkg/a$b;->u(Ljava/lang/String;)Lkg/a$b;
    ...
    invoke-virtual {v2, p2}, Lkg/a$b;->I(Z)Lkg/a$b;

    move-result-object v2

    iget-object v3, v1, Ls7/i;->id:Ljava/lang/String;

    invoke-virtual {v2, v3}, Lkg/a$b;->F(Ljava/lang/String;)Lkg/a$b;
    ...
    invoke-virtual {v2, v1}, Lkg/a$b;->B(Z)Lkg/a$b;
    ...
    sget-object p1, Lzi/d;->a:Ljava/lang/String;
...
.method public final c(Ljava/lang/String;Lorg/json/JSONArray;)Ljava/util/List;
    ...
    invoke-virtual {p0, v1, v2}, Lzi/d;->b(Lorg/json/JSONObject;Lcom/xiaomi/mimoji/common/bean/AvatarBean$FUDataBean;)Z
...
.method public d(Ljava/lang/String;Ljava/util/List;)V
    ...
    :goto_1
    invoke-virtual {v4, v3}, Lkg/a$b;->x(Ljava/lang/String;)Lkg/a$b;
    ...
    invoke-virtual {v3, v2}, Lkg/a$b;->u(Ljava/lang/String;)Lkg/a$b;
    ...
    invoke-virtual {v2, v1}, Lkg/a$b;->F(Ljava/lang/String;)Lkg/a$b;
...
.method public e(Lkg/a;Ljava/lang/String;)Ljava/lang/String;
    .locals 4
    ...
    invoke-static {p2}, Lqj/b;->d(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v3}, Lpj/i;->f(Ljava/io/File;)V
    ...
    sget-object p0, Lzi/d;->a:Ljava/lang/String;
...
.method public f(Lkg/a;Ljava/lang/String;)V
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/json/JSONException;
    ...
    invoke-static {p0, p2}, Lpj/i;->t(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
