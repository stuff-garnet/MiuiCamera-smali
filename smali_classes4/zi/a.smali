...
# virtual methods
.method public final a(Laj/b$a;Lcom/faceunity/core/entity/FUGroupAnimationBundleData;)V
    .locals 2

    iget-object p0, p1, Laj/b$a;->a:Ljava/util/List;
    ...
    :cond_0
    iget-object p0, p1, Laj/b$a;->b:Ljava/util/List;
...
.method public b(Laj/b;Z)Laj/b;
    .locals 5

    if-nez p1, :cond_0

    sget-object p0, Lzi/a;->a:Ljava/lang/String;
    ...
    invoke-virtual {p1}, Laj/b;->b()Laj/b$a;

    move-result-object v1

    invoke-virtual {v0, v1}, Laj/b;->g(Laj/b$a;)V

    invoke-virtual {p1}, Laj/b;->d()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Laj/b;->i(Ljava/lang/String;)V

    invoke-virtual {p1}, Laj/b;->c()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Laj/b;->h(Ljava/lang/String;)V

    invoke-virtual {p1}, Laj/b;->e()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Laj/b;->j(Ljava/lang/String;)V
    ...
    invoke-virtual {p1}, Laj/b;->a()Lcom/faceunity/core/entity/FUAnimationBundleData;
    ...
    invoke-virtual {v0, v2}, Laj/b;->f(Lcom/faceunity/core/entity/FUAnimationBundleData;)V
    ...
    invoke-virtual {p0, v1, p1}, Lzi/a;->a(Laj/b$a;Lcom/faceunity/core/entity/FUGroupAnimationBundleData;)V
    ...
    invoke-virtual {v0, p0}, Laj/b;->f(Lcom/faceunity/core/entity/FUAnimationBundleData;)V

    :goto_0
    return-object v0
.end method

.method public c(Laj/d;Z)Laj/d;
    .locals 2
    ...
    invoke-virtual {p0, v0}, Laj/d;->g(Ljava/lang/String;)V

    invoke-virtual {p1}, Laj/d;->a()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p0, v0}, Laj/d;->e(Ljava/lang/String;)V

    invoke-virtual {p1}, Laj/d;->d()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p0, v0}, Laj/d;->h(Ljava/lang/String;)V

    new-instance v0, Lcom/faceunity/core/entity/FUEmotionBundleData;

    invoke-virtual {p1}, Laj/d;->b()Lcom/faceunity/core/entity/FUEmotionBundleData;
    ...
    invoke-virtual {p0, v0}, Laj/d;->f(Lcom/faceunity/core/entity/FUEmotionBundleData;)V
...
.method public final d(Ljava/util/Map;Ljava/util/List;)V
    ...
    invoke-virtual {p2}, Laj/b;->d()Ljava/lang/String;
...
.method public final e(Ljava/util/Map;Ljava/util/List;)V
    ...
    invoke-virtual {p2}, Laj/d;->c()Ljava/lang/String;
...
.method public f(Ljava/lang/String;Laj/a;)V
    .locals 10
    ...
    sget-object v6, Lzi/a;->a:Ljava/lang/String;
    ...
    invoke-static {v6, v7}, Lpj/j;->k(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p2}, Laj/a;->a()Ljava/util/Map;

    move-result-object v6

    invoke-virtual {p2}, Laj/a;->b()Ljava/util/Map;

    move-result-object v7

    invoke-virtual {p2}, Laj/a;->e()Ljava/util/Map;

    move-result-object v8

    :try_start_0
    invoke-static {p1}, Lqj/b;->e(Ljava/lang/String;)Lorg/json/JSONObject;
    ...
    invoke-virtual {p0, v3, v9}, Lzi/a;->q(Lorg/json/JSONArray;Ljava/lang/String;)Ljava/util/List;

    move-result-object v3

    invoke-virtual {p0, v6, v3}, Lzi/a;->d(Ljava/util/Map;Ljava/util/List;)V
    ...
    invoke-virtual {p0, v2}, Lzi/a;->r(Lorg/json/JSONArray;)Ljava/util/List;

    move-result-object v2

    invoke-virtual {p0, v7, v2}, Lzi/a;->e(Ljava/util/Map;Ljava/util/List;)V
    ...
    invoke-virtual {p0, v2, v3, v6}, Lzi/a;->t(Lorg/json/JSONObject;Ljava/lang/String;Ljava/util/Map;)Ljava/util/List;

    move-result-object v2

    invoke-virtual {p2, v2}, Laj/a;->h(Ljava/util/List;)V
    ...
    invoke-virtual {p2, v2}, Laj/a;->j(Ljava/util/List;)V
    ...
    invoke-virtual {p2, v2}, Laj/a;->i(Ljava/util/List;)V
    ...
    invoke-virtual {p0, v1, v2, v6}, Lzi/a;->n(Lorg/json/JSONObject;Ljava/lang/String;Ljava/util/Map;)Laj/b;

    move-result-object v1

    invoke-virtual {p2, v1}, Laj/a;->k(Laj/b;)V
    ...
    invoke-virtual {p0, p2, v0}, Lzi/a;->o(Lorg/json/JSONObject;Z)Laj/f;
    ...
    invoke-virtual {p0, p1, v0}, Lzi/a;->o(Lorg/json/JSONObject;Z)Laj/f;
    ...
    sget-object p1, Lzi/a;->a:Ljava/lang/String;
...
.method public final g(Lorg/json/JSONObject;)Laj/c;
    .locals 3
    ...
    invoke-virtual {p0, v0}, Laj/c;->f(I)V

    goto :goto_0

    :cond_0
    invoke-virtual {p0, v2}, Laj/c;->f(I)V
    ...
    invoke-virtual {p0, v0}, Laj/c;->j(Z)V

    goto :goto_1

    :cond_1
    invoke-virtual {p0, v2}, Laj/c;->j(Z)V
    ...
    invoke-virtual {p0, v0}, Laj/c;->h(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0}, Laj/c;->g(Ljava/lang/Integer;)V
    ...
    invoke-virtual {p0, p1}, Laj/c;->i(Ljava/lang/Boolean;)V

    :cond_5
    return-object p0
.end method

.method public final h(Lorg/json/JSONObject;Z)Laj/b$a;
    .locals 3
    ...
    invoke-virtual {p0, v1, v2}, Lzi/a;->p(Lorg/json/JSONArray;Ljava/lang/String;)Ljava/util/List;

    move-result-object v1

    iput-object v1, v0, Laj/b$a;->a:Ljava/util/List;
    ...
    invoke-virtual {p0, v1}, Lzi/a;->s(Lorg/json/JSONArray;)Ljava/util/List;

    move-result-object v1

    iput-object v1, v0, Laj/b$a;->b:Ljava/util/List;
    ...
    invoke-virtual {p0, v1, p2}, Lzi/a;->l(Lorg/json/JSONObject;Z)Lcom/faceunity/core/entity/FUAnimationBundleData;

    move-result-object v1

    iput-object v1, v0, Laj/b$a;->c:Lcom/faceunity/core/entity/FUAnimationBundleData;
    ...
    iput-object v1, v0, Laj/b$a;->e:Lcom/faceunity/core/entity/FUBundleData;
    ...
    iput-object v1, v0, Laj/b$a;->f:Lcom/faceunity/core/entity/FUBundleData;
    ...
    iput-object v1, v0, Laj/b$a;->g:Lcom/faceunity/core/entity/FUBundleData;
    ...
    invoke-virtual {p0, p1, p2}, Lzi/a;->m(Lorg/json/JSONObject;Z)Lcom/faceunity/core/entity/FUEmotionBundleData;

    move-result-object p0

    iput-object p0, v0, Laj/b$a;->d:Lcom/faceunity/core/entity/FUEmotionBundleData;
...
.method public final i(Lorg/json/JSONObject;ZLjava/lang/String;)Lcom/faceunity/core/entity/FUAnimationBundleData;
    ...
    invoke-static {v1}, Ldj/c;->i(Ljava/lang/String;)Ljava/lang/String;
...
.method public final j(Lorg/json/JSONObject;ZLjava/lang/String;)Laj/b;
    .locals 16
    ...
    invoke-virtual {v2, v3}, Laj/b;->i(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v3}, Laj/b;->j(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v3}, Laj/b;->h(Ljava/lang/String;)V

    :cond_2
    invoke-virtual/range {p0 .. p1}, Lzi/a;->g(Lorg/json/JSONObject;)Laj/c;
    ...
    invoke-static {v4}, Ldj/c;->i(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v2}, Laj/b;->e()Ljava/lang/String;

    move-result-object v7

    invoke-virtual {v3}, Laj/c;->e()Z

    move-result v9

    const/4 v10, 0x0

    invoke-virtual {v3}, Laj/c;->a()I

    move-result v11

    invoke-virtual {v3}, Laj/c;->c()Ljava/lang/String;

    move-result-object v12

    invoke-virtual {v3}, Laj/c;->b()Ljava/lang/Integer;

    move-result-object v13

    invoke-virtual {v3}, Laj/c;->d()Ljava/lang/Boolean;
    ...
    invoke-virtual {v2, v15}, Laj/b;->f(Lcom/faceunity/core/entity/FUAnimationBundleData;)V
    ...
    invoke-virtual {v0, v1, v3}, Lzi/a;->h(Lorg/json/JSONObject;Z)Laj/b$a;

    move-result-object v1

    invoke-virtual {v2, v1}, Laj/b;->g(Laj/b$a;)V

    invoke-virtual {v2}, Laj/b;->b()Laj/b$a;

    move-result-object v1

    invoke-virtual {v2}, Laj/b;->a()Lcom/faceunity/core/entity/FUAnimationBundleData;

    move-result-object v3

    check-cast v3, Lcom/faceunity/core/entity/FUGroupAnimationBundleData;

    invoke-virtual {v0, v1, v3}, Lzi/a;->a(Laj/b$a;Lcom/faceunity/core/entity/FUGroupAnimationBundleData;)V
    ...
    invoke-virtual {v2, v0}, Laj/b;->f(Lcom/faceunity/core/entity/FUAnimationBundleData;)V

    :goto_1
    return-object v2
.end method

.method public final k(Lorg/json/JSONObject;Z)Laj/d;
    .locals 2
    ...
    invoke-static {p1}, Ldj/c;->i(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0}, Laj/d;->d()Ljava/lang/String;

    move-result-object v0

    invoke-direct {p2, p1, v0}, Lcom/faceunity/core/entity/FUEmotionBundleData;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p0, p2}, Laj/d;->f(Lcom/faceunity/core/entity/FUEmotionBundleData;)V
...
.method public final n(Lorg/json/JSONObject;Ljava/lang/String;Ljava/util/Map;)Laj/b;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, p1, p2, p3}, Lzi/a;->t(Lorg/json/JSONObject;Ljava/lang/String;Ljava/util/Map;)Ljava/util/List;

    move-result-object p0

    invoke-static {p0}, Lpj/e;->e(Ljava/util/List;)Z
...
.method public final o(Lorg/json/JSONObject;Z)Laj/f;
    .locals 3
    ...
    invoke-virtual {p0, v2}, Laj/f;->f(Lcom/faceunity/core/entity/FUAnimationBundleData;)V
    ...
    invoke-virtual {p0, p2}, Laj/f;->h(Lcom/faceunity/core/entity/FUBundleData;)V
...
.method public final p(Lorg/json/JSONArray;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-virtual {p0, v2, v3, p2}, Lzi/a;->i(Lorg/json/JSONObject;ZLjava/lang/String;)Lcom/faceunity/core/entity/FUAnimationBundleData;
...
.method public final q(Lorg/json/JSONArray;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-virtual {p0, v2, v3, p2}, Lzi/a;->j(Lorg/json/JSONObject;ZLjava/lang/String;)Laj/b;
...
.method public final r(Lorg/json/JSONArray;)Ljava/util/List;
    ...
    invoke-virtual {p0, v2, v3}, Lzi/a;->k(Lorg/json/JSONObject;Z)Laj/d;
...
.method public final s(Lorg/json/JSONArray;)Ljava/util/List;
    ...
    invoke-virtual {p0, v2, v3}, Lzi/a;->l(Lorg/json/JSONObject;Z)Lcom/faceunity/core/entity/FUAnimationBundleData;
...
.method public final t(Lorg/json/JSONObject;Ljava/lang/String;Ljava/util/Map;)Ljava/util/List;
    ...
    :cond_0
    invoke-virtual {v0, v4}, Lzi/a;->g(Lorg/json/JSONObject;)Laj/c;

    move-result-object v4

    invoke-virtual {v5}, Laj/b;->b()Laj/b$a;
    ...
    invoke-virtual {v5}, Laj/b;->a()Lcom/faceunity/core/entity/FUAnimationBundleData;
    ...
    invoke-virtual {v5}, Laj/b;->e()Ljava/lang/String;

    move-result-object v10

    invoke-virtual {v4}, Laj/c;->e()Z

    move-result v12

    const/4 v13, 0x0

    invoke-virtual {v4}, Laj/c;->a()I

    move-result v14

    invoke-virtual {v4}, Laj/c;->c()Ljava/lang/String;

    move-result-object v16

    invoke-virtual {v4}, Laj/c;->b()Ljava/lang/Integer;

    move-result-object v17

    invoke-virtual {v4}, Laj/c;->d()Ljava/lang/Boolean;
    ...
    invoke-virtual {v5, v4}, Laj/b;->f(Lcom/faceunity/core/entity/FUAnimationBundleData;)V
    ...
    invoke-virtual {v0, v7, v4}, Lzi/a;->a(Laj/b$a;Lcom/faceunity/core/entity/FUGroupAnimationBundleData;)V
    ...
    invoke-virtual {v5, v7}, Laj/b;->f(Lcom/faceunity/core/entity/FUAnimationBundleData;)V
