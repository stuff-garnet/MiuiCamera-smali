...
.method public constructor <init>(Lid/h0;)V
    ...
    iput-object p1, p0, Lid/h0$e;->a:Lid/h0;
...
.method public a(Lid/l;)Z
    ...
    invoke-virtual {p0, p1}, Lid/t;->z(Lid/l;)Z
...
.method public b(Landroid/media/Image;)V
    ...
    iget-object p0, p0, Lid/h0$e;->a:Lid/h0;

    invoke-static {p0}, Lid/h0;->d(Lid/h0;)Lid/f;

    move-result-object p0

    invoke-interface {p0, p1}, Lid/f;->b(Landroid/media/Image;)V
...
.method public c(JI)V
    ...
    iget-object v0, p0, Lid/h0$e;->a:Lid/h0;

    invoke-static {v0}, Lid/h0;->l(Lid/h0;)Lid/h0$j;

    move-result-object v0

    if-eqz v0, :cond_2

    invoke-virtual {p0, p1, p2}, Lid/h0$e;->d(J)Lid/z;

    move-result-object v0

    if-eqz v0, :cond_2

    invoke-virtual {v0}, Lid/z;->j0()Z
    ...
    invoke-static {p0}, Lid/h0;->l(Lid/h0;)Lid/h0$j;

    move-result-object p0

    invoke-interface {p0, v0, p3}, Lid/h0$j;->a(Lid/z;I)V
...
.method public d(J)Lid/z;
    .locals 0

    iget-object p0, p0, Lid/h0$e;->a:Lid/h0;

    invoke-static {p0, p1, p2}, Lid/h0;->C(Lid/h0;J)Lid/z;
...
.method public e(ILjava/lang/Object;)V
    ...
    invoke-virtual {p0, p2}, Lid/h0$e;->i(Lcom/xiaomi/engine/ResultData;)V
    ...
    invoke-virtual {p0, p2}, Lid/h0$e;->j(Lcom/xiaomi/engine/ResultData;)V
...
.method public f(Landroid/media/Image;IZ)V
    ...
    invoke-static {v8, v13}, Ldd/e;->d(II)V

    invoke-static/range {p1 .. p1}, Ldd/d;->g(Landroid/media/Image;)[B

    move-result-object v0

    if-eqz v0, :cond_12

    iget-object v1, v1, Lid/h0$e;->a:Lid/h0;

    invoke-static {v1}, Lid/h0;->i(Lid/h0;)Lcom/xiaomi/camera/imagecodec/ReprocessData$OnDataAvailableListener;
    ...
    :cond_0
    invoke-virtual {v1, v9, v10}, Lid/h0$e;->d(J)Lid/z;
    ...
    invoke-virtual {v15}, Lid/z;->l()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-virtual {v15}, Lid/z;->s()Lid/a0;

    move-result-object v3

    invoke-virtual {v3}, Lid/a0;->q0()I
    ...
    invoke-static {v5}, Ldd/c;->d(I)Z

    move-result v4

    if-nez v4, :cond_8

    invoke-virtual {v3}, Lid/a0;->V0()Z
    ...
    iget-object v2, v1, Lid/h0$e;->a:Lid/h0;
    ...
    invoke-static/range {v2 .. v7}, Lid/h0;->B(Lid/h0;Lid/z;Landroid/media/Image;Ljava/lang/String;IZ)Lcom/xiaomi/camera/imagecodec/ReprocessData;
    ...
    invoke-static {v3, v0, v7}, Ldd/d;->l(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;I)Landroid/media/Image;

    move-result-object v3

    iget-object v4, v1, Lid/h0$e;->a:Lid/h0;

    invoke-static {v4}, Lid/h0;->d(Lid/h0;)Lid/f;

    move-result-object v4

    invoke-interface {v4, v0}, Lid/f;->b(Landroid/media/Image;)V
    ...
    iget-object v3, v1, Lid/h0$e;->a:Lid/h0;

    invoke-static {v3}, Lid/h0;->h(Lid/h0;)La8/i;

    move-result-object v3

    iget-object v4, v1, Lid/h0$e;->a:Lid/h0;

    invoke-static {v4}, Lid/h0;->e(Lid/h0;)La8/e$a;

    move-result-object v4

    invoke-virtual {v3, v0, v2, v15, v4}, La8/i;->s(Landroid/media/Image;Landroid/hardware/camera2/CaptureResult;Lid/z;La8/e$a;)V

    invoke-static {v5}, Ldd/c;->c(I)Z

    move-result v0

    if-eqz v0, :cond_7

    iget-object v0, v1, Lid/h0$e;->a:Lid/h0;

    invoke-static {v0}, Lid/h0;->q(Lid/h0;)Ljava/util/Map;
    ...
    invoke-static {v3}, Lid/h0;->r(Lid/h0;)Ljava/util/Map;
    ...
    invoke-static {v3, v5}, Lid/h0;->v(Lid/h0;Ljava/util/Map;)V
    ...
    invoke-static {v3}, Lid/h0;->p(Lid/h0;)Ljava/util/Map;
    ...
    invoke-static {v3, v5}, Lid/h0;->u(Lid/h0;Ljava/util/Map;)V
    ...
    invoke-virtual {v15}, Lid/z;->K()I

    move-result v5

    invoke-virtual {v15}, Lid/z;->J()I

    move-result v6

    invoke-virtual {v15}, Lid/z;->d()Landroid/graphics/Rect;

    move-result-object v7

    invoke-virtual {v15}, Lid/z;->Q()F
    ...
    invoke-static {v0}, Lid/h0;->p(Lid/h0;)Ljava/util/Map;
    ...
    invoke-static {v0}, Lid/h0;->r(Lid/h0;)Ljava/util/Map;
    ...
    invoke-static {v2}, Lid/h0;->i(Lid/h0;)Lcom/xiaomi/camera/imagecodec/ReprocessData$OnDataAvailableListener;
    ...
    invoke-static {v2}, Lid/h0;->p(Lid/h0;)Ljava/util/Map;
    ...
    invoke-static {v1}, Lid/h0;->r(Lid/h0;)Ljava/util/Map;
    ...
    invoke-virtual/range {v1 .. v7}, Lid/h0$e;->h(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;ZLid/z;J)V
    ...
    invoke-static {v2, v0, v3}, Ldd/d;->l(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;I)Landroid/media/Image;

    move-result-object v2

    iget-object v3, v1, Lid/h0$e;->a:Lid/h0;

    invoke-static {v3}, Lid/h0;->d(Lid/h0;)Lid/f;

    move-result-object v3

    invoke-interface {v3, v0}, Lid/f;->b(Landroid/media/Image;)V

    iget-object v0, v1, Lid/h0$e;->a:Lid/h0;

    invoke-static {v0, v9, v10, v2}, Lid/h0;->z(Lid/h0;JLandroid/media/Image;)V
    ...
    invoke-static {v1, v9, v10, v0}, Lid/h0;->z(Lid/h0;JLandroid/media/Image;)V
...
.method public final h(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;ZLid/z;J)V
    .locals 6
    ...
    invoke-static {p2}, Ldd/d;->f(Landroid/media/Image;)[B
    ...
    invoke-virtual {p4, v3, v0}, Lid/z;->a([BI)V

    const-string p2, "JPEG"

    invoke-virtual {p4, p2}, Lid/z;->b0(Ljava/lang/String;)Z

    move-result p2

    if-nez p2, :cond_2

    sget-boolean p2, Lid/h0;->U:Z
    ...
    invoke-virtual {p4, p2}, Lid/z;->X0(Z)V
    ...
    iget-object p2, p0, Lid/h0$e;->a:Lid/h0;

    invoke-static {p2}, Lid/h0;->h(Lid/h0;)La8/i;

    move-result-object p2

    const/4 p3, 0x0

    invoke-virtual {p2, p4, p1, p3, p3}, La8/i;->m(Lid/z;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)Z

    move-result p1

    iget-object p2, p0, Lid/h0$e;->a:Lid/h0;

    invoke-virtual {p4}, Lid/z;->P()Landroid/media/Image;

    move-result-object p3

    invoke-static {p2, p3}, Lid/h0;->y(Lid/h0;Landroid/media/Image;)V

    if-eqz p1, :cond_3

    invoke-virtual {p4}, Lid/z;->v0()V

    :cond_3
    iget-object p1, p0, Lid/h0$e;->a:Lid/h0;

    invoke-static {p1, p4}, Lid/h0;->D(Lid/h0;Lid/z;)Z
    ...
    invoke-interface {p1, p4}, Lid/h0$j;->b(Lid/z;)V
    ...
    invoke-static {p1}, Lid/h0;->j(Lid/h0;)I

    move-result p2

    add-int/lit8 p2, p2, 0x1

    invoke-static {p1, p2}, Lid/h0;->t(Lid/h0;I)V

    iget-object p1, p0, Lid/h0$e;->a:Lid/h0;

    invoke-static {p1, p5, p6}, Lid/h0;->J(Lid/h0;J)Lid/z;

    move-result-object p1

    iget-object p2, p0, Lid/h0$e;->a:Lid/h0;

    invoke-static {p2}, Lid/h0;->j(Lid/h0;)I

    move-result p3

    invoke-static {p2, p1, p3}, Lid/h0;->E(Lid/h0;Lid/z;I)Z
    ...
    invoke-static {p1}, Lid/h0;->A(Lid/h0;)V

    iget-object p1, p0, Lid/h0$e;->a:Lid/h0;

    invoke-static {p1, v0}, Lid/h0;->t(Lid/h0;I)V

    :cond_5
    iget-object p1, p0, Lid/h0$e;->a:Lid/h0;

    invoke-static {p1}, Lid/h0;->M(Lid/h0;)V
...
.method public final i(Lcom/xiaomi/engine/ResultData;)V
    ...
    invoke-virtual {p0, v0, v1}, Lid/h0$e;->d(J)Lid/z;
    ...
    :cond_1
    invoke-virtual {p0}, Lid/a0;->s0()Lid/d0;

    move-result-object v0

    invoke-static {p1}, Lid/m;->a(Lcom/xiaomi/engine/ResultData;)Ljava/lang/String;
    ...
    invoke-virtual {v0, p1}, Lid/d0;->F(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, Lid/a0;->Y0(B)V

    invoke-virtual {v0, p1}, Lid/d0;->d0(B)V
...
.method public final j(Lcom/xiaomi/engine/ResultData;)V
    ...
    invoke-virtual {v1, v2, v3}, Lid/h0$e;->d(J)Lid/z;
    ...
    :goto_1
    iget-object v11, v1, Lid/h0$e;->a:Lid/h0;

    invoke-static {v11}, Lid/h0;->p(Lid/h0;)Ljava/util/Map;
    ...
    invoke-static {v11, v12}, Lid/h0;->u(Lid/h0;Ljava/util/Map;)V
    ...
    invoke-static {v0, v7}, Lid/h0;->v(Lid/h0;Ljava/util/Map;)V
    ...
    iget-object v7, v1, Lid/h0$e;->a:Lid/h0;

    invoke-static {v7}, Lid/h0;->p(Lid/h0;)Ljava/util/Map;
    ...
    invoke-virtual {v4}, Lid/z;->K()I

    move-result v8

    invoke-virtual {v4}, Lid/z;->J()I

    move-result v11

    invoke-virtual {v4}, Lid/z;->d()Landroid/graphics/Rect;

    move-result-object v12

    invoke-virtual {v4}, Lid/z;->Q()F
    ...
    invoke-static {v4}, Lid/h0;->i(Lid/h0;)Lcom/xiaomi/camera/imagecodec/ReprocessData$OnDataAvailableListener;
    ...
    invoke-static {v4}, Lid/h0;->r(Lid/h0;)Ljava/util/Map;
    ...
    invoke-static {v1}, Lid/h0;->p(Lid/h0;)Ljava/util/Map;
