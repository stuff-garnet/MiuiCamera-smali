...
.method public X(Lid/m0;)V
    ...
    invoke-virtual {p0, v5}, Lid/l;->q(Landroid/media/Image;)Z
    ...
    invoke-static {v6, v1}, Ldd/e;->b(Ljava/lang/String;I)V

    invoke-virtual {v4}, Lid/e$a;->g()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-virtual {p0, v6, v5, v1, v7}, Lid/l0;->f0(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    sget-object v9, Ly9/pj;->M:Ly9/cr;

    invoke-static {v8, v9}, Ly9/dr;->l(Landroid/hardware/camera2/CaptureRequest;Ly9/cr;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v6, v5, v7, v8}, Lid/l0;->f0(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V

    :goto_3
    invoke-virtual {v4}, Lid/e$a;->k()Landroid/media/Image;

    move-result-object v4

    iget-object v5, p0, Lid/l;->j:Lid/l$a;

    invoke-virtual {p0, v4, v5}, Lid/c;->b0(Landroid/media/Image;Lid/l$a;)V
...
.method public b(Lcom/xiaomi/engine/BufferFormat;)Ljava/util/List;
    ...
    new-instance v2, Lid/l0$a;

    invoke-direct {v2, p0}, Lid/l0$a;-><init>(Lid/l0;)V
    ...
    new-instance v2, Lid/l0$b;

    invoke-direct {v2, p0}, Lid/l0$b;-><init>(Lid/l0;)V
    ...
    new-instance v1, Lid/l0$c;

    invoke-direct {v1, p0}, Lid/l0$c;-><init>(Lid/l0;)V
...
.method public final f0(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    :cond_0
    new-instance p1, Lid/l0$d;

    invoke-direct {p1, p0}, Lid/l0$d;-><init>(Lid/l0;)V
    ...
    :cond_2
    new-instance p1, Lid/l0$e;

    invoke-direct {p1, p0}, Lid/l0$e;-><init>(Lid/l0;)V
