...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lid/t;->A(Landroid/media/Image;IIZ)V
.end annotation
...
.field public final synthetic e:Lid/t;


# direct methods
.method public constructor <init>(Lid/t;Landroid/media/Image;IIZ)V
    .locals 0

    iput-object p1, p0, Lid/t$c;->e:Lid/t;

    iput-object p2, p0, Lid/t$c;->a:Landroid/media/Image;

    iput p3, p0, Lid/t$c;->b:I

    iput p4, p0, Lid/t$c;->c:I

    iput-boolean p5, p0, Lid/t$c;->d:Z
...
.method public static synthetic a(Ljava/util/Map$Entry;)Lid/e;
    .locals 0

    invoke-static {p0}, Lid/t$c;->d(Ljava/util/Map$Entry;)Lid/e;
...
.method public static synthetic b(Ljava/lang/String;Ljava/util/Map$Entry;)Z
    ...
    invoke-static {p0, p1}, Lid/t$c;->c(Ljava/lang/String;Ljava/util/Map$Entry;)Z
...
.method public run()V
    ...
    :try_start_0
    iget-object v4, v0, Lid/t$c;->a:Landroid/media/Image;
    ...
    iget-object v6, v0, Lid/t$c;->e:Lid/t;
    ...
    sget-object v7, Lpk/b;->j:Lpk/b;

    iget-object v8, v0, Lid/t$c;->e:Lid/t;

    invoke-static {v8}, Lid/t;->d(Lid/t;)Ljava/util/Map;
    ...
    invoke-virtual {v6}, Lid/e$a;->c()Ljava/lang/String;
    ...
    iget-object v9, v0, Lid/t$c;->e:Lid/t;

    invoke-static {v9}, Lid/t;->d(Lid/t;)Ljava/util/Map;
    ...
    new-instance v10, Lid/w;

    invoke-direct {v10, v8}, Lid/w;-><init>(Ljava/lang/String;)V

    invoke-interface {v9, v10}, Ljava/util/stream/Stream;->filter(Ljava/util/function/Predicate;)Ljava/util/stream/Stream;

    move-result-object v9

    new-instance v10, Lid/x;

    invoke-direct {v10}, Lid/x;-><init>()V
    ...
    invoke-static {v8, v4, v5}, Lid/t;->g(Lid/t;J)J
    ...
    iget-object v10, v0, Lid/t$c;->e:Lid/t;

    invoke-static {v10}, Lid/t;->d(Lid/t;)Ljava/util/Map;
    ...
    :cond_3
    invoke-virtual {v8}, Lid/e;->q()I

    move-result v7

    invoke-virtual {v8}, Lid/e;->z()Z

    move-result v9

    invoke-virtual {v8}, Lid/e;->p()Lpk/b;

    move-result-object v10

    invoke-virtual {v8}, Lid/e;->v()Z

    move-result v11

    invoke-virtual {v8}, Lid/e;->i()J
    ...
    invoke-direct/range {v14 .. v19}, Lid/e$a;-><init>(IZLpk/b;ZZ)V

    iget-object v2, v0, Lid/t$c;->e:Lid/t;

    invoke-static {v2}, Lid/t;->e(Lid/t;)Landroid/util/LongSparseArray;
    ...
    invoke-virtual {v6, v9, v10}, Lid/e$a;->y(J)V

    invoke-virtual {v6, v8}, Lid/e$a;->z(Z)V
    ...
    iget-object v1, v0, Lid/t$c;->a:Landroid/media/Image;

    iget v2, v0, Lid/t$c;->b:I

    iget v3, v0, Lid/t$c;->c:I

    iget-boolean v4, v0, Lid/t$c;->d:Z

    invoke-virtual {v6, v1, v2, v3, v4}, Lid/e$a;->A(Landroid/media/Image;IIZ)V

    iget-object v0, v0, Lid/t$c;->e:Lid/t;
    ...
    iget-object v0, v0, Lid/t$c;->a:Landroid/media/Image;
