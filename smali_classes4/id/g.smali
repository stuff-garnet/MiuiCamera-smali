...
.method public constructor <init>(Lid/l$a;Lcom/xiaomi/engine/BufferFormat;)V
    ...
    invoke-direct {p0, p1, p2}, Lid/c;-><init>(Lid/l$a;Lcom/xiaomi/engine/BufferFormat;)V
...
.method public X(Lid/m0;)V
    ...
    invoke-virtual {p1}, Lid/m0;->f()Lpk/b;
    ...
    :cond_1
    invoke-virtual {p0, p1}, Lid/g;->g0(Lid/m0;)V

    goto :goto_1

    :cond_2
    :goto_0
    invoke-virtual {p0, p1}, Lid/g;->h0(Lid/m0;)V
...
.method public b(Lcom/xiaomi/engine/BufferFormat;)Ljava/util/List;
    ...
    iput-object v1, p0, Lid/c;->K:Landroid/media/ImageReader;

    new-instance v2, Lid/g$a;

    invoke-direct {v2, p0}, Lid/g$a;-><init>(Lid/g;)V
    ...
    iget-object v2, p0, Lid/c;->K:Landroid/media/ImageReader;
    ...
    iput-object v1, p0, Lid/c;->L:Landroid/media/ImageReader;

    new-instance v2, Lid/g$b;

    invoke-direct {v2, p0}, Lid/g$b;-><init>(Lid/g;)V
    ...
    iget-object v2, p0, Lid/c;->L:Landroid/media/ImageReader;
    ...
    iput-object p1, p0, Lid/c;->M:Landroid/media/ImageReader;

    new-instance v1, Lid/g$c;

    invoke-direct {v1, p0}, Lid/g$c;-><init>(Lid/g;)V
    ...
    iget-object p0, p0, Lid/c;->M:Landroid/media/ImageReader;
...
.method public final f0(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    sget-object v0, Ly9/br;->b2:Ly9/cr;

    invoke-virtual {v0}, Ly9/cr;->b()Ljava/lang/Object;
    ...
    :cond_2
    new-instance p1, Lid/g$d;

    invoke-direct {p1, p0}, Lid/g$d;-><init>(Lid/g;)V
    ...
    iget-object p1, p0, Lid/c;->O:Ljava/lang/Object;
    ...
    :try_start_1
    iget-object p2, p0, Lid/c;->I:Lcom/xiaomi/engine/TaskSession;

    goto :goto_2

    :cond_3
    iget-object p2, p0, Lid/c;->J:Lid/o0;

    invoke-virtual {p2}, Lid/o0;->b()Lcom/xiaomi/engine/TaskSession;
    ...
    :cond_4
    new-instance p1, Lid/g$e;

    invoke-direct {p1, p0}, Lid/g$e;-><init>(Lid/g;)V
...
.method public final g0(Lid/m0;)V
    .locals 9
    .param p1    # Lid/m0;
    ...
    invoke-virtual {v1}, Lid/e$a;->k()Landroid/media/Image;

    move-result-object v3

    invoke-virtual {p0, v2}, Lid/l;->q(Landroid/media/Image;)Z

    move-result v4

    invoke-virtual {p0, v3}, Lid/l;->q(Landroid/media/Image;)Z
    ...
    invoke-static {v8, v7}, Ldd/e;->b(Ljava/lang/String;I)V

    invoke-virtual {v1}, Lid/e$a;->g()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-virtual {p1}, Lid/m0;->e()I

    move-result v4

    invoke-virtual {p0, v1, v2, v7, v4}, Lid/g;->f0(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    invoke-virtual {p0, v1, v3, v2, v4}, Lid/g;->f0(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
...
.method public final h0(Lid/m0;)V
    .locals 7
    .param p1    # Lid/m0;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-static {v4, v5}, Ldd/e;->b(Ljava/lang/String;I)V
    ...
    invoke-virtual {p0, v1, v2, v5, v4}, Lid/g;->f0(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
...
.method public p()Z
    ...
    iget-object v1, p0, Lid/l;->b:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v0, p0, Lid/l;->b:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v0, p0, Lid/l;->c:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object p0, p0, Lid/l;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-interface {v0, p0}, Lid/l$a;->a(Lid/l;)Z
    ...
    iget-object p0, p0, Lid/l;->b:Ljava/util/concurrent/atomic/AtomicInteger;
