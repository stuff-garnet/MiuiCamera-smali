...
# direct methods
.method public constructor <init>(Lid/l$a;Lcom/xiaomi/engine/BufferFormat;)V
    .locals 2

    invoke-direct {p0, p1, p2}, Lid/l;-><init>(Lid/l$a;Lcom/xiaomi/engine/BufferFormat;)V
    ...
    iput-object p1, p0, Lid/c;->F:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance p1, Ljava/lang/Object;

    invoke-direct {p1}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lid/c;->O:Ljava/lang/Object;

    new-instance p1, Landroid/util/LongSparseArray;

    invoke-direct {p1}, Landroid/util/LongSparseArray;-><init>()V

    iput-object p1, p0, Lid/c;->P:Landroid/util/LongSparseArray;
    ...
    iget-object v1, p0, Lid/l;->m:Ljava/lang/String;
    ...
    iput-object p1, p0, Lid/c;->G:Landroid/os/HandlerThread;
    ...
    iget-object p0, p0, Lid/l;->m:Ljava/lang/String;
...
.method public static synthetic L(Lid/c;Landroid/media/ImageReader;)V
    .locals 0

    invoke-direct {p0, p1}, Lid/c;->S(Landroid/media/ImageReader;)V
...
.method private synthetic S(Landroid/media/ImageReader;)V
    ...
    invoke-static {v2, v3}, Ldd/e;->b(Ljava/lang/String;I)V
    ...
    invoke-virtual {p0, v2, p1}, Lid/l;->y(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;)Landroid/media/Image;
    ...
    invoke-direct {p1, v2, v4, v3}, Lid/j;-><init>(Landroid/media/Image;IZ)V

    invoke-virtual {p0, p1}, Lid/l;->d(Lid/j;)V

    invoke-virtual {p0, v0, v1}, Lid/c;->V(J)V
...
.method public E(Lcom/xiaomi/engine/TaskSession;)V
    ...
    iget-object v0, p0, Lid/c;->O:Ljava/lang/Object;
    ...
    iput-object p1, p0, Lid/c;->I:Lcom/xiaomi/engine/TaskSession;

    monitor-exit v0
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_1

    invoke-virtual {p0}, Lid/l;->n()Z

    move-result p1

    if-eqz p1, :cond_0

    iget-object p1, p0, Lid/l;->o:Ljava/lang/Object;

    monitor-enter p1

    :try_start_1
    iget-object v0, p0, Lid/l;->p:Ljava/util/LinkedList;
...
.method public F(Lid/o0;)V
    ...
    iput-object p1, p0, Lid/c;->J:Lid/o0;
...
.method public G()V
    ...
    invoke-super {p0}, Lid/l;->G()V

    iget-object v1, p0, Lid/c;->G:Landroid/os/HandlerThread;

    invoke-virtual {v1}, Ljava/lang/Thread;->start()V

    new-instance v1, Landroid/os/Handler;

    iget-object v3, p0, Lid/c;->G:Landroid/os/HandlerThread;
    ...
    iput-object v1, p0, Lid/c;->H:Landroid/os/Handler;
    ...
    iget-object p0, p0, Lid/l;->h:Landroid/os/HandlerThread;
...
.method public H()V
    ...
    invoke-super {p0}, Lid/l;->H()V

    iget-object v0, p0, Lid/c;->G:Landroid/os/HandlerThread;

    invoke-virtual {v0}, Landroid/os/HandlerThread;->quitSafely()Z

    iget-object v0, p0, Lid/c;->H:Landroid/os/Handler;
    ...
    iput-object v2, p0, Lid/c;->H:Landroid/os/Handler;

    :cond_0
    iget-object v0, p0, Lid/l;->l:Lid/i;

    if-eqz v0, :cond_1

    iput-object v2, p0, Lid/l;->l:Lid/i;

    :cond_1
    invoke-virtual {p0}, Lid/c;->N()V

    invoke-virtual {p0}, Lid/c;->O()V

    invoke-virtual {p0}, Lid/c;->z()V
...
.method public J()Z
    ...
    :try_start_0
    iget-object v2, p0, Lid/c;->I:Lcom/xiaomi/engine/TaskSession;
    ...
    invoke-virtual {p0, v3}, Lid/l;->D(I)V
...
.method public final M(Lid/n0;Ljava/lang/String;)V
    .locals 6
    .param p1    # Lid/n0;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-virtual {p0, p1}, Lid/c;->c0(Lid/n0;)V

    iget-object v0, p0, Lid/c;->F:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v0}, Ljava/util/concurrent/atomic/AtomicInteger;->getAndDecrement()I

    iget-object v0, p0, Lid/l;->j:Lid/l$a;

    if-eqz v0, :cond_0

    iget-wide v4, p1, Lid/n0;->a:J

    invoke-interface {v0, v4, v5}, Lid/l$a;->d(J)Lid/z;

    move-result-object v0

    if-eqz v0, :cond_0

    iget-object p0, p0, Lid/l;->j:Lid/l$a;

    iget-wide v4, p1, Lid/n0;->a:J

    invoke-interface {p0, v4, v5, p2}, Lid/l$a;->g(JLjava/lang/String;)V
...
.method public final N()V
    ...
    :try_start_0
    iget-object v1, p0, Lid/c;->I:Lcom/xiaomi/engine/TaskSession;

    const/4 v2, 0x0

    iput-object v2, p0, Lid/c;->I:Lcom/xiaomi/engine/TaskSession;
...
.method public final O()V
    ...
    :try_start_0
    iget-object v1, p0, Lid/c;->J:Lid/o0;

    const/4 v2, 0x0

    if-eqz v1, :cond_0

    invoke-virtual {v1}, Lid/o0;->b()Lcom/xiaomi/engine/TaskSession;
    ...
    :goto_0
    iput-object v2, p0, Lid/c;->J:Lid/o0;
...
.method public final P(ZJ)V
    ...
    :try_start_0
    iget-object p0, p0, Lid/c;->J:Lid/o0;

    if-eqz p0, :cond_0

    invoke-virtual {p0}, Lid/o0;->b()Lcom/xiaomi/engine/TaskSession;
    ...
    :cond_1
    iget-object p0, p0, Lid/c;->I:Lcom/xiaomi/engine/TaskSession;
...
.method public Q()Landroid/os/Handler;
    ...
    iget-object p0, p0, Lid/c;->H:Landroid/os/Handler;
...
.method public final T(Lid/m0;)V
    .locals 6
    .annotation build Lcom/android/camera/jacoco/JacocoForceIgnore;
    .end annotation
    ...
    invoke-virtual {p1}, Lid/m0;->c()Ljava/util/List;
    ...
    :cond_0
    invoke-virtual {p0, p1}, Lid/c;->W(Lid/m0;)V
    ...
    invoke-virtual {p0, v4}, Lid/c;->Z(Lid/e$a;)V
    ...
    :cond_1
    invoke-virtual {v1}, Lid/e$a;->e()Landroid/media/Image;
    ...
    invoke-virtual {p0, v5, p1}, Lid/l;->y(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;)Landroid/media/Image;

    move-result-object p1

    invoke-virtual {p0, v1}, Lid/c;->Z(Lid/e$a;)V

    new-instance v1, Lid/j;

    invoke-direct {v1, p1, v0, v2}, Lid/j;-><init>(Landroid/media/Image;IZ)V

    invoke-virtual {p0, v1}, Lid/l;->d(Lid/j;)V

    invoke-virtual {p0, v3, v4}, Lid/c;->V(J)V
...
.method public final U(Lid/m0;)V
    .locals 11
    ...
    iget-object v0, p0, Lid/l;->o:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    invoke-virtual {p1}, Lid/m0;->d()J

    move-result-wide v3

    invoke-virtual {p1}, Lid/m0;->a()Z
    ...
    invoke-direct {v1, v3, v4, v7, v8}, Lid/n0;-><init>(JJ)V

    invoke-virtual {v1, p1}, Lid/n0;->a(Lid/m0;)V

    iget-object v5, p0, Lid/c;->P:Landroid/util/LongSparseArray;
    ...
    iget-object v1, v1, Lid/n0;->c:Ljava/util/List;
...
.method public V(J)V
    ...
    iget-object p1, p0, Lid/l;->p:Ljava/util/LinkedList;
...
.method public W(Lid/m0;)V
    ...
    iget-object p0, p0, Lid/c;->F:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public abstract X(Lid/m0;)V
.end method

.method public final Y(Lid/m0;)V
    .locals 1

    sget-boolean v0, Lid/h0;->U:Z

    if-eqz v0, :cond_0

    invoke-virtual {p0, p1}, Lid/c;->T(Lid/m0;)V

    return-void

    :cond_0
    invoke-virtual {p0, p1}, Lid/c;->U(Lid/m0;)V

    invoke-virtual {p0, p1}, Lid/c;->X(Lid/m0;)V

    return-void
.end method

.method public final Z(Lid/e$a;)V
    .locals 3
    ...
    iget-object v1, p0, Lid/l;->j:Lid/l$a;

    invoke-virtual {p0, v0, v1}, Lid/c;->b0(Landroid/media/Image;Lid/l$a;)V
    ...
    invoke-virtual {p0, p1, v0}, Lid/c;->b0(Landroid/media/Image;Lid/l$a;)V
...
.method public a(J)V
    ...
    iget-object v1, p0, Lid/l;->o:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-object v2, p0, Lid/c;->P:Landroid/util/LongSparseArray;
    ...
    iget-object v6, p0, Lid/c;->P:Landroid/util/LongSparseArray;

    invoke-virtual {v6, v2}, Landroid/util/LongSparseArray;->valueAt(I)Ljava/lang/Object;

    move-result-object v6

    check-cast v6, Lid/n0;

    iget-wide v7, v6, Lid/n0;->b:J

    sub-long v7, p1, v7

    invoke-virtual {p0}, Lid/c;->R()J
    ...
    invoke-virtual {p0, p2, v0}, Lid/c;->M(Lid/n0;Ljava/lang/String;)V
...
.method public final a0()V
    ...
    iget-object v0, p0, Lid/c;->N:Landroid/media/ImageReader;
    ...
    iput-object v0, p0, Lid/c;->N:Landroid/media/ImageReader;

    :cond_0
    return-void
.end method

.method public b0(Landroid/media/Image;Lid/l$a;)V
    .locals 0
    ...
    invoke-interface {p2, p1}, Lid/l$a;->b(Landroid/media/Image;)V
...
.method public c(Lcom/xiaomi/engine/BufferFormat;)Ljava/util/List;
    ...
    iput-object p1, p0, Lid/c;->N:Landroid/media/ImageReader;
    ...
    iget-object p1, p0, Lid/c;->N:Landroid/media/ImageReader;

    new-instance v1, Lid/b;

    invoke-direct {v1, p0}, Lid/b;-><init>(Lid/c;)V

    invoke-virtual {p0}, Lid/c;->Q()Landroid/os/Handler;
    ...
    iget-object p0, p0, Lid/c;->N:Landroid/media/ImageReader;
...
.method public final c0(Lid/n0;)V
    .locals 2

    if-eqz p1, :cond_1

    iget-object p1, p1, Lid/n0;->c:Ljava/util/List;
...
.method public final d0()V
    ...
    iget-object v0, p0, Lid/l;->g:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lid/l;->i:Landroid/os/Handler;
...
.method public e(Lid/m0;)I
    ...
    :try_start_0
    iget-object v1, p0, Lid/l;->p:Ljava/util/LinkedList;
    ...
    invoke-virtual {p0, v2}, Lid/l;->C(Z)V

    iget-object v3, p0, Lid/c;->O:Ljava/lang/Object;

    monitor-enter v3

    :try_start_1
    iget-object v0, p0, Lid/c;->I:Lcom/xiaomi/engine/TaskSession;
...
.method public final e0()V
    ...
    iget-object p0, p0, Lid/l;->i:Landroid/os/Handler;
...
.method public g(J)V
    ...
    invoke-virtual {p0, v1, p1, p2}, Lid/c;->P(ZJ)V

    const/4 v0, 0x1

    invoke-virtual {p0, v0, p1, p2}, Lid/c;->P(ZJ)V
...
.method public k()Lcom/xiaomi/engine/TaskSession;
    ...
    iget-object v3, p0, Lid/c;->I:Lcom/xiaomi/engine/TaskSession;
...
.method public l()Lid/o0;
    ...
    iget-object v3, p0, Lid/c;->J:Lid/o0;
...
.method public u()Ljava/util/List;
    ...
    :try_start_0
    iput-object v1, p0, Lid/c;->I:Lcom/xiaomi/engine/TaskSession;

    iput-object v1, p0, Lid/c;->J:Lid/o0;
    ...
    :try_start_1
    iget-object v3, p0, Lid/c;->P:Landroid/util/LongSparseArray;
    ...
    iget-object v4, p0, Lid/c;->P:Landroid/util/LongSparseArray;

    invoke-virtual {v4, v3}, Landroid/util/LongSparseArray;->valueAt(I)Ljava/lang/Object;

    move-result-object v4

    check-cast v4, Lid/n0;

    iget-object v5, p0, Lid/c;->P:Landroid/util/LongSparseArray;

    invoke-virtual {v5, v3}, Landroid/util/LongSparseArray;->removeAt(I)V

    iget-wide v5, v4, Lid/n0;->a:J
    ...
    invoke-virtual {p0, v4}, Lid/c;->c0(Lid/n0;)V

    iget-object v5, p0, Lid/c;->F:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    :cond_0
    iget-object v3, p0, Lid/l;->p:Ljava/util/LinkedList;
    ...
    invoke-virtual {v4}, Lid/m0;->a()Z

    move-result v5

    if-eqz v5, :cond_1

    invoke-virtual {v4}, Lid/m0;->d()J
    ...
    :cond_1
    invoke-virtual {v4}, Lid/m0;->c()Ljava/util/List;
    ...
    invoke-virtual {p0, v6}, Lid/c;->Z(Lid/e$a;)V
...
.method public v(J)Z
    ...
    iget-object p2, p0, Lid/c;->P:Landroid/util/LongSparseArray;
    ...
    invoke-virtual {p0, p2, p1}, Lid/c;->M(Lid/n0;Ljava/lang/String;)V
...
.method public w(J)V
    ...
    :cond_0
    iget-object p1, p0, Lid/l;->i:Landroid/os/Handler;
...
.method public x()V
    ...
    invoke-virtual {p0, v0}, Lid/c;->Y(Lid/m0;)V
...
.method public z()V
    ...
    invoke-super {p0}, Lid/l;->z()V

    const/4 v0, 0x0

    iput-object v0, p0, Lid/l;->j:Lid/l$a;

    iget-object v1, p0, Lid/c;->K:Landroid/media/ImageReader;

    if-eqz v1, :cond_0

    invoke-virtual {v1}, Landroid/media/ImageReader;->close()V

    iput-object v0, p0, Lid/c;->K:Landroid/media/ImageReader;

    :cond_0
    iget-object v1, p0, Lid/c;->L:Landroid/media/ImageReader;

    if-eqz v1, :cond_1

    invoke-virtual {v1}, Landroid/media/ImageReader;->close()V

    iput-object v0, p0, Lid/c;->L:Landroid/media/ImageReader;

    :cond_1
    iget-object v1, p0, Lid/c;->M:Landroid/media/ImageReader;

    if-eqz v1, :cond_2

    invoke-virtual {v1}, Landroid/media/ImageReader;->close()V

    iput-object v0, p0, Lid/c;->M:Landroid/media/ImageReader;

    :cond_2
    invoke-virtual {p0}, Lid/c;->a0()V
