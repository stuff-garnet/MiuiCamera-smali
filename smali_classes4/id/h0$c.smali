...
.method public constructor <init>(Lid/h0;)V
    ...
    iput-object p1, p0, Lid/h0$c;->a:Lid/h0;
...
.method public a(Lid/e;)V
    ...
    invoke-virtual {p0, p1, v0}, Lid/h0$c;->d(Lid/e;Ljava/lang/String;)V
...
.method public c(Lid/e;)V
    ...
    iget-object v5, p0, Lid/h0$c;->a:Lid/h0;

    invoke-virtual {v5}, Lid/h0;->y0()Z
    ...
    :cond_0
    invoke-virtual {p1}, Lid/e;->n()Lid/e$a;

    move-result-object v5

    if-eqz v5, :cond_e

    iget-object v6, p0, Lid/h0$c;->a:Lid/h0;

    invoke-static {v6, v7, v8}, Lid/h0;->C(Lid/h0;J)Lid/z;

    move-result-object v6

    invoke-virtual {v5}, Lid/e$a;->g()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-virtual {v6, v9, v10}, Lid/z;->u1(J)V

    iget-object v11, p0, Lid/h0$c;->a:Lid/h0;

    invoke-static {v11, v7, v8}, Lid/h0;->J(Lid/h0;J)Lid/z;

    iget-object v11, p0, Lid/h0$c;->a:Lid/h0;

    invoke-static {v11, v9, v10, v6}, Lid/h0;->G(Lid/h0;JLid/z;)V

    :cond_1
    if-ne v1, v0, :cond_4

    iget-object v1, p0, Lid/h0$c;->a:Lid/h0;
    ...
    invoke-virtual {p1}, Lid/e;->l()Ljava/util/List;
    ...
    invoke-virtual {v0}, Lid/e$a;->g()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    iget-object v4, p0, Lid/h0$c;->a:Lid/h0;

    invoke-static {v4, v7, v8}, Lid/h0;->C(Lid/h0;J)Lid/z;

    move-result-object v4

    if-eqz v4, :cond_9

    invoke-virtual {v4, v1}, Lid/z;->I0(Lcom/xiaomi/protocol/ICustomCaptureResult;)V

    invoke-virtual {v4}, Lid/z;->s()Lid/a0;

    move-result-object v1

    invoke-virtual {v1}, Lid/a0;->Z0()Z
    ...
    invoke-virtual {v4}, Lid/z;->L()Lpk/b;
    ...
    invoke-direct/range {v0 .. v6}, Lid/m0;-><init>(Ljava/util/List;ZJZLpk/b;)V

    invoke-virtual {p1}, Lid/e;->c()I

    move-result v0

    invoke-virtual {p0, v0}, Lid/m0;->h(I)V
    ...
    iget-object v0, p1, Lid/l;->b:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-virtual {p1, p0}, Lid/l;->e(Lid/m0;)I

    goto/16 :goto_1

    :cond_8
    iget-object p1, p0, Lid/h0$c;->a:Lid/h0;

    invoke-static {p1}, Lid/h0;->g(Lid/h0;)Lid/l$a;

    move-result-object p1

    invoke-interface {p1, v7, v8, v3}, Lid/l$a;->c(JI)V
    ...
    invoke-interface {p1, v0, v3, v3}, Lid/l$a;->f(Landroid/media/Image;IZ)V

    invoke-virtual {v0}, Landroid/media/Image;->close()V

    invoke-virtual {p0, v0}, Lid/h0$c;->b(Landroid/media/Image;)V
    ...
    :cond_a
    iget-object v0, p0, Lid/h0$c;->a:Lid/h0;

    invoke-static {v0, v7, v8}, Lid/h0;->C(Lid/h0;J)Lid/z;
    ...
    invoke-virtual {v5}, Lid/e$a;->e()Landroid/media/Image;

    move-result-object v1

    invoke-virtual {v0, v6}, Lid/z;->I0(Lcom/xiaomi/protocol/ICustomCaptureResult;)V
    ...
    invoke-static {v5, v1, v4}, Ldd/d;->l(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;I)Landroid/media/Image;
    ...
    invoke-direct {v5, v4, v3, v6}, Lid/j;-><init>(Landroid/media/Image;IZ)V

    invoke-virtual {v0, v5}, Lid/l;->d(Lid/j;)V
    ...
    :cond_b
    invoke-virtual {p0, v1}, Lid/h0$c;->b(Landroid/media/Image;)V

    goto :goto_1

    :cond_c
    invoke-virtual {p0, p1, v1}, Lid/h0$c;->d(Lid/e;Ljava/lang/String;)V
...
.method public final d(Lid/e;Ljava/lang/String;)V
    .locals 13
    .param p1    # Lid/e;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-virtual {v7}, Lid/e$a;->p()Z

    move-result v9

    if-eqz v9, :cond_2

    invoke-virtual {v7}, Lid/e$a;->g()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-static {v5, v9, v10}, Lid/h0;->C(Lid/h0;J)Lid/z;
    ...
    iget-object v7, p0, Lid/h0$c;->a:Lid/h0;

    invoke-virtual {p1}, Lid/e;->b()I

    move-result v9

    invoke-static {v7, p1, v9}, Lid/h0;->x(Lid/h0;Lid/e;I)Lcom/xiaomi/protocol/ICustomCaptureResult;

    move-result-object v7

    invoke-virtual {v5, v7}, Lid/z;->I0(Lcom/xiaomi/protocol/ICustomCaptureResult;)V
    ...
    invoke-static {v7, v10, v11}, Lid/h0;->C(Lid/h0;J)Lid/z;
    ...
    iget-object v8, p0, Lid/h0$c;->a:Lid/h0;

    invoke-virtual {p1}, Lid/e;->b()I

    move-result v9

    invoke-static {v8, p1, v9}, Lid/h0;->x(Lid/h0;Lid/e;I)Lcom/xiaomi/protocol/ICustomCaptureResult;

    move-result-object v8

    invoke-virtual {v7, v8}, Lid/z;->I0(Lcom/xiaomi/protocol/ICustomCaptureResult;)V
    ...
    invoke-static {v0, p2, p0}, Lid/h0;->I(Lid/h0;Lid/e$a;Lid/f;)V
    ...
    invoke-virtual {v0}, Lid/m0;->a()Z

    move-result v5

    if-eqz v5, :cond_9

    iget-object v5, v4, Lid/l;->b:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v5}, Ljava/util/concurrent/atomic/AtomicInteger;->getAndIncrement()I

    :cond_9
    iget-object p0, p0, Lid/h0$c;->a:Lid/h0;
    ...
    invoke-virtual {v0, v2}, Lid/m0;->i(I)V

    :cond_b
    if-eqz v4, :cond_c

    invoke-virtual {v4, v0}, Lid/l;->e(Lid/m0;)I
