...
.method public constructor <init>(Lid/h0;)V
    ...
    iput-object p1, p0, Lid/h0$f;->a:Lid/h0;
...
# virtual methods
.method public final a(Lid/z;J)V
    .locals 11
    ...
    invoke-virtual {p1, v0}, Lid/z;->j1(I)V
    ...
    invoke-virtual {v0, p2}, Lid/e;->D(I)V

    iget-object p0, p0, Lid/h0$f;->a:Lid/h0;

    invoke-static {p0}, Lid/h0;->s(Lid/h0;)Lid/t$e;

    move-result-object p0

    invoke-virtual {v0, p0}, Lid/e;->H(Lid/t$e;)V

    const/4 p0, 0x1

    invoke-virtual {v0, p0}, Lid/e;->Q(Z)V

    invoke-virtual {v0, p0}, Lid/e;->L(Z)V

    invoke-static {}, Lid/t;->w()Lid/t;

    move-result-object p2

    invoke-virtual {p2, v0}, Lid/t;->G(Lid/e;)V
    ...
    invoke-virtual {p2, p1, p0}, Lid/t;->B(Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V
...
.method public onEarlyMetaAvailable(Lcom/xiaomi/camera/isp/ISPResult;)V
    ...
    iget-object v0, p0, Lid/h0$f;->a:Lid/h0;

    invoke-static {v0}, Lid/h0;->m(Lid/h0;)Ljava/lang/ref/WeakReference;
    ...
    invoke-static {p0}, Lid/h0;->m(Lid/h0;)Ljava/lang/ref/WeakReference;
    ...
    invoke-interface {p0, v0, v1, p1}, Lid/k;->a(ILjava/lang/String;Ljava/lang/Object;)V
...
.method public onError(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p2, v3}, Ldd/e;->d(II)V

    iget-object p1, p0, Lid/h0$f;->a:Lid/h0;

    invoke-static {p1, v1, v2}, Lid/h0;->C(Lid/h0;J)Lid/z;

    move-result-object p1

    if-eqz p1, :cond_0

    iget-object v3, p0, Lid/h0$f;->a:Lid/h0;

    invoke-virtual {p1}, Lid/z;->P()Landroid/media/Image;

    move-result-object v4

    invoke-static {v3, v4}, Lid/h0;->y(Lid/h0;Landroid/media/Image;)V

    invoke-virtual {p1}, Lid/z;->v0()V

    iget-object p1, p0, Lid/h0$f;->a:Lid/h0;

    invoke-static {p1, v1, v2}, Lid/h0;->J(Lid/h0;J)Lid/z;
...
.method public onJpegAvailable([BLjava/lang/String;)V
    ...
    iget-object v4, p0, Lid/h0$f;->a:Lid/h0;

    invoke-static {v4, v1, v2}, Lid/h0;->C(Lid/h0;J)Lid/z;
    ...
    invoke-virtual {v4, p1, p2}, Lid/z;->a([BI)V

    const-string p2, "JPEG"

    invoke-virtual {v4, p2}, Lid/z;->b0(Ljava/lang/String;)Z
    ...
    :cond_1
    iget-object p2, p0, Lid/h0$f;->a:Lid/h0;

    invoke-static {p2}, Lid/h0;->o(Lid/h0;)Ljava/lang/Object;
    ...
    :try_start_0
    iget-object v5, p0, Lid/h0$f;->a:Lid/h0;

    invoke-static {v5}, Lid/h0;->k(Lid/h0;)Ljava/util/HashMap;
    ...
    invoke-static {v5, v1, v2}, Lid/h0;->J(Lid/h0;J)Lid/z;
    ...
    invoke-virtual {v4, p2}, Lid/z;->X0(Z)V

    invoke-virtual {v4}, Lid/z;->l()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-static {p1}, Lid/h0;->h(Lid/h0;)La8/i;

    move-result-object p1

    const/4 v5, 0x0

    invoke-virtual {p1, v4, p2, v5, v5}, La8/i;->m(Lid/z;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)Z

    move-result p1

    iget-object p2, p0, Lid/h0$f;->a:Lid/h0;

    invoke-virtual {v4}, Lid/z;->P()Landroid/media/Image;

    move-result-object v5

    invoke-static {p2, v5}, Lid/h0;->y(Lid/h0;Landroid/media/Image;)V

    if-eqz p1, :cond_3

    invoke-virtual {v4}, Lid/z;->v0()V

    :cond_3
    iget-object p1, p0, Lid/h0$f;->a:Lid/h0;

    invoke-static {p1, v4}, Lid/h0;->D(Lid/h0;Lid/z;)Z
    ...
    invoke-interface {p1, v4}, Lid/h0$j;->b(Lid/z;)V
    ...
    invoke-static {p1, v4, p2}, Lid/h0;->E(Lid/h0;Lid/z;I)Z
...
.method public onJpegImageAvailable(Landroid/media/Image;Ljava/lang/String;Z)V
    ...
    invoke-static {p1}, Lcom/android/camera/o6;->i1(Landroid/media/Image;)[B

    move-result-object v7

    :cond_1
    invoke-virtual {v4, v7, p2}, Lid/z;->a([BI)V
    ...
    invoke-virtual {v4, p1}, Lid/z;->O0([B)V

    invoke-virtual {v4}, Lid/z;->s()Lid/a0;

    move-result-object p2

    invoke-virtual {p2}, Lid/a0;->r0()Landroid/util/Size;
    ...
    invoke-virtual {v4, v6}, Lid/z;->L0(Landroid/graphics/Rect;)V

    sget-boolean p2, Lcom/android/camera/o6;->u0:Z

    if-eqz p2, :cond_2

    invoke-virtual {v4}, Lid/z;->M()Ljava/lang/String;
    ...
    invoke-static {p1, p2}, Lcom/android/camera/o6;->x4([BLjava/lang/String;)V

    :cond_2
    const-string p1, "JPEG"

    invoke-virtual {v4, p1}, Lid/z;->b0(Ljava/lang/String;)Z
    ...
    iget-object p3, p0, Lid/h0$f;->a:Lid/h0;

    invoke-static {p3}, Lid/h0;->h(Lid/h0;)La8/i;

    move-result-object p3

    invoke-virtual {p3, v4, p2, v7, p1}, La8/i;->m(Lid/z;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)Z
    ...
    invoke-virtual {p1, v4, p2, v7, v7}, La8/i;->m(Lid/z;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)Z
...
.method public onTuningImageAvailable(Landroid/media/Image;Ljava/lang/String;Z)V
    ...
    invoke-static {v0, v1, v2}, Lid/h0;->C(Lid/h0;J)Lid/z;
    ...
    invoke-virtual {p0, v5, v1, v2}, Lid/h0$f;->a(Lid/z;J)V
    ...
    invoke-virtual {p0, p1, p2, v3, p3}, Lid/t;->A(Landroid/media/Image;IIZ)V
    ...
    invoke-static/range {v4 .. v9}, Lid/h0;->H(Lid/h0;Lid/z;Landroid/media/Image;Ljava/lang/String;IZ)V
...
.method public onYuvAvailable(Landroid/media/Image;Ljava/lang/String;Z)V
    ...
    invoke-virtual {v6}, Lid/z;->e()I

    move-result v4

    invoke-static {v4}, Ldd/c;->d(I)Z

    move-result v4

    if-nez v4, :cond_2

    invoke-virtual {v6}, Lid/z;->j0()Z

    move-result p2

    if-nez p2, :cond_1

    invoke-virtual {p0, v6, v1, v2}, Lid/h0$f;->a(Lid/z;J)V
    ...
    invoke-virtual {p0, p1, v0, v3, p3}, Lid/t;->A(Landroid/media/Image;IIZ)V
    ...
    invoke-static/range {v5 .. v10}, Lid/h0;->H(Lid/h0;Lid/z;Landroid/media/Image;Ljava/lang/String;IZ)V
