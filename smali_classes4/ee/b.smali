...
.method public a(Lid/e;Lee/d;Lcom/xiaomi/engine/TaskSession;)V
    ...
    invoke-direct/range {v4 .. v9}, Lid/e$a;-><init>(IZLpk/b;ZZ)V
    ...
    invoke-static {v4, v0}, Ldd/e;->b(Ljava/lang/String;I)V
    ...
    invoke-virtual {v7}, Lid/e$a;->e()Landroid/media/Image;
    ...
    :cond_3
    invoke-static {v4, v10}, Ldd/e;->b(Ljava/lang/String;I)V
    ...
    :goto_2
    invoke-virtual {v3, v6, v0, v0}, Lid/e$a;->B(Landroid/media/Image;IZ)V
    ...
    invoke-interface {v6, v11}, Lid/f;->b(Landroid/media/Image;)V

    invoke-virtual {v8}, Lid/e$a;->k()Landroid/media/Image;
    ...
    invoke-interface {v6, v8}, Lid/f;->b(Landroid/media/Image;)V
    ...
    invoke-interface {v6, v1}, Lid/f;->b(Landroid/media/Image;)V

    invoke-virtual {v3, v5, v10}, Lid/e$a;->x(Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V
    ...
    invoke-virtual {v4}, Lid/e$a;->m()Landroid/media/Image;

    move-result-object v1

    invoke-virtual {v4}, Lid/e$a;->v()Z

    move-result v5

    invoke-virtual {v3, v1, v9, v5}, Lid/e$a;->B(Landroid/media/Image;IZ)V
    ...
    invoke-virtual {v3, v1, v10, v0}, Lid/e$a;->B(Landroid/media/Image;IZ)V

    :cond_9
    invoke-virtual {v3}, Lid/e$a;->o()Z
    ...
    invoke-virtual {v1, v4, v3, v5}, Lee/b;->b(Lid/e;Lid/e$a;Lee/d;)V
