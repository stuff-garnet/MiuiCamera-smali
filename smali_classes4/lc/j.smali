...
.method public constructor <init>(Llc/e;)V
    ...
    iput-object v0, p0, Llc/j;->f:Ljava/util/Map;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArraySet;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArraySet;-><init>()V

    iput-object v0, p0, Llc/j;->g:Ljava/util/Set;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Llc/j;->h:Ljava/util/Map;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Llc/j;->i:Ljava/util/Map;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArraySet;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArraySet;-><init>()V

    iput-object v0, p0, Llc/j;->j:Ljava/util/Set;

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Llc/j;->k:J

    const/4 v2, 0x0

    iput-boolean v2, p0, Llc/j;->l:Z

    iput-wide v0, p0, Llc/j;->m:J

    iput-boolean v2, p0, Llc/j;->n:Z

    iput-object p1, p0, Llc/j;->c:Llc/e;

    new-instance v0, Lpc/b;

    invoke-direct {v0, p1}, Lpc/b;-><init>(Llc/e;)V

    iput-object v0, p0, Llc/j;->d:Lyc/b;
    ...
    iget-object v1, p0, Llc/j;->c:Llc/e;

    iget-object v2, p0, Llc/j;->d:Lyc/b;

    invoke-direct {v0, v1, v2, p1}, Lpc/e;-><init>(Llc/e;Lyc/b;Lpc/c$d;)V

    iput-object v0, p0, Llc/j;->e:Lpc/e;

    iget-object p1, p0, Llc/j;->c:Llc/e;
    ...
    iput-object p1, p0, Llc/j;->a:Landroid/os/HandlerThread;

    invoke-virtual {p1}, Ljava/lang/Thread;->start()V

    new-instance p1, Landroid/os/Handler;

    iget-object v0, p0, Llc/j;->a:Landroid/os/HandlerThread;

    invoke-virtual {v0}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v0

    new-instance v1, Llc/j$b;

    invoke-direct {v1, p0}, Llc/j$b;-><init>(Llc/j;)V

    invoke-direct {p1, v0, v1}, Landroid/os/Handler;-><init>(Landroid/os/Looper;Landroid/os/Handler$Callback;)V

    iput-object p1, p0, Llc/j;->b:Landroid/os/Handler;
...
.method public static synthetic D(Llc/j;)V
    .locals 0

    invoke-virtual {p0}, Llc/j;->K()V

    return-void
.end method

.method public static synthetic G(Llc/j;)V
    .locals 0

    invoke-virtual {p0}, Llc/j;->M()V

    return-void
.end method

.method public static synthetic a(Llc/j;)Ljava/util/Set;
    .locals 0

    iget-object p0, p0, Llc/j;->g:Ljava/util/Set;

    return-object p0
.end method

.method public static synthetic g(Llc/j;Lcom/fasterxml/jackson/databind/node/u;)V
    .locals 0

    invoke-virtual {p0, p1}, Llc/j;->q(Lcom/fasterxml/jackson/databind/node/u;)V

    return-void
.end method

.method public static synthetic h(Llc/j;Ljava/lang/String;)V
    .locals 0

    invoke-virtual {p0, p1}, Llc/j;->r(Ljava/lang/String;)V

    return-void
.end method

.method public static synthetic i(Llc/j;Z)V
    .locals 0

    invoke-virtual {p0, p1}, Llc/j;->v(Z)V

    return-void
.end method

.method public static synthetic o(Llc/j;)Ljava/util/Map;
    .locals 0

    iget-object p0, p0, Llc/j;->f:Ljava/util/Map;

    return-object p0
.end method

.method public static synthetic y(Llc/j;)V
    .locals 0

    invoke-virtual {p0}, Llc/j;->L()V
...
# virtual methods
.method public A(Ltc/i;)V
    .locals 2

    iget-object v0, p0, Llc/j;->c:Llc/e;
    ...
    invoke-virtual {p0, p1}, Llc/j;->J(Ltc/i;)V
...
.method public B()V
    ...
    invoke-static {v0}, Luc/f;->b(Ljava/lang/String;)Z
    ...
    :cond_0
    invoke-virtual {p0, v0}, Llc/j;->x(Ljava/lang/String;)V
...
.method public final C(Ljava/lang/String;)V
    ...
    invoke-static {p1}, Luc/f;->b(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v0}, Lyc/a;->e(Ljava/lang/String;)J
    ...
    invoke-static {v2, p1, v1}, Lxc/a;->c(Ljava/lang/String;Ljava/lang/String;Z)V

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v1

    invoke-virtual {p0, v0, v1, v2}, Lyc/a;->k(Ljava/lang/String;J)V

    :cond_1
    return-void
.end method

.method public final E(Ltc/i;)V
    .locals 7
    ...
    :cond_0
    iget-object v1, p0, Llc/j;->f:Ljava/util/Map;
    ...
    invoke-virtual {v2}, Ltc/k;->j()Lkf/a;
    ...
    invoke-static {v4, v3}, Lxc/a;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v2}, Lkf/a;->b()Ljava/lang/Object;
    ...
    invoke-static {v4, p0}, Lxc/a;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0}, Lcom/xiaomi/ai/api/r0$m;->h()Lkf/a;

    move-result-object v5

    invoke-virtual {v5}, Lkf/a;->c()Z
    ...
    invoke-virtual {v1, v0, v5, v6}, Lyc/a;->k(Ljava/lang/String;J)V

    invoke-static {v2}, Luc/f;->b(Ljava/lang/String;)Z

    move-result v0

    if-nez v0, :cond_d

    iput-object v2, p0, Llc/j;->p:Ljava/lang/String;

    :cond_d
    const-string v0, "v5.sdk.asr.recv.first.partial.out"

    invoke-virtual {v1, v0}, Lyc/a;->e(Ljava/lang/String;)J
    ...
    iget-object v0, p0, Llc/j;->i:Ljava/util/Map;
    ...
    invoke-virtual {v1, v0, v3, v4}, Lyc/a;->k(Ljava/lang/String;J)V
    ...
    invoke-virtual {v1, p1, v3, v4}, Lyc/a;->k(Ljava/lang/String;J)V

    iget-object p1, p0, Llc/j;->i:Ljava/util/Map;
    ...
    :cond_12
    iget-object p1, p0, Llc/j;->p:Ljava/lang/String;
    ...
    iget-object v0, p0, Llc/j;->p:Ljava/lang/String;
    ...
    iget-object p0, p0, Llc/j;->i:Ljava/util/Map;
    ...
    invoke-virtual {v1, p1, v2, v3}, Lyc/a;->k(Ljava/lang/String;J)V
    ...
    invoke-virtual {v1, p0, v3, v4}, Lyc/a;->k(Ljava/lang/String;J)V
    ...
    invoke-virtual {v1, p1, p0}, Lyc/a;->j(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0}, Lcom/xiaomi/ai/api/t0$c;->e()Lkf/a;
    ...
    invoke-virtual {v1, p0}, Lyc/a;->e(Ljava/lang/String;)J
    ...
    invoke-virtual {v1, p0, v2, v3}, Lyc/a;->k(Ljava/lang/String;J)V
...
.method public F()V
    ...
    :cond_0
    invoke-virtual {p0, v0}, Llc/j;->C(Ljava/lang/String;)V

    :cond_1
    return-void
.end method

.method public final H(Ltc/i;)V
    .locals 4
    ...
    invoke-virtual {p0, p1}, Lyc/a;->e(Ljava/lang/String;)J
    ...
    invoke-virtual {p0, p1, v0, v1}, Lyc/a;->k(Ljava/lang/String;J)V
...
.method public I()Lyc/b;
    .locals 0

    iget-object p0, p0, Llc/j;->d:Lyc/b;
...
.method public final J(Ltc/i;)V
    ...
    invoke-virtual {v1}, Ltc/k;->j()Lkf/a;
    ...
    iget-object v3, p0, Llc/j;->j:Ljava/util/Set;
    ...
    iget-object v3, p0, Llc/j;->f:Ljava/util/Map;
    ...
    invoke-static {v2, v4}, Lxc/a;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v2, v3}, Lxc/a;->b(Ljava/lang/String;Ljava/lang/String;)V

    new-instance v3, Lyc/a;

    iget-object v4, p0, Llc/j;->d:Lyc/b;

    invoke-direct {v3, v4}, Lyc/a;-><init>(Lyc/b;)V

    iget-object v4, p0, Llc/j;->f:Ljava/util/Map;
    ...
    invoke-virtual {p0, p1, v3}, Llc/j;->m(Ltc/i;Lyc/a;)V
    ...
    invoke-static {v2, v4, v5}, Lxc/a;->c(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    invoke-virtual {v3, v2, v4, v5}, Lyc/a;->k(Ljava/lang/String;J)V
    ...
    iput-object v1, p0, Llc/j;->o:Ljava/lang/String;

    :cond_d
    const-string v2, "v5.sdk.asr.recv.first.partial.in"

    invoke-virtual {v3, v2}, Lyc/a;->e(Ljava/lang/String;)J
    ...
    iget-object v2, p0, Llc/j;->h:Ljava/util/Map;
    ...
    invoke-virtual {v3, p1, v4, v5}, Lyc/a;->k(Ljava/lang/String;J)V

    invoke-virtual {v0}, Lcom/xiaomi/ai/api/r0$m;->b()Lkf/a;
    ...
    :cond_12
    invoke-virtual {v0}, Lcom/xiaomi/ai/api/r0$m;->d()Lkf/a;
    ...
    iget-object p1, p0, Llc/j;->h:Ljava/util/Map;
    ...
    :cond_14
    iget-object p1, p0, Llc/j;->o:Ljava/lang/String;
    ...
    iget-object v0, p0, Llc/j;->o:Ljava/lang/String;
    ...
    invoke-virtual {v3, v0, v4, v5}, Lyc/a;->k(Ljava/lang/String;J)V
    ...
    iget-object p0, p0, Llc/j;->h:Ljava/util/Map;
    ...
    invoke-virtual {v3, p1, v0, v1}, Lyc/a;->k(Ljava/lang/String;J)V
    ...
    iget-object p0, p0, Llc/j;->j:Ljava/util/Set;
    ...
    invoke-static {v2, p0}, Lxc/a;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v3, p0}, Lyc/a;->e(Ljava/lang/String;)J
    ...
    invoke-virtual {v3, p0, v0, v1}, Lyc/a;->k(Ljava/lang/String;J)V
...
.method public final K()V
    ...
    invoke-virtual {p0, v0}, Llc/j;->v(Z)V

    const/4 v0, 0x0

    iput-object v0, p0, Llc/j;->e:Lpc/e;

    iget-object v1, p0, Llc/j;->b:Landroid/os/Handler;

    invoke-virtual {v1, v0}, Landroid/os/Handler;->removeCallbacksAndMessages(Ljava/lang/Object;)V

    iget-object p0, p0, Llc/j;->a:Landroid/os/HandlerThread;
...
.method public final L()V
    ...
    iget-object p0, p0, Llc/j;->e:Lpc/e;
...
.method public b()V
    ...
    iget-object p0, p0, Llc/j;->b:Landroid/os/Handler;
...
.method public d(Ljava/lang/String;)V
    ...
    :cond_0
    iget-object v0, p0, Llc/j;->f:Ljava/util/Map;
    ...
    invoke-virtual {p1, v0}, Lyc/a;->e(Ljava/lang/String;)J
    ...
    invoke-virtual {p1, p0}, Lyc/a;->e(Ljava/lang/String;)J
    ...
    invoke-virtual {p1, p0, v0, v1}, Lyc/a;->k(Ljava/lang/String;J)V
    ...
    invoke-virtual {p1, v0, v4, v5}, Lyc/a;->k(Ljava/lang/String;J)V

    iget-wide v0, p0, Llc/j;->m:J
    ...
    iput-wide v2, p0, Llc/j;->m:J

    iget-boolean v2, p0, Llc/j;->n:Z
    ...
    :goto_2
    invoke-virtual {p1, v2}, Lyc/a;->e(Ljava/lang/String;)J
    ...
    invoke-virtual {p1, v2, v0, v1}, Lyc/a;->k(Ljava/lang/String;J)V

    :cond_7
    const/4 p1, 0x0

    iput-boolean p1, p0, Llc/j;->n:Z
...
.method public e(Ljava/lang/String;J)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Lyc/a;->k(Ljava/lang/String;J)V
...
.method public f(Ljava/lang/String;Z)V
    ...
    invoke-virtual {p0, p1, p2}, Llc/j;->s(Ljava/lang/String;Z)V

    :cond_0
    return-void
.end method

.method public j(Ltc/f;)V
    .locals 3
    ...
    invoke-static {v2, v0, v1}, Lxc/a;->c(Ljava/lang/String;Ljava/lang/String;Z)V

    invoke-virtual {p0, p1}, Llc/j;->z(Ltc/f;)V

    :cond_0
    return-void
.end method

.method public final k(Ltc/f;Lyc/a;)V
    .locals 5
    ...
    invoke-virtual {p2, v1, v0}, Lyc/a;->j(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p2, v1, v0}, Lyc/a;->i(Ljava/lang/String;I)V
    ...
    invoke-virtual {p2, v3, v2}, Lyc/a;->j(Ljava/lang/String;Ljava/lang/String;)V

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v2

    invoke-virtual {p2, v1, v2, v3}, Lyc/a;->k(Ljava/lang/String;J)V

    const-wide/16 p1, 0x0

    iput-wide p1, p0, Llc/j;->k:J

    iput-wide p1, p0, Llc/j;->m:J

    const/4 p1, 0x0

    iput-boolean p1, p0, Llc/j;->l:Z
    ...
    iput-object p1, p0, Llc/j;->o:Ljava/lang/String;

    iput-object p1, p0, Llc/j;->p:Ljava/lang/String;
    ...
    invoke-virtual {p2, v3, p0}, Lyc/a;->j(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p2, p0, v0, v1}, Lyc/a;->k(Ljava/lang/String;J)V
...
.method public l(Ltc/i;)V
    ...
    invoke-virtual {p0, p1}, Llc/j;->E(Ltc/i;)V

    :cond_0
    return-void
.end method

.method public final m(Ltc/i;Lyc/a;)V
    .locals 2
    ...
    iget-object p0, p0, Llc/j;->c:Llc/e;
    ...
    invoke-virtual {p2, v0, p0}, Lyc/a;->i(Ljava/lang/String;I)V
    ...
    invoke-virtual {p2, v0, p0}, Lyc/a;->j(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0}, Ltc/k;->j()Lkf/a;
    ...
    invoke-virtual {p2, p0, p1}, Lyc/a;->j(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final q(Lcom/fasterxml/jackson/databind/node/u;)V
    ...
    iget-object v0, p0, Llc/j;->d:Lyc/b;

    invoke-virtual {v0}, Lyc/b;->a()Lyc/a;
    ...
    invoke-static {v2, v1}, Lxc/a;->h(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v1, p0, Llc/j;->d:Lyc/b;

    invoke-virtual {v1}, Lyc/b;->a()Lyc/a;

    move-result-object v1

    const-string v3, "request.id"

    invoke-virtual {v1, v3, v0}, Lyc/a;->j(Ljava/lang/String;Ljava/lang/String;)V

    :cond_1
    move-object v0, v1

    invoke-virtual {v0}, Lyc/a;->b()V

    :goto_0
    invoke-virtual {v0, p1}, Lyc/a;->h(Lcom/fasterxml/jackson/databind/node/u;)V
    ...
    invoke-static {v2, p1}, Lxc/a;->b(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final r(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Llc/j;->g:Ljava/util/Set;
    ...
    invoke-static {v1, p1}, Lxc/a;->e(Ljava/lang/String;Ljava/lang/String;)V

    const/4 p1, 0x1

    invoke-virtual {p0, p1}, Llc/j;->n(Z)V
...
.method public final s(Ljava/lang/String;Z)V
    ...
    iput-wide v2, p0, Llc/j;->k:J

    iget-boolean p2, p0, Llc/j;->l:Z
    ...
    :goto_2
    invoke-virtual {p1, p2}, Lyc/a;->e(Ljava/lang/String;)J
    ...
    invoke-virtual {p1, p2, v0, v1}, Lyc/a;->k(Ljava/lang/String;J)V
...
.method public t(Ltc/f;)V
    ...
    invoke-virtual {v0, p0, v1, v2}, Lyc/a;->k(Ljava/lang/String;J)V
...
.method public u(Ltc/i;)V
    ...
    invoke-virtual {p0, p1}, Llc/j;->H(Ltc/i;)V
...
.method public final v(Z)V
    ...
    invoke-virtual {p0, p1}, Lpc/c;->e(Z)Z
...
.method public final z(Ltc/f;)V
    ...
    invoke-virtual {v0, p1}, Llc/f;->f(Ltc/f;)Z
    ...
    invoke-direct {v0, v1}, Lyc/a;-><init>(Lyc/b;)V
    ...
    :cond_0
    invoke-virtual {p0, p1, v0}, Llc/j;->k(Ltc/f;Lyc/a;)V

    iget-object v0, p0, Llc/j;->b:Landroid/os/Handler;
    ...
    invoke-virtual {p0}, Llc/e;->J()Lcom/xiaomi/ai/core/a;
