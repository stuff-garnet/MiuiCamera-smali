...
.method public constructor <init>(Llc/e;Landroid/os/Looper;)V
    ...
    iput-object p2, p0, Llc/k;->f:Ljava/util/LinkedList;

    iput-object p1, p0, Llc/k;->a:Llc/e;
    ...
    iput-object v0, p0, Llc/k;->e:Ljava/lang/String;
    ...
    invoke-direct {v0, p1}, Lcom/xiaomi/ai/android/codec/AudioEncoder;-><init>(Llc/a;)V

    iput-object v0, p0, Llc/k;->b:Lcom/xiaomi/ai/android/codec/AudioEncoder;
    ...
    iget-object p1, p0, Llc/k;->b:Lcom/xiaomi/ai/android/codec/AudioEncoder;

    invoke-virtual {p1}, Lcom/xiaomi/ai/android/codec/AudioEncoder;->d()V

    const/4 p1, 0x0

    iput-object p1, p0, Llc/k;->b:Lcom/xiaomi/ai/android/codec/AudioEncoder;
    ...
    iput-object p1, p0, Llc/k;->c:Lrc/a;
...
.method public a()V
    ...
    :try_start_0
    iget-object v0, p0, Llc/k;->f:Ljava/util/LinkedList;
    ...
    iget-object v2, p0, Llc/k;->f:Ljava/util/LinkedList;
...
.method public b(Landroid/os/Message;)V
    ...
    iget-object v0, p0, Llc/k;->a:Llc/e;

    invoke-virtual {v0}, Llc/e;->R()Llc/h;
    ...
    invoke-virtual {v0, v1}, Llc/h;->d(Ltc/f;)V
...
.method public final c([BZ)V
    ...
    :cond_2
    iget-object v1, p0, Llc/k;->b:Lcom/xiaomi/ai/android/codec/AudioEncoder;

    invoke-virtual {v1, p1, p2}, Lcom/xiaomi/ai/android/codec/AudioEncoder;->a([BZ)I

    move-result p1

    iget-object p2, p0, Llc/k;->b:Lcom/xiaomi/ai/android/codec/AudioEncoder;

    invoke-virtual {p2}, Lcom/xiaomi/ai/android/codec/AudioEncoder;->c()[B

    move-result-object p2

    iget-object v1, p0, Llc/k;->a:Llc/e;

    invoke-virtual {v1}, Llc/e;->O()Lcom/xiaomi/ai/core/b;
    ...
    iget-object p0, p0, Llc/k;->a:Llc/e;
    ...
    invoke-virtual {v0, p0}, Llc/j;->d(Ljava/lang/String;)V
...
.method public final f()V
    ...
    iget-object v1, p0, Llc/k;->f:Ljava/util/LinkedList;
    ...
    :cond_0
    iget-object p0, p0, Llc/k;->f:Ljava/util/LinkedList;
...
.method public final g()V
    ...
    invoke-virtual {v0}, Ltc/m;->a()Ljava/lang/String;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    :cond_1
    iget-object p1, p0, Llc/k;->a:Llc/e;
    ...
    invoke-virtual {p1, v0}, Llc/e;->G(Lwc/a;)V
    ...
    invoke-virtual {p0}, Llc/e;->P()Llc/b;

    move-result-object p0

    const/4 p1, 0x0

    invoke-virtual {p0, p1}, Llc/b;->z(Z)V
    ...
    iget-object v5, p0, Llc/k;->b:Lcom/xiaomi/ai/android/codec/AudioEncoder;
    ...
    invoke-virtual {p0, v2, p1}, Llc/k;->c([BZ)V
    ...
    iget-object v4, p0, Llc/k;->a:Llc/e;

    invoke-virtual {v4}, Llc/e;->M()Llc/f;

    move-result-object v4

    invoke-virtual {v4}, Llc/f;->g()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {p1, v4}, Llc/j;->d(Ljava/lang/String;)V
    ...
    :goto_1
    iget-object p1, p0, Llc/k;->c:Lrc/a;

    if-eqz p1, :cond_c

    if-eqz v2, :cond_c

    invoke-interface {p1, v2}, Lrc/a;->a([B)Z
    ...
    invoke-static {p1}, Ltc/a;->e(Ltc/l;)Ltc/i;
    ...
    invoke-virtual {v1}, Llc/f;->g()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Ltc/k;->l(Ljava/lang/String;)Ltc/k;
    ...
    invoke-virtual {v0, p1}, Llc/j;->A(Ltc/i;)V

    iget-object v0, p0, Llc/k;->a:Llc/e;

    invoke-virtual {v0}, Llc/e;->L()Llc/d;
    ...
    iget-object p0, p0, Llc/k;->c:Lrc/a;

    invoke-interface {p0}, Lrc/a;->release()V
    ...
    iget-object v2, p0, Llc/k;->c:Lrc/a;

    invoke-interface {v2}, Lrc/a;->release()V

    iget-object v2, p0, Llc/k;->c:Lrc/a;

    invoke-interface {v2}, Lrc/a;->init()Z

    :cond_8
    iget-object v2, p0, Llc/k;->b:Lcom/xiaomi/ai/android/codec/AudioEncoder;

    const-string v4, "SpeechRecognizer.RecognizeStreamFinished"

    if-eqz v2, :cond_a

    iget-object v2, p0, Llc/k;->e:Ljava/lang/String;
    ...
    invoke-virtual {p0, v1, v3}, Llc/k;->c([BZ)V
    ...
    invoke-virtual {v1, p1}, Llc/j;->t(Ltc/f;)V
    ...
    const-class v1, Lkc/c;

    invoke-virtual {p0, v1}, Llc/e;->D(Ljava/lang/Class;)Lkc/b;
    ...
    invoke-virtual {p0, v1}, Lkc/c;->d(Ljava/lang/String;)V

    :cond_b
    invoke-virtual {v0, p1}, Lcom/xiaomi/ai/core/b;->w(Ltc/f;)Z
