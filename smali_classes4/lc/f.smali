...
.method public constructor <init>(Llc/e;)V
    ...
    iput-object v0, p0, Llc/f;->b:Ljava/util/Map;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Llc/f;->c:Ljava/util/Map;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, Llc/f;->e:Ljava/util/Set;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, Llc/f;->f:Ljava/util/Set;

    iput-object p1, p0, Llc/f;->a:Llc/e;

    iget-object p1, p0, Llc/f;->e:Ljava/util/Set;
    ...
    iget-object p0, p0, Llc/f;->f:Ljava/util/Set;
...
.method public a()V
    ...
    iget-object v0, p0, Llc/f;->b:Ljava/util/Map;
    ...
    invoke-static {v2, v4, v5}, Ltc/a;->d(Ltc/h;Ljava/util/List;Ljava/lang/String;)Ltc/f;

    move-result-object v2

    iget-object v4, p0, Llc/f;->a:Llc/e;

    invoke-virtual {v4}, Llc/e;->K()Llc/k;
    ...
    invoke-static {v3, v1}, Lxc/a;->e(Ljava/lang/String;Ljava/lang/String;)V
...
.method public b(Ltc/f;)V
    .locals 2

    iget-object v0, p0, Llc/f;->e:Ljava/util/Set;
    ...
    :cond_0
    invoke-virtual {p0, p1}, Llc/f;->f(Ltc/f;)Z
    ...
    iput-object p1, p0, Llc/f;->d:Ljava/lang/String;
...
.method public c(Ljava/lang/String;)Z
    ...
    iget-object p0, p0, Llc/f;->b:Ljava/util/Map;
...
.method public d(Ltc/i;)Z
    ...
    :cond_1
    iget-object v3, p0, Llc/f;->f:Ljava/util/Set;
    ...
    invoke-virtual {v3}, Ltc/k;->j()Lkf/a;
    ...
    :goto_0
    iget-object v4, p0, Llc/f;->b:Ljava/util/Map;
    ...
    iget-object p1, p0, Llc/f;->b:Ljava/util/Map;

    invoke-interface {p1, v3}, Ljava/util/Map;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    iget-object p1, p0, Llc/f;->d:Ljava/lang/String;
...
.method public e()V
    ...
    iget-object v1, p0, Llc/f;->b:Ljava/util/Map;
    ...
    iput-object v0, p0, Llc/f;->d:Ljava/lang/String;
...
.method public f(Ltc/f;)Z
    ...
    invoke-virtual {p0, p1}, Llc/f;->h(Ltc/f;)Z
...
.method public g()Ljava/lang/String;
    ...
    iget-object p0, p0, Llc/f;->d:Ljava/lang/String;

    return-object p0
.end method

.method public final h(Ltc/f;)Z
    .locals 1
    ...
    invoke-virtual {p0}, Lcom/xiaomi/ai/api/u0$c;->f()Lkf/a;
