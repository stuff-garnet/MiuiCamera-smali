...
.method public constructor <init>(Llc/e;)V
    ...
    iput-object v0, p0, Llc/c;->j:Ljava/security/SecureRandom;
    ...
    iput-object v0, p0, Llc/c;->b:Landroid/content/Context;
    ...
    iput-object v1, p0, Llc/c;->d:Ljava/lang/String;
    ...
    iput-object v1, p0, Llc/c;->f:Ljava/lang/String;

    invoke-virtual {p1}, Llc/e;->V()Lcom/xiaomi/ai/api/o0$e;
    ...
    iput-object p1, p0, Llc/c;->g:Lokhttp3/OkHttpClient;

    new-instance p1, Llc/c$a;

    invoke-direct {p1, p0}, Llc/c$a;-><init>(Llc/c;)V

    iput-object p1, p0, Llc/c;->c:Ljava/lang/Runnable;

    return-void
.end method

.method public static synthetic a(Llc/c;)I
    .locals 0
...
.method public static synthetic f(Llc/c;I)V
    .locals 0

    invoke-virtual {p0, p1}, Llc/c;->c(I)V

    return-void
.end method

.method public static synthetic g(Llc/c;J)V
    .locals 0

    invoke-virtual {p0, p1, p2}, Llc/c;->d(J)V

    return-void
.end method

.method public static synthetic k(Llc/c;I)J
    .locals 0

    invoke-virtual {p0, p1}, Llc/c;->j(I)J
...
.method public static synthetic o(Llc/c;)V
    .locals 0

    invoke-virtual {p0}, Llc/c;->p()V
...
.method public final b(Ljava/lang/String;J)J
    ...
    iget-object p0, p0, Llc/c;->b:Landroid/content/Context;

    const-string v0, "aivs_cloud_control"

    invoke-static {p0, v0, p1}, Lqc/e;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public final c(I)V
    ...
    iget-object v1, p0, Llc/c;->j:Ljava/security/SecureRandom;
    ...
    iput p1, p0, Llc/c;->h:I

    int-to-long v1, p1

    invoke-virtual {p0, v0, v1, v2}, Llc/c;->n(Ljava/lang/String;J)V
    ...
    invoke-virtual {p0, v0, v1, v2}, Llc/c;->b(Ljava/lang/String;J)J
    ...
    iget-object p1, p0, Llc/c;->j:Ljava/security/SecureRandom;
...
.method public final d(J)V
    ...
    iget-object v0, p0, Llc/c;->c:Ljava/lang/Runnable;
    ...
    :cond_0
    iget-object v0, p0, Llc/c;->i:Ljava/util/concurrent/ScheduledFuture;
    ...
    invoke-static {v0}, Luc/c;->c(Ljava/util/concurrent/ScheduledFuture;)V

    :cond_1
    :try_start_0
    iget-object v0, p0, Llc/c;->c:Ljava/lang/Runnable;

    invoke-static {v0, p1, p2}, Luc/c;->a(Ljava/lang/Runnable;J)Ljava/util/concurrent/ScheduledFuture;

    move-result-object p1

    iput-object p1, p0, Llc/c;->i:Ljava/util/concurrent/ScheduledFuture;
    :try_end_0
...
.method public final e(Ljava/lang/String;)V
    ...
    invoke-static {p0, v0, v1, p1}, Lqc/e;->c(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    :cond_0
    return-void
.end method

.method public final h(Loc/a$a;)V
    .locals 1

    invoke-virtual {p1}, Loc/a$a;->b()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Llc/c;->r()V

    :cond_0
    invoke-virtual {p1}, Loc/a$a;->e()Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-virtual {p0}, Llc/c;->s()V

    :cond_1
    invoke-virtual {p1}, Loc/a$a;->a()Z

    move-result v0

    if-eqz v0, :cond_2

    invoke-virtual {p0}, Llc/c;->t()V

    :cond_2
    invoke-virtual {p1}, Loc/a$a;->d()Z

    move-result v0

    if-eqz v0, :cond_3

    invoke-virtual {p0}, Llc/c;->u()V

    :cond_3
    invoke-virtual {p1}, Loc/a$a;->c()Z

    move-result p1

    if-eqz p1, :cond_4

    invoke-virtual {p0}, Llc/c;->v()V
...
.method public i()Z
    ...
    :cond_0
    iget-object p0, p0, Llc/c;->c:Ljava/lang/Runnable;
...
.method public final j(I)J
    ...
    invoke-virtual {p0, v0}, Llc/c;->m(Ljava/lang/String;)V
...
.method public l()V
    ...
    iput-object v1, p0, Llc/c;->i:Ljava/util/concurrent/ScheduledFuture;

    :cond_0
    iput-object v1, p0, Llc/c;->c:Ljava/lang/Runnable;
...
.method public final m(Ljava/lang/String;)V
    ...
    invoke-static {p0, v0, p1}, Lqc/e;->e(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
...
.method public final n(Ljava/lang/String;J)V
    ...
    invoke-static {p0, v0, p1, p2}, Lqc/e;->c(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public final p()V
    ...
    invoke-virtual {p0}, Llc/c;->q()Loc/a;
    ...
    iget-object v2, p0, Llc/c;->c:Ljava/lang/Runnable;
    ...
    invoke-virtual {p0, v5, v3, v4}, Llc/c;->b(Ljava/lang/String;J)J

    move-result-wide v3

    long-to-int v3, v3

    iget-object v4, p0, Llc/c;->b:Landroid/content/Context;

    const-string v6, "aivs_cloud_control"

    const-string v7, "link_mode"

    invoke-static {v4, v6, v7}, Lqc/e;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1, p0}, Lxc/a;->h(Ljava/lang/String;Ljava/lang/String;)V

    return-void

    :cond_2
    invoke-virtual {v0}, Loc/a;->b()Ljava/lang/String;
    ...
    invoke-virtual {p0, v5, v2, v3}, Llc/c;->n(Ljava/lang/String;J)V

    invoke-virtual {v0}, Loc/a;->a()Loc/a$a;
    ...
    invoke-virtual {p0, v2}, Llc/c;->h(Loc/a$a;)V
    ...
    invoke-virtual {p0, v2}, Llc/c;->e(Ljava/lang/String;)V

    invoke-virtual {v0}, Loc/a;->c()I

    move-result v0

    invoke-virtual {p0, v0}, Llc/c;->c(I)V
...
.method public final q()Loc/a;
    .locals 4

    new-instance v0, Lcom/xiaomi/ai/core/c;

    iget-object v1, p0, Llc/c;->a:Llc/e;
    ...
    iget-object v2, p0, Llc/c;->f:Ljava/lang/String;
    ...
    :try_start_0
    iget-object p0, p0, Llc/c;->g:Lokhttp3/OkHttpClient;
...
.method public final r()V
    ...
    iget-object p0, p0, Llc/c;->a:Llc/e;
    ...
    invoke-virtual {v0, p0, v1}, Lvc/a;->m(Lcom/xiaomi/ai/core/b;Ljava/lang/String;)V
...
.method public final s()V
    ...
    invoke-static {p0, v1}, Lxc/a;->k(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final v()V
    ...
    invoke-virtual {v0, v1}, Lkc/h;->h(Ljava/lang/String;)V
    ...
    invoke-static {p0, v0, v1}, Lqc/e;->e(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
