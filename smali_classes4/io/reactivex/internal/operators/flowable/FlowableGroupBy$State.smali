...
.method public checkTerminated(ZZLms/p;ZJ)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZ",
    ...
    invoke-interface {p0, p5, p6}, Lms/q;->request(J)V
...
.method public drainNormal()V
    ...
    invoke-virtual/range {v0 .. v6}, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$State;->checkTerminated(ZZLms/p;ZJ)Z
    ...
    iget-object v0, v0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->upstream:Lms/q;

    invoke-interface {v0, v5, v6}, Lms/q;->request(J)V
