...
.method public constructor <init>(Lms/p;Lio/reactivex/functions/Function;Lio/reactivex/functions/Function;IZLjava/util/Map;Ljava/util/Queue;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->downstream:Lms/p;
...
.method public cancel()V
    ...
    .line 4
    iget-object p0, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->upstream:Lms/q;
...
.method public cancel(Ljava/lang/Object;)V
    ...
    .line 8
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->upstream:Lms/q;
...
.method public checkTerminated(ZZLms/p;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZ",
    ...
    invoke-interface {p3, p0}, Lms/p;->onError(Ljava/lang/Throwable;)V
...
.method public drainFused()V
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->downstream:Lms/p;
    ...
    invoke-interface {v1, v4}, Lms/p;->onError(Ljava/lang/Throwable;)V
    ...
    invoke-interface {v1, v4}, Lms/p;->onNext(Ljava/lang/Object;)V
    ...
    invoke-interface {v1, p0}, Lms/p;->onError(Ljava/lang/Throwable;)V

    goto :goto_0

    :cond_3
    invoke-interface {v1}, Lms/p;->onComplete()V
...
.method public drainNormal()V
    ...
    :goto_1
    invoke-virtual {p0, v11, v13, v1, v0}, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->checkTerminated(ZZLms/p;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
    ...
    :cond_3
    invoke-interface {v1, v12}, Lms/p;->onNext(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, v10, v11, v1, v0}, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->checkTerminated(ZZLms/p;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
    ...
    :cond_6
    iget-object v4, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->upstream:Lms/q;

    invoke-interface {v4, v8, v9}, Lms/q;->request(J)V
...
.method public onNext(Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->upstream:Lms/q;
...
.method public onSubscribe(Lms/q;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->upstream:Lms/q;

    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->downstream:Lms/p;
