...
.method public static subscribe(Lms/p;Ljava/util/Iterator;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-interface {p0, v0}, Lms/p;->onSubscribe(Lms/q;)V
    ...
    invoke-direct {v0, p0, p1}, Lio/reactivex/internal/operators/flowable/FlowableFromIterable$IteratorSubscription;-><init>(Lms/p;Ljava/util/Iterator;)V
...
.method public subscribeActual(Lms/p;)V
    ...
    invoke-static {p1, p0}, Lio/reactivex/internal/operators/flowable/FlowableFromIterable;->subscribe(Lms/p;Ljava/util/Iterator;)V
