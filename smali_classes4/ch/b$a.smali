...
.field public final synthetic m:Lch/b;


# direct methods
.method public constructor <init>(Lch/b;Landroid/content/Context;Landroid/view/View$OnClickListener;Landroid/widget/RelativeLayout;)V
    .locals 5

    iput-object p1, p0, Lch/b$a;->m:Lch/b;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    const/16 p1, 0x68

    iput p1, p0, Lch/b$a;->a:I

    const/4 p1, 0x3

    new-array v0, p1, [I

    iput-object v0, p0, Lch/b$a;->b:[I

    const/4 v0, 0x0

    iput-boolean v0, p0, Lch/b$a;->l:Z

    iput-object p2, p0, Lch/b$a;->k:Landroid/content/Context;

    iput-object p4, p0, Lch/b$a;->d:Landroid/widget/RelativeLayout;

    new-instance p2, Landroid/widget/ImageView;

    iget-object p4, p0, Lch/b$a;->k:Landroid/content/Context;

    invoke-direct {p2, p4}, Landroid/widget/ImageView;-><init>(Landroid/content/Context;)V

    iput-object p2, p0, Lch/b$a;->h:Landroid/widget/ImageView;
    ...
    iget-object p2, p0, Lch/b$a;->h:Landroid/widget/ImageView;
    ...
    iget-object v2, p0, Lch/b$a;->k:Landroid/content/Context;
    ...
    iput-object p2, p0, Lch/b$a;->i:Landroid/widget/ImageView;
    ...
    iget-object p2, p0, Lch/b$a;->i:Landroid/widget/ImageView;
    ...
    iput-object p2, p0, Lch/b$a;->j:Landroid/widget/ImageView;
    ...
    iget-object p2, p0, Lch/b$a;->j:Landroid/widget/ImageView;
    ...
    iget-object p4, p0, Lch/b$a;->j:Landroid/widget/ImageView;
    ...
    iget-object p1, p0, Lch/b$a;->k:Landroid/content/Context;
    ...
    iget-object p3, p0, Lch/b$a;->k:Landroid/content/Context;
    ...
    iput-object p3, p0, Lch/b$a;->e:Landroid/view/ViewGroup$MarginLayoutParams;

    new-instance p3, Landroid/widget/RelativeLayout$LayoutParams;

    invoke-direct {p3, p1, p2}, Landroid/widget/RelativeLayout$LayoutParams;-><init>(II)V

    iput-object p3, p0, Lch/b$a;->f:Landroid/view/ViewGroup$MarginLayoutParams;

    new-instance p3, Landroid/widget/RelativeLayout$LayoutParams;

    invoke-direct {p3, p1, p2}, Landroid/widget/RelativeLayout$LayoutParams;-><init>(II)V

    iput-object p3, p0, Lch/b$a;->g:Landroid/view/ViewGroup$MarginLayoutParams;

    return-void
.end method

.method public static bridge synthetic a(Lch/b$a;)Landroid/view/ViewGroup$MarginLayoutParams;
    .locals 0

    iget-object p0, p0, Lch/b$a;->f:Landroid/view/ViewGroup$MarginLayoutParams;

    return-object p0
.end method

.method public static bridge synthetic b(Lch/b$a;)Landroid/view/ViewGroup$MarginLayoutParams;
    .locals 0

    iget-object p0, p0, Lch/b$a;->e:Landroid/view/ViewGroup$MarginLayoutParams;

    return-object p0
.end method

.method public static bridge synthetic c(Lch/b$a;)Landroid/view/ViewGroup$MarginLayoutParams;
    .locals 0

    iget-object p0, p0, Lch/b$a;->g:Landroid/view/ViewGroup$MarginLayoutParams;
...
.method public e()V
    ...
    iget-object v1, v0, Lch/b$a;->h:Landroid/widget/ImageView;

    if-eqz v1, :cond_3

    iget-object v1, v0, Lch/b$a;->i:Landroid/widget/ImageView;
    ...
    iget-object v2, v0, Lch/b$a;->i:Landroid/widget/ImageView;
    ...
    iget-object v4, v0, Lch/b$a;->i:Landroid/widget/ImageView;
    ...
    iget-object v5, v0, Lch/b$a;->i:Landroid/widget/ImageView;
    ...
    iget-object v9, v0, Lch/b$a;->m:Lch/b;

    invoke-static {v9}, Lch/b;->e(Lch/b;)Z
    ...
    invoke-static {v9}, Lch/b;->d(Lch/b;)D
    ...
    invoke-static {v9}, Lch/b;->g(Lch/b;)D
    ...
    iget-object v6, v0, Lch/b$a;->i:Landroid/widget/ImageView;

    new-array v11, v3, [F

    aput v8, v11, v7

    iget-object v12, v0, Lch/b$a;->m:Lch/b;

    invoke-static {v12}, Lch/b;->a(Lch/b;)I
    ...
    new-instance v6, Lch/b$a$d;

    invoke-direct {v6, v0}, Lch/b$a$d;-><init>(Lch/b$a;)V
    ...
    iget-object v14, v0, Lch/b$a;->h:Landroid/widget/ImageView;
    ...
    iget-object v5, v0, Lch/b$a;->h:Landroid/widget/ImageView;
    ...
    iget-object v1, v0, Lch/b$a;->m:Lch/b;

    invoke-static {v1}, Lch/b;->e(Lch/b;)Z
    ...
    invoke-static {v1}, Lch/b;->g(Lch/b;)D
    ...
    invoke-static {v1}, Lch/b;->d(Lch/b;)D
    ...
    iget-object v7, v0, Lch/b$a;->h:Landroid/widget/ImageView;
    ...
    invoke-static {v9}, Lch/b;->a(Lch/b;)I
    ...
    new-instance v1, Lch/b$a$e;

    invoke-direct {v1, v0}, Lch/b$a$e;-><init>(Lch/b$a;)V
    ...
    iget-object v2, v0, Lch/b$a;->j:Landroid/widget/ImageView;
    ...
    iget-object v4, v0, Lch/b$a;->j:Landroid/widget/ImageView;
    ...
    iget-object v5, v0, Lch/b$a;->j:Landroid/widget/ImageView;
    ...
    iget-object v7, v0, Lch/b$a;->j:Landroid/widget/ImageView;
    ...
    new-instance v2, Lch/b$a$f;

    invoke-direct {v2, v0}, Lch/b$a$f;-><init>(Lch/b$a;)V
...
.method public f(III)V
    ...
    iput p3, p0, Lch/b$a;->c:I

    iget-boolean p3, p0, Lch/b$a;->l:Z

    if-nez p3, :cond_0

    iget-object p3, p0, Lch/b$a;->d:Landroid/widget/RelativeLayout;

    iget-object v0, p0, Lch/b$a;->i:Landroid/widget/ImageView;

    invoke-virtual {p3, v0}, Landroid/view/ViewGroup;->addView(Landroid/view/View;)V

    iget-object p3, p0, Lch/b$a;->d:Landroid/widget/RelativeLayout;

    iget-object v0, p0, Lch/b$a;->h:Landroid/widget/ImageView;

    invoke-virtual {p3, v0}, Landroid/view/ViewGroup;->addView(Landroid/view/View;)V

    iget-object p3, p0, Lch/b$a;->d:Landroid/widget/RelativeLayout;

    iget-object v0, p0, Lch/b$a;->j:Landroid/widget/ImageView;

    invoke-virtual {p3, v0}, Landroid/view/ViewGroup;->addView(Landroid/view/View;)V

    const/4 p3, 0x1

    iput-boolean p3, p0, Lch/b$a;->l:Z

    :cond_0
    iget-object p3, p0, Lch/b$a;->m:Lch/b;

    invoke-static {p3}, Lch/b;->c(Lch/b;)Z
    ...
    invoke-static {p3}, Lch/b;->b(Lch/b;)Z
    ...
    iget v0, p0, Lch/b$a;->c:I

    invoke-virtual {p3, v0}, Lch/b;->n(I)V

    invoke-virtual {p0, p1, p2}, Lch/b$a;->h(II)V
...
.method public h(II)V
    ...
    iget-object v2, v0, Lch/b$a;->m:Lch/b;

    invoke-static {v2}, Lch/b;->f(Lch/b;)I

    move-result v2

    sub-int v2, v2, p1

    iget-object v3, v0, Lch/b$a;->k:Landroid/content/Context;
    ...
    iget-object v3, v0, Lch/b$a;->i:Landroid/widget/ImageView;
    ...
    iget-object v7, v0, Lch/b$a;->i:Landroid/widget/ImageView;
    ...
    iget-object v9, v0, Lch/b$a;->i:Landroid/widget/ImageView;
    ...
    iget-object v10, v0, Lch/b$a;->i:Landroid/widget/ImageView;
    ...
    iget-object v13, v0, Lch/b$a;->m:Lch/b;

    invoke-static {v13}, Lch/b;->e(Lch/b;)Z
    ...
    invoke-static {v13}, Lch/b;->g(Lch/b;)D
    ...
    invoke-static {v13}, Lch/b;->d(Lch/b;)D
    ...
    iget-object v11, v0, Lch/b$a;->i:Landroid/widget/ImageView;

    new-array v14, v8, [F

    aput v12, v14, v4

    iget-object v15, v0, Lch/b$a;->m:Lch/b;

    invoke-static {v15}, Lch/b;->h(Lch/b;)I
    ...
    new-instance v5, Lch/b$a$a;

    invoke-direct {v5, v0, v1, v2}, Lch/b$a$a;-><init>(Lch/b$a;II)V
    ...
    iget-object v9, v0, Lch/b$a;->h:Landroid/widget/ImageView;
    ...
    iget-object v10, v0, Lch/b$a;->h:Landroid/widget/ImageView;
    ...
    invoke-static {v12}, Lch/b;->e(Lch/b;)Z
    ...
    invoke-static {v12}, Lch/b;->d(Lch/b;)D
    ...
    iget-object v4, v0, Lch/b$a;->m:Lch/b;

    invoke-static {v4}, Lch/b;->g(Lch/b;)D
    ...
    iget-object v11, v0, Lch/b$a;->m:Lch/b;

    invoke-static {v11}, Lch/b;->h(Lch/b;)I
    ...
    new-instance v4, Lch/b$a$b;

    invoke-direct {v4, v0, v1, v2}, Lch/b$a$b;-><init>(Lch/b$a;II)V
    ...
    iget-object v9, v0, Lch/b$a;->j:Landroid/widget/ImageView;
    ...
    iget-object v10, v0, Lch/b$a;->j:Landroid/widget/ImageView;
    ...
    invoke-static {v12}, Lch/b;->h(Lch/b;)I
    ...
    new-instance v5, Lch/b$a$c;

    invoke-direct {v5, v0, v1, v2}, Lch/b$a$c;-><init>(Lch/b$a;II)V
