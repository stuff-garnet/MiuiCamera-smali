...
.method public static synthetic a(IZ)V
    ...
    invoke-static {p0, p1}, Lhi/e;->n(IZ)V

    return-void
.end method

.method public static synthetic b(Ljava/lang/String;Ljava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicInteger;Lli/b;Ljava/util/concurrent/atomic/AtomicBoolean;)V
    .locals 0

    invoke-static {p0, p1, p2, p3, p4}, Lhi/e;->k(Ljava/lang/String;Ljava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicInteger;Lli/b;Ljava/util/concurrent/atomic/AtomicBoolean;)V

    return-void
.end method

.method public static synthetic c([B[BLjava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicBoolean;Lli/b;Ljava/util/concurrent/atomic/AtomicInteger;)V
    .locals 0

    invoke-static/range {p0 .. p5}, Lhi/e;->m([B[BLjava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicBoolean;Lli/b;Ljava/util/concurrent/atomic/AtomicInteger;)V

    return-void
.end method

.method public static synthetic d(Ljava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicBoolean;Lli/b;Ljava/util/concurrent/atomic/AtomicInteger;ILjava/lang/String;)V
    .locals 0

    invoke-static/range {p0 .. p5}, Lhi/e;->l(Ljava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicBoolean;Lli/b;Ljava/util/concurrent/atomic/AtomicInteger;ILjava/lang/String;)V
...
.method public static f()Z
    ...
    sget-object v0, Lhi/e;->a:Ljava/lang/String;
    ...
    invoke-static {v0, v1}, Lpj/c;->a(Ljava/lang/String;Ljava/lang/String;)V

    return v4

    :cond_0
    invoke-static {v1}, Lpj/i;->o(Ljava/lang/String;)Z
...
.method public static g(Lcom/faceunity/core/avatar/model/Avatar;Ljava/util/List;)Z
    ...
    sget-object p0, Lhi/e;->a:Ljava/lang/String;

    const-string p1, "checkAvatarIsLegal avatar isEmpty"

    invoke-static {p0, p1}, Lpj/c;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v5}, Lpj/i;->o(Ljava/lang/String;)Z
    ...
    invoke-static {v1, v4}, Lhi/e;->e(Ljava/lang/StringBuilder;Ljava/lang/String;)V
    ...
    sget-object p1, Lhi/e;->a:Ljava/lang/String;
...
.method public static h(Laj/f;Lcom/faceunity/core/avatar/model/Avatar;)Z
    .locals 5
    ...
    invoke-static {p1}, Lpj/i;->o(Ljava/lang/String;)Z
    ...
    :cond_2
    invoke-static {v0, v3}, Lhi/e;->e(Ljava/lang/StringBuilder;Ljava/lang/String;)V
    ...
    invoke-static {v0, p1}, Lhi/e;->e(Ljava/lang/StringBuilder;Ljava/lang/String;)V
    ...
    invoke-static {v0, p0}, Lhi/e;->e(Ljava/lang/StringBuilder;Ljava/lang/String;)V
...
.method public static i(ZILli/b;)V
    .locals 0
    ...
    invoke-static {}, Lhi/e;->f()Z

    move-result p0

    if-eqz p0, :cond_1

    invoke-static {}, Lhi/e;->p()V

    sget-object p0, Lhi/e;->a:Ljava/lang/String;

    const-string p1, "initFaceUnity registerFURender finishes SUCCESS"

    invoke-static {p0, p1}, Lpj/j;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {p2, p0, p1}, Lli/b;->a(ILjava/lang/String;)V
    ...
    invoke-interface {p2, p0, p1}, Lli/b;->c(ILjava/lang/String;)V
...
.method public static j(Ljava/lang/String;Lli/b;)V
    .locals 13
    ...
    invoke-virtual {v0, v3, v4}, Lpj/f;->d([B[B)V
    ...
    invoke-direct/range {v5 .. v10}, Lhi/b;-><init>(Ljava/lang/String;Ljava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicInteger;Lli/b;Ljava/util/concurrent/atomic/AtomicBoolean;)V
    ...
    invoke-static {p0}, Lhi/e;->q(Lcom/faceunity/toolbox/utils/FULogger$LogLevel;)V

    sget-object p0, Lcom/faceunity/toolbox/utils/FULogger$LogLevel;->INFO:Lcom/faceunity/toolbox/utils/FULogger$LogLevel;

    invoke-static {p0}, Lhi/e;->r(Lcom/faceunity/toolbox/utils/FULogger$LogLevel;)V

    new-instance p0, Ljava/lang/Thread;

    new-instance v9, Lhi/c;
    ...
    invoke-direct/range {v2 .. v8}, Lhi/c;-><init>([B[BLjava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicBoolean;Lli/b;Ljava/util/concurrent/atomic/AtomicInteger;)V
...
.method public static synthetic k(Ljava/lang/String;Ljava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicInteger;Lli/b;Ljava/util/concurrent/atomic/AtomicBoolean;)V
    .locals 3
    ...
    invoke-virtual {v1, v2, p0}, Lwi/e;->G(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p2, v1, p3}, Lhi/e;->i(ZILli/b;)V
...
.method public static synthetic l(Ljava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicBoolean;Lli/b;Ljava/util/concurrent/atomic/AtomicInteger;ILjava/lang/String;)V
    .locals 2
    ...
    invoke-static {v1, p4, p2}, Lhi/e;->i(ZILli/b;)V
    ...
    invoke-interface {p2, p4, p5}, Lli/b;->c(ILjava/lang/String;)V
...
.method public static synthetic m([B[BLjava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicBoolean;Lli/b;Ljava/util/concurrent/atomic/AtomicInteger;)V
    .locals 2
    ...
    invoke-direct {v0, p2, p3, p4, p5}, Lhi/a;-><init>(Ljava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicBoolean;Lli/b;Ljava/util/concurrent/atomic/AtomicInteger;)V
...
.method public static synthetic n(IZ)V
    ...
    invoke-virtual {v1}, Lji/b;->g()Lcom/faceunity/core/avatar/model/Scene;

    move-result-object v2

    invoke-virtual {v1, p0}, Lji/b;->p(I)Lxi/c;
    ...
    invoke-virtual {v3}, Lxi/c;->b()Lkg/a;
    ...
    invoke-static {v5, v4}, Lhi/e;->g(Lcom/faceunity/core/avatar/model/Avatar;Ljava/util/List;)Z
    ...
    invoke-static {v0, v5}, Lpj/c;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v5, v7, v4}, Lwi/e;->f(Lcom/faceunity/core/avatar/model/Avatar;Ljava/util/List;)V

    goto :goto_0

    :cond_1
    invoke-static {v0, v6}, Lpj/c;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v4, v5}, Lji/b;->b(Lcom/faceunity/core/avatar/model/Avatar;Ljava/lang/String;)V

    invoke-virtual {v3}, Lxi/c;->a()Lcom/faceunity/core/avatar/model/Avatar;

    move-result-object v4

    sget-object v5, Lki/b;->a:Lki/b;

    invoke-virtual {v1, v4, v5}, Lji/b;->q(Lcom/faceunity/core/avatar/model/Avatar;Lki/b;)Laj/f;
    ...
    invoke-static {v4, v5}, Lhi/e;->h(Laj/f;Lcom/faceunity/core/avatar/model/Avatar;)Z
    ...
    invoke-virtual {p1, v4, v5}, Lwi/e;->R(Laj/f;Lcom/faceunity/core/avatar/model/Avatar;)V
    ...
    :cond_5
    :goto_2
    invoke-virtual {v1, v2, v4}, Lji/b;->f(Lcom/faceunity/core/avatar/model/Scene;Laj/f;)V

    invoke-virtual {v1, v2}, Lji/b;->s(Lcom/faceunity/core/avatar/model/Scene;)V

    invoke-virtual {v3}, Lxi/c;->a()Lcom/faceunity/core/avatar/model/Avatar;

    move-result-object p1

    invoke-virtual {v1, v2, p1}, Lji/b;->e(Lcom/faceunity/core/avatar/model/Scene;Lcom/faceunity/core/avatar/model/Avatar;)V
    ...
    invoke-static {p0, p1}, Lhi/e;->e(Ljava/lang/StringBuilder;Ljava/lang/String;)V
    ...
    invoke-static {v0, p0}, Lpj/c;->a(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static o(IZ)V
    ...
    invoke-direct {v1, p0, p1}, Lhi/d;-><init>(IZ)V
...
.method public static p()V
    ...
    sget-object v1, Lii/a;->b:Ljava/lang/String;
    ...
    sget-object v2, Lii/a;->c:Ljava/lang/String;
