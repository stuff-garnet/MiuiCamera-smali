...
.method public constructor <init>(Lxf/w2;)V
    ...
    iput-object p1, p0, Lxf/w2$d;->a:Lxf/w2;
...
.method public static synthetic d(Lxf/w2$d;Lb2/s3;)V
    .locals 0

    invoke-direct {p0, p1}, Lxf/w2$d;->e(Lb2/s3;)V
...
.method private synthetic e(Lb2/s3;)V
    ...
    iget-object v0, p0, Lxf/w2$d;->a:Lxf/w2;

    invoke-virtual {v0}, Lxf/w2;->f()Z
    ...
    invoke-static {v1, v0}, Lz7/a;->f1(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object p0, p0, Lxf/w2$d;->a:Lxf/w2;

    const/4 p1, 0x1

    invoke-virtual {p0, p1}, Lxf/w2;->gr(I)V
...
.method public a()V
    ...
    invoke-static {v0}, Lxf/w2;->xp(Lxf/w2;)Lb2/w3;
    ...
    invoke-static {v0, v1}, Lxf/w2;->zp(Lxf/w2;Z)V
...
.method public b()V
    ...
    invoke-virtual {v0}, Lxf/w2;->Lp()Ljava/util/Optional;

    move-result-object v0

    new-instance v1, Lxf/y2;

    invoke-direct {v1, p0}, Lxf/y2;-><init>(Lxf/w2$d;)V
